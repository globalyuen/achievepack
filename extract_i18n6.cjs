...
const sourceFile = project.addSourceFileAtPath('src/pages/admin/prospects/ProspectListsPage.tsx');
...
const component = sourceFile.getVariableDeclaration('ProspectListsPage');
if (component) {
...
fs.writeFileSync('extracted_prospect_lists.json', JSON.stringify(dict, null, 2));
