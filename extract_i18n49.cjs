...
const sourceFile = project.addSourceFileAtPath('src/pages/topics/RecyclableSnackPackagingPage.tsx');
...
const component = sourceFile.getVariableDeclaration('RecyclableSnackPackagingPage') || sourceFile.getFunction('RecyclableSnackPackagingPage');
if (component) {
...
fs.writeFileSync('extracted_recyclable_snack.json', JSON.stringify(dict, null, 2));
