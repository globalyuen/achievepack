...
const sourceFile = project.addSourceFileAtPath('src/pages/quotes/ThreeSideSealQuotePage.tsx');
...
const component = sourceFile.getVariableDeclaration('ThreeSideSealQuotePage');
if (component) {
...
fs.writeFileSync('extracted_three_side.json', JSON.stringify(dict, null, 2));
