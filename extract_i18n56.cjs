...
const sourceFile = project.addSourceFileAtPath('src/pages/topics/MonoPEPouchesPage.tsx');
...
const component = sourceFile.getVariableDeclaration('MonoPEPouchesPage') || sourceFile.getFunction('MonoPEPouchesPage');
if (component) {
...
fs.writeFileSync('extracted_monope.json', JSON.stringify(dict, null, 2));
