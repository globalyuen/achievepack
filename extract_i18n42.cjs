...
const sourceFile = project.addSourceFileAtPath('src/pages/free-service/FreeCustomerCenterPage.tsx');
...
const component = sourceFile.getVariableDeclaration('FreeCustomerCenterPage') || sourceFile.getFunction('FreeCustomerCenterPage');
if (component) {
...
fs.writeFileSync('extracted_free_customer.json', JSON.stringify(dict, null, 2));
