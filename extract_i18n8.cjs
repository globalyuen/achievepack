...
const sourceFile = project.addSourceFileAtPath('src/pages/admin/ShipmentDetailPage.tsx');
...
const component = sourceFile.getVariableDeclaration('ShipmentDetailPage');
if (component) {
...
fs.writeFileSync('extracted_shipment_detail.json', JSON.stringify(dict, null, 2));
