...
const sourceFile = project.addSourceFileAtPath('src/pages/ProductPage.tsx');
...
const component = sourceFile.getVariableDeclaration('ProductPage') || sourceFile.getFunction('ProductPage');
if (component) {
...
fs.writeFileSync('extracted_product.json', JSON.stringify(dict, null, 2));
