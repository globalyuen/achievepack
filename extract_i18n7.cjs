...
const sourceFile = project.addSourceFileAtPath('src/pages/admin/rfq/RFQGeneratorPage.tsx');
...
const component = sourceFile.getVariableDeclaration('RFQGeneratorPage');
if (component) {
...
fs.writeFileSync('extracted_rfq_generator.json', JSON.stringify(dict, null, 2));
