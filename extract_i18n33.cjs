...
const sourceFile = project.addSourceFileAtPath('src/pages/free-service/AchievePouchEcoDemoPage.tsx');
...
const component = sourceFile.getVariableDeclaration('AchievePouchEcoDemoPage') || sourceFile.getFunction('AchievePouchEcoDemoPage');
if (component) {
...
fs.writeFileSync('extracted_achieve_pouch.json', JSON.stringify(dict, null, 2));
