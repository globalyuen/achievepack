...
const sourceFile = project.addSourceFileAtPath('src/pages/blog/CompostableVsRecyclablePage.tsx');
...
const component = sourceFile.getVariableDeclaration('CompostableVsRecyclablePage');
if (component) {
...
fs.writeFileSync('extracted_compostable_vs_recyclable.json', JSON.stringify(dict, null, 2));
