...
const sourceFile = project.addSourceFileAtPath('src/pages/topics/CustomBrandPackagingPage.tsx');
...
const component = sourceFile.getVariableDeclaration('CustomBrandPackagingPage') || sourceFile.getFunction('CustomBrandPackagingPage');
if (component) {
...
fs.writeFileSync('extracted_custom_brand.json', JSON.stringify(dict, null, 2));
