...
const sourceFile = project.addSourceFileAtPath('src/pages/free-service/AchieveCoffeeDemoPage.tsx');
...
const component = sourceFile.getVariableDeclaration('AchieveCoffeeDemoPage') || sourceFile.getFunction('AchieveCoffeeDemoPage');
if (component) {
...
fs.writeFileSync('extracted_achieve_coffee.json', JSON.stringify(dict, null, 2));
