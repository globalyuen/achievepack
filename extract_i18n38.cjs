...
const sourceFile = project.addSourceFileAtPath('src/pages/free-service/AchieveCleaningDemoPage.tsx');
...
const component = sourceFile.getVariableDeclaration('AchieveCleaningDemoPage') || sourceFile.getFunction('AchieveCleaningDemoPage');
if (component) {
...
fs.writeFileSync('extracted_achieve_cleaning.json', JSON.stringify(dict, null, 2));
