...
const sourceFile = project.addSourceFileAtPath('src/pages/admin/DocumentTemplatesPage.tsx');
...
const component = sourceFile.getVariableDeclaration('DocumentTemplatesPage');
if (component) {
...
fs.writeFileSync('extracted_doc_templates.json', JSON.stringify(dict, null, 2));
