...
const sourceFile = project.addSourceFileAtPath('src/pages/topics/GreenCoffeeMaterialsPage.tsx');
...
const component = sourceFile.getVariableDeclaration('GreenCoffeeMaterialsPage') || sourceFile.getFunction('GreenCoffeeMaterialsPage');
if (component) {
...
fs.writeFileSync('extracted_green_coffee.json', JSON.stringify(dict, null, 2));
