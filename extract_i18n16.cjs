...
const sourceFile = project.addSourceFileAtPath('src/pages/UnsubscribePage.tsx');
...
const component = sourceFile.getVariableDeclaration('UnsubscribePage') || sourceFile.getFunction('UnsubscribePage');
if (component) {
...
fs.writeFileSync('extracted_unsubscribe.json', JSON.stringify(dict, null, 2));
