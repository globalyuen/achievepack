...
const sourceFile = project.addSourceFileAtPath('src/pages/free-service/AchieveSkinDemoPage.tsx');
...
const component = sourceFile.getVariableDeclaration('AchieveSkinDemoPage') || sourceFile.getFunction('AchieveSkinDemoPage');
if (component) {
...
fs.writeFileSync('extracted_achieve_skin.json', JSON.stringify(dict, null, 2));
