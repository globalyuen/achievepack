...
const sourceFile = project.addSourceFileAtPath('src/pages/knowledge/FlatBottomVsGussetPage.tsx');
...
const component = sourceFile.getVariableDeclaration('FlatBottomVsGussetPage') || sourceFile.getFunction('FlatBottomVsGussetPage');
if (component) {
...
fs.writeFileSync('extracted_flat_bottom.json', JSON.stringify(dict, null, 2));
