...
const sourceFile = project.addSourceFileAtPath('src/pages/RfqConfirmation.tsx');
...
const component = sourceFile.getVariableDeclaration('RfqConfirmation') || sourceFile.getFunction('RfqConfirmation');
if (component) {
...
fs.writeFileSync('extracted_rfq_confirmation.json', JSON.stringify(dict, null, 2));
