...
const sourceFile = project.addSourceFileAtPath('src/pages/topics/ReducePackagingWasteGuidePage.tsx');
...
const component = sourceFile.getVariableDeclaration('ReducePackagingWasteGuidePage') || sourceFile.getFunction('ReducePackagingWasteGuidePage');
if (component) {
...
fs.writeFileSync('extracted_reduce_waste.json', JSON.stringify(dict, null, 2));
