...
const sourceFile = project.addSourceFileAtPath('src/pages/free-service/AchieveTeaDemoPage.tsx');
...
const component = sourceFile.getVariableDeclaration('AchieveTeaDemoPage') || sourceFile.getFunction('AchieveTeaDemoPage');
if (component) {
...
fs.writeFileSync('extracted_achieve_tea.json', JSON.stringify(dict, null, 2));
