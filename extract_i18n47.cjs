...
const sourceFile = project.addSourceFileAtPath('src/pages/topics/PFASFreePackagingPage.tsx');
...
const component = sourceFile.getVariableDeclaration('PFASFreePackagingPage') || sourceFile.getFunction('PFASFreePackagingPage');
if (component) {
...
fs.writeFileSync('extracted_pfas.json', JSON.stringify(dict, null, 2));
