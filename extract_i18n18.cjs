...
const sourceFile = project.addSourceFileAtPath('src/pages/support/UnprintedSamplesPage.tsx');
...
const component = sourceFile.getVariableDeclaration('UnprintedSamplesPage') || sourceFile.getFunction('UnprintedSamplesPage');
if (component) {
...
fs.writeFileSync('extracted_unprinted_samples.json', JSON.stringify(dict, null, 2));
