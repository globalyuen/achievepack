...
const sourceFile = project.addSourceFileAtPath('src/pages/topics/LowMOQStartupPackagingPage.tsx');
...
const component = sourceFile.getVariableDeclaration('LowMOQStartupPackagingPage') || sourceFile.getFunction('LowMOQStartupPackagingPage');
if (component) {
...
fs.writeFileSync('extracted_low_moq.json', JSON.stringify(dict, null, 2));
