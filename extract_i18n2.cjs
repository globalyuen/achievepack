...
const sourceFile = project.addSourceFileAtPath('src/pages/quotes/FlatBottomQuotePage.tsx');
...
const component = sourceFile.getVariableDeclaration('FlatBottomQuotePage');
if (component) {
