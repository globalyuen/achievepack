...
const sourceFile = project.addSourceFileAtPath('src/pages/free-service/FreeWebsiteUpgradePage.tsx');
...
const component = sourceFile.getVariableDeclaration('FreeWebsiteUpgradePage') || sourceFile.getFunction('FreeWebsiteUpgradePage');
if (component) {
...
fs.writeFileSync('extracted_free_website.json', JSON.stringify(dict, null, 2));
