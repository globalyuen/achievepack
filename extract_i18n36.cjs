...
const sourceFile = project.addSourceFileAtPath('src/pages/free-service/PencilDemoPage.tsx');
...
const component = sourceFile.getVariableDeclaration('PencilDemoPage') || sourceFile.getFunction('PencilDemoPage');
if (component) {
...
fs.writeFileSync('extracted_pencil.json', JSON.stringify(dict, null, 2));
