...
const sourceFile = project.addSourceFileAtPath('src/pages/knowledge/KSealStandUpPouchesPage.tsx');
...
const component = sourceFile.getVariableDeclaration('KSealStandUpPouchesPage') || sourceFile.getFunction('KSealStandUpPouchesPage');
if (component) {
...
fs.writeFileSync('extracted_kseal.json', JSON.stringify(dict, null, 2));
