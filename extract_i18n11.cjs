...
const sourceFile = project.addSourceFileAtPath('src/pages/DomainHomePage.tsx');
...
const component = sourceFile.getVariableDeclaration('DomainHomePage') || sourceFile.getFunction('DomainHomePage');
if (component) {
...
fs.writeFileSync('extracted_domain_home.json', JSON.stringify(dict, null, 2));
