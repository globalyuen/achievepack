...
const sourceFile = project.addSourceFileAtPath('src/pages/knowledge/FinSealLapSealPage.tsx');
...
const component = sourceFile.getVariableDeclaration('FinSealLapSealPage') || sourceFile.getFunction('FinSealLapSealPage');
if (component) {
...
fs.writeFileSync('extracted_fin_seal.json', JSON.stringify(dict, null, 2));
