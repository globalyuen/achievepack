...
const sourceFile = project.addSourceFileAtPath('src/pages/NotFoundPage.tsx');
...
const component = sourceFile.getVariableDeclaration('NotFoundPage') || sourceFile.getFunction('NotFoundPage');
if (component) {
...
fs.writeFileSync('extracted_not_found.json', JSON.stringify(dict, null, 2));
