...
const sourceFile = project.addSourceFileAtPath('src/pages/blog/BlogPostPage.tsx');
...
const component = sourceFile.getVariableDeclaration('BlogPostPage') || sourceFile.getFunction('BlogPostPage');
if (component) {
...
fs.writeFileSync('extracted_blog_post.json', JSON.stringify(dict, null, 2));
