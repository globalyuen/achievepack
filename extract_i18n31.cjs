...
const sourceFile = project.addSourceFileAtPath('src/pages/free-service/AchieveBathDemoPage.tsx');
...
const component = sourceFile.getVariableDeclaration('AchieveBathDemoPage') || sourceFile.getFunction('AchieveBathDemoPage');
if (component) {
...
fs.writeFileSync('extracted_achieve_bath.json', JSON.stringify(dict, null, 2));
