...
const sourceFile = project.addSourceFileAtPath('src/pages/knowledge/WhiteInkUnderprintPage.tsx');
...
const component = sourceFile.getVariableDeclaration('WhiteInkUnderprintPage') || sourceFile.getFunction('WhiteInkUnderprintPage');
if (component) {
...
fs.writeFileSync('extracted_white_ink.json', JSON.stringify(dict, null, 2));
