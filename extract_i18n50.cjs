...
const sourceFile = project.addSourceFileAtPath('src/pages/topics/ChildResistantMylarBagsPage.tsx');
...
const component = sourceFile.getVariableDeclaration('ChildResistantMylarBagsPage') || sourceFile.getFunction('ChildResistantMylarBagsPage');
if (component) {
...
fs.writeFileSync('extracted_child_resistant.json', JSON.stringify(dict, null, 2));
