...
const sourceFile = project.addSourceFileAtPath('src/pages/topics/DigitalPrintingEcoPackagingPage.tsx');
...
const component = sourceFile.getVariableDeclaration('DigitalPrintingEcoPackagingPage') || sourceFile.getFunction('DigitalPrintingEcoPackagingPage');
if (component) {
...
fs.writeFileSync('extracted_digital_print.json', JSON.stringify(dict, null, 2));
