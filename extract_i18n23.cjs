...
const sourceFile = project.addSourceFileAtPath('src/pages/PouchDielineFinderPage.tsx');
...
const component = sourceFile.getVariableDeclaration('PouchDielineFinderPage') || sourceFile.getFunction('PouchDielineFinderPage') || sourceFile.getVariableDeclaration('PouchDielineFinder') || sourceFile.getFunction('PouchDielineFinder');
if (component) {
...
fs.writeFileSync('extracted_pouch_dieline.json', JSON.stringify(dict, null, 2));
