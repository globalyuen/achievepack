...
const sourceFile = project.addSourceFileAtPath('src/pages/PouchEcoPTNPage.tsx');
...
const component = sourceFile.getVariableDeclaration('PouchEcoPTNPage') || sourceFile.getFunction('PouchEcoPTNPage');
if (component) {
...
fs.writeFileSync('extracted_pouch_eco_ptn.json', JSON.stringify(dict, null, 2));
