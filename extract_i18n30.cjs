...
const sourceFile = project.addSourceFileAtPath('src/pages/PouchEcoSizeGuidePage.tsx');
...
const component = sourceFile.getVariableDeclaration('PouchEcoSizeGuidePage') || sourceFile.getFunction('PouchEcoSizeGuidePage');
if (component) {
...
fs.writeFileSync('extracted_pouch_eco_size.json', JSON.stringify(dict, null, 2));
