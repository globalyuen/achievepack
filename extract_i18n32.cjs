...
const sourceFile = project.addSourceFileAtPath('src/pages/free-service/FreePackagingDesignPage.tsx');
...
const component = sourceFile.getVariableDeclaration('FreePackagingDesignPage') || sourceFile.getFunction('FreePackagingDesignPage');
if (component) {
...
fs.writeFileSync('extracted_free_design.json', JSON.stringify(dict, null, 2));
