...
const sourceFile = project.addSourceFileAtPath('src/pages/topics/CompostableBabyFoodBagsPage.tsx');
...
const component = sourceFile.getVariableDeclaration('CompostableBabyFoodBagsPage') || sourceFile.getFunction('CompostableBabyFoodBagsPage');
if (component) {
...
fs.writeFileSync('extracted_compostable_baby.json', JSON.stringify(dict, null, 2));
