...
export const TESTIMONIALS: Testimonial[] = [
  // === TRUSTPILOT REVIEWS ===
  {
    ...
    company: '',
    role: '',
    quote: "The team at Pouch.eco are amazing. My account manager Jericha was in touch with me throughout the process. As a new business, I had lots of questions and Jericha answered each one even sending me photos and videos to ensure I had chosen the right size and material. The aesthetic of the packaging was important to me and I'm so pleased with the final outcome. The quality is great, the printing is crisp, and I love that it is compostable. I would highly recommend them!",
    shortQuote: "Amazing team - quality great, printing crisp, love that it's compostable!",
    extraInfo: 'Trustpilot Review, GB, Oct 2023',
    ownerImage: 'https://ui-avatars.com/api/?name=Jasmin+M&background=22c55e&color=fff&size=128',
    companyLogo: '',
    brandLogo: '',
  ...
  },
  {
    ...
    name: 'Melanie Dylan Kim',
    company: 'Eloquence International',
    role: '',
    quote: "It was an absolute pleasure working with Ryan from Eco Pouch. Not only was he very thorough with checking all of the different designs, color matching them, and amazing at showing me the library of samples available. He really helped us meet a close to impossible deadline. Really appreciate the team at Eco pouch! Thank you for our beautiful thank you cards, cute stickers, and custom envelopes!",
    shortQuote: "Helped us meet a close to impossible deadline!",
    extraInfo: 'Trustpilot Review, HK, Sep 2021',
    ownerImage: 'https://ui-avatars.com/api/?name=Melanie+Kim&background=8b5cf6&color=fff&size=128',
    companyLogo: '',
    brandLogo: '',
  ...
  {
    id: 'nastasha-mckeon',
    name: 'Nastasha McKeon',
    company: '',
    role: '',
    quote: "We had an issue getting our order. It was stuck in customs for weeks. The company reached out and got a new order processed for us. I'm happy to report we finally received that order & are very happy with the products.",
    shortQuote: "Company reached out and got a new order processed for us!",
    extraInfo: 'Trustpilot Review, US, Aug 2023',
    ownerImage: 'https://ui-avatars.com/api/?name=Nastasha+M&background=f59e0b&color=fff&size=128',
    companyLogo: '',
    brandLogo: '',
  ...
  },
  {
    ...
    company: '',
    role: '',
    quote: "Amazing product! We're really proud of our biodegradable, plastic-free pouches, plus they give us a great point of difference!",
    shortQuote: "Really proud of our biodegradable, plastic-free pouches!",
    extraInfo: 'Trustpilot Review, GB, Apr 2023',
    ownerImage: 'https://ui-avatars.com/api/?name=Paul+Ramos&background=3b82f6&color=fff&size=128',
    companyLogo: '',
    brandLogo: '',
    bgColor: 'bg-blue-100',
    pouchImage: '/imgs/testimonials/pouch-hover/morlife.webp',
  },
  {
    ...
    company: '',
    role: '',
    quote: "Friendly, knowledgeable and always available to clarify any doubts. They approached me with the utmost professionalism, despite the fact that I have a small business that has just opened. Highly recommended!",
    shortQuote: "Utmost professionalism for small businesses. Highly recommended!",
    extraInfo: 'Trustpilot Review, IT, Mar 2023',
    ownerImage: 'https://ui-avatars.com/api/?name=Carlo+C&background=ef4444&color=fff&size=128',
    companyLogo: '',
    brandLogo: '',
    bgColor: 'bg-red-100',
    pouchImage: '/imgs/testimonials/pouch-hover/morlife.webp',
  },
  {
    ...
    company: '',
    role: '',
    quote: "I am totally satisfied with the 3 side seal bags I ordered from Pouch.eco. Excellent communication with Jericha, and very good quality products quickly delivered in France.",
    shortQuote: "Excellent communication, very good quality, quickly delivered!",
    extraInfo: 'Trustpilot Review, FR, Sep 2022',
    ownerImage: 'https://ui-avatars.com/api/?name=Alexandre+G&background=0ea5e9&color=fff&size=128',
    companyLogo: '',
    brandLogo: '',
    bgColor: 'bg-sky-100',
    pouchImage: '/imgs/testimonials/pouch-hover/morlife.webp',
  },
  {
    ...
    company: '',
    role: '',
    quote: "Thorough follow up and quality product - very responsive and trustworthy supplier. I have been re-ordering from them since we started our first purchase. Highly recommended!",
    shortQuote: "Very responsive and trustworthy supplier. Highly recommended!",
    extraInfo: 'Trustpilot Review, HK, Sep 2022',
    ownerImage: 'https://ui-avatars.com/api/?name=L+S&background=14b8a6&color=fff&size=128',
    companyLogo: '',
    brandLogo: '',
    bgColor: 'bg-teal-100',
    pouchImage: '/imgs/testimonials/pouch-hover/morlife.webp',
  },
  {
    ...
    company: '',
    role: '',
    quote: "Very good packaging and very helpful! Will be back to order soon.",
    shortQuote: "Very good packaging and very helpful!",
    extraInfo: 'Trustpilot Review, NL, Jun 2022',
    ownerImage: 'https://ui-avatars.com/api/?name=Nelus+C&background=a855f7&color=fff&size=128',
    companyLogo: '',
    brandLogo: '',
  ...
  },
  {
    ...
    company: '',
    role: '',
    quote: "Ryan and Jericha from Achieve Pack are easy to deal with and professional. When a small problem emerged with our packaging they were quick to fix it free of charge and very quickly. We will continue to do business with them!",
    shortQuote: "Easy to deal with, professional, quick to fix any issues!",
    extraInfo: 'Trustpilot Review, NZ, Jun 2022',
    ownerImage: 'https://ui-avatars.com/api/?name=Harvey+H&background=22c55e&color=fff&size=128',
    companyLogo: '',
    brandLogo: '',
  ...
  },
  {
    ...
    company: '',
    role: '',
    quote: "Great service, quality of pouch is really good.",
    shortQuote: "Great service, quality of pouch is really good!",
    extraInfo: 'Trustpilot Review, ES, May 2022',
    ownerImage: 'https://ui-avatars.com/api/?name=Muhammad+B&background=f97316&color=fff&size=128',
    companyLogo: '',
    brandLogo: '',
  ...
  },
  {
    ...
    company: '',
    role: '',
    quote: "We worked with Pouch.eco from the start - product development, changes, samples, print and shipping. We can totally recommend Pouch.eco for startups or all forms of companies.",
    shortQuote: "Totally recommend for startups or all forms of companies!",
    extraInfo: 'Trustpilot Review, DE, Feb 2022',
    ownerImage: 'https://ui-avatars.com/api/?name=Steffen&background=6366f1&color=fff&size=128',
    companyLogo: '',
    brandLogo: '',
  ...
  },
  {
    ...
    company: '',
    role: '',
    quote: "Very happy, good quality and great customer service. I will definitely buy again. Very fast production, shipping and overall process.",
    shortQuote: "Very fast production, shipping and overall process!",
    extraInfo: 'Trustpilot Review, CA, Jan 2022',
    ownerImage: 'https://ui-avatars.com/api/?name=JM&background=ec4899&color=fff&size=128',
    companyLogo: '',
    brandLogo: '',
    bgColor: 'bg-pink-100',
    pouchImage: '/imgs/testimonials/pouch-hover/morlife.webp',
  },
  {
    ...
    name: 'Sarah Evaravenspell',
    company: '',
    role: '',
    quote: "I was SOOO GLAD to have contacted Ryan to make my pouches for our tea leaves packaging. I was more than impressed with the outcome. Ryan has given me ideas on how to improve the packaging, making it even more exclusive than ever. Quality is impeccable, printing wise and material wise. Price is so affordable! I couldn't be happier. Two thumbs up!",
    shortQuote: "Quality impeccable, printing and material wise. Two thumbs up!",
    extraInfo: 'Trustpilot Review, MY, Sep 2021',
    ownerImage: 'https://ui-avatars.com/api/?name=Sarah+E&background=84cc16&color=fff&size=128',
    companyLogo: '',
    brandLogo: '',
    bgColor: 'bg-lime-100',
    pouchImage: '/imgs/testimonials/pouch-hover/morlife.webp',
  },
  {
    ...
    company: '',
    role: '',
    quote: "Working with Achieve Pack and Pouch.eco has been a real pleasure. Ryan Wong knows his products. He is diligent, organized, and works to ensure customer satisfaction.",
    shortQuote: "Ryan is diligent, organized, ensures customer satisfaction!",
    extraInfo: 'Trustpilot Review, US, Aug 2021',
    ownerImage: 'https://ui-avatars.com/api/?name=FM+Allen&background=0891b2&color=fff&size=128',
    companyLogo: '',
    brandLogo: '',
    bgColor: 'bg-cyan-100',
    pouchImage: '/imgs/testimonials/pouch-hover/morlife.webp',
  },
  {
    ...
    company: '',
    role: '',
    quote: "Very helpful and professional staff with great customer service. They made sure I got exactly what I wanted. Would definitely recommend and will reorder.",
    shortQuote: "Made sure I got exactly what I wanted. Will reorder!",
    extraInfo: 'Trustpilot Review, AU, Jul 2021',
    ownerImage: 'https://ui-avatars.com/api/?name=Deidre+H&background=d946ef&color=fff&size=128',
    companyLogo: '',
    brandLogo: '',
  ...
  },
  {
    ...
    company: '',
    role: '',
    quote: "So beyond impressed with my new packaging for my wall decal company!!! Incredible service and incredible quality.",
    shortQuote: "Incredible service and incredible quality!",
    extraInfo: 'Trustpilot Review, CA, Jul 2021',
    ownerImage: 'https://ui-avatars.com/api/?name=Caitlyn+D&background=f43f5e&color=fff&size=128',
    companyLogo: '',
    brandLogo: '',
    bgColor: 'bg-rose-100',
    pouchImage: '/imgs/testimonials/pouch-hover/morlife.webp',
  ...
  {
    id: 'eunice-ng',
    name: 'Eunice Yvette Ng',
    company: '',
    role: '',
    quote: "Excellent service and reasonable pricing. Very good! Will recommend.",
    shortQuote: "Excellent service and reasonable pricing!",
    extraInfo: 'Trustpilot Review, SG, Jun 2021',
    ownerImage: 'https://ui-avatars.com/api/?name=Eunice+Ng&background=10b981&color=fff&size=128',
    companyLogo: '',
    brandLogo: '',
    bgColor: 'bg-emerald-100',
    pouchImage: '/imgs/testimonials/pouch-hover/morlife.webp',
  },
  {
    ...
    company: '',
    role: '',
    quote: "Amazing. Thank you, very highly recommend.",
    shortQuote: "Amazing. Very highly recommend!",
    extraInfo: 'Trustpilot Review, GB, May 2021',
    ownerImage: 'https://ui-avatars.com/api/?name=Sarah+T&background=eab308&color=fff&size=128',
    companyLogo: '',
    brandLogo: '',
  ...
  },
  {
    ...
    company: '',
    role: '',
    quote: "Ryan has been helpful, professional and very responsive since day 1. He helped design my stand up pouch for my Sauce. The Pouches was glossy and high quality. Shipment arrived on time to the UK. Can't wait for my next batch!",
    shortQuote: "Glossy and high quality pouches, arrived on time!",
    extraInfo: 'Trustpilot Review, GB, May 2021',
    ownerImage: 'https://ui-avatars.com/api/?name=Mary+E&background=8b5cf6&color=fff&size=128',
    companyLogo: '',
    brandLogo: '',
    bgColor: 'bg-violet-100',
    pouchImage: '/imgs/testimonials/pouch-hover/morlife.webp',
  },
  {
    ...
    company: '',
    role: '',
    quote: "Wow this company was really awesome. Their product rock and their customer services is A +++.",
    shortQuote: "Product rocks and customer service is A+++!",
    extraInfo: 'Trustpilot Review, CA, Apr 2021',
    ownerImage: 'https://ui-avatars.com/api/?name=ato+crew&background=06b6d4&color=fff&size=128',
    companyLogo: '',
    brandLogo: '',
    bgColor: 'bg-cyan-100',
    pouchImage: '/imgs/testimonials/pouch-hover/morlife.webp',
  },
  {
    ...
    company: '',
    role: '',
    quote: "Really helpful, informative company who are keen to work with you for what you need at a price that works for you. Ryan really cares about his products and was keen to find something workable for me. Really pleased they offer solutions to properly sustainable packaging. They also offer smaller print runs for small companies like myself.",
    shortQuote: "Properly sustainable packaging with smaller print runs!",
    extraInfo: 'Trustpilot Review, GB, Apr 2021',
    ownerImage: 'https://ui-avatars.com/api/?name=Thea+S&background=22c55e&color=fff&size=128',
    companyLogo: '',
    brandLogo: '',
    bgColor: 'bg-green-100',
    pouchImage: '/imgs/testimonials/pouch-hover/morlife.webp',
  },
  {
    ...
    company: '',
    role: '',
    quote: "Quick responses to queries about products and sample looks great. Pleased to find eco pouch supplier with reasonable MoQ.",
    shortQuote: "Quick responses, reasonable MoQ. Pleased!",
    extraInfo: 'Trustpilot Review, GB, Mar 2021',
    ownerImage: 'https://ui-avatars.com/api/?name=J+Cook&background=f97316&color=fff&size=128',
    companyLogo: '',
    brandLogo: '',
    bgColor: 'bg-orange-100',
    pouchImage: '/imgs/testimonials/pouch-hover/morlife.webp',
  },
  {
    ...
    company: '',
    role: '',
    quote: "The ENTIRE Team of Ryan, Jackie et al has been VERY pro-active!",
    shortQuote: "The entire team has been VERY pro-active!",
    extraInfo: 'Trustpilot Review, US, Mar 2021',
    ownerImage: 'https://ui-avatars.com/api/?name=Ramesh&background=6366f1&color=fff&size=128',
    companyLogo: '',
    brandLogo: '',
    bgColor: 'bg-indigo-100',
    pouchImage: '/imgs/testimonials/pouch-hover/morlife.webp',
  },
  {
    ...
    company: '',
    role: '',
    quote: "Clear and fast communication. Really fast shipping!",
    shortQuote: "Clear, fast communication and really fast shipping!",
    extraInfo: 'Trustpilot Review, CA, Mar 2021',
    ownerImage: 'https://ui-avatars.com/api/?name=Danielle&background=ec4899&color=fff&size=128',
    companyLogo: '',
    brandLogo: '',
    bgColor: 'bg-pink-100',
    pouchImage: '/imgs/testimonials/pouch-hover/morlife.webp',
  },
  {
    ...
    company: '',
    role: '',
    quote: "Very good quality, reasonable price and environment friendly.",
    shortQuote: "Good quality, reasonable price, environment friendly!",
    extraInfo: 'Trustpilot Review, GB, Mar 2021',
    ownerImage: 'https://ui-avatars.com/api/?name=Rubel+Roy&background=84cc16&color=fff&size=128',
    companyLogo: '',
    brandLogo: '',
    bgColor: 'bg-lime-100',
    pouchImage: '/imgs/testimonials/pouch-hover/morlife.webp',
  ...
  // === ORIGINAL TESTIMONIALS WITH IMAGES ===
  {
    ...
    ownerImage: '/imgs/testimonials/owner/michelle.webp',
  ...
  },
  {
    ...
    ownerImage: '/imgs/testimonials/owner/nicole.webp',
  ...
  },
  {
    ...
    ownerImage: '/imgs/testimonials/owner/jemma.webp',
  ...
  },
  {
    ...
    ownerImage: '/imgs/testimonials/owner/ruby.webp',
  ...
  },
  {
    ...
    ownerImage: '/imgs/testimonials/owner/Richard.webp',
  ...
  },
  {
    ...
    ownerImage: '/imgs/testimonials/owner/arielle.webp',
  ...
  },
  {
    ...
    ownerImage: '/imgs/testimonials/owner/leo.webp',
  ...
  },
  {
    ...
    extraInfo: '2 years ago',
    ownerImage: '/imgs/testimonials/owner/remi.webp',
  ...
  },
  {
    ...
    extraInfo: '2 years ago',
    ownerImage: '/imgs/testimonials/owner/david.webp',
  ...
  },
  {
    ...
    extraInfo: '2 years ago',
    ownerImage: '/imgs/testimonials/owner/Paul.webp',
  ...
  },
  {
    ...
    ownerImage: '/imgs/testimonials/owner/Steph.webp',
  ...
  },
  {
    ...
    ownerImage: '/imgs/testimonials/owner/cheryl.webp',
