...
import { Mail, ArrowLeft, Loader2, ChevronLeft, ChevronRight } from 'lucide-react'
  ...
  const slides = [
    {
      ...
      title: t(`${p}.slides.0.title`),
      description: t(`${p}.slides.0.description`)
    },
    {
      image: '/imgs/sign-in/slide-2.webp',
      title: t(`${p}.slides.1.title`),
      description: t(`${p}.slides.1.description`)
    },
    {
      image: '/imgs/sign-in/slide-3.webp',
      title: t(`${p}.slides.2.title`),
      description: t(`${p}.slides.2.description`)
    },
    {
      image: '/imgs/sign-in/slide-4.webp',
      title: t(`${p}.slides.3.title`),
      description: t(`${p}.slides.3.description`)
    }
  ]
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    className="w-full pl-12 pr-4 py-3 border border-neutral-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent transition" 
              ...
              <div className="flex justify-center gap-2">
                {otpCode.map((digit, index) => (
                  <input
                    ...
                    className="w-10 h-12 text-center text-xl font-bold border border-neutral-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent transition"
                    autoFocus={index === 0}
                  />
                ))}
              </div>
