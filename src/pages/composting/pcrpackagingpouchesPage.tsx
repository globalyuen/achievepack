...
const PcrpackagingpouchesPage: React.FC = () => {
  const { t } = useTranslation()
  const p = 'seoPages.pages.pcrPackagingPouches'
  ...
  return (
    <SEOPageLayout
      ...
      canonicalUrl="https://achievepack.com/pcr-packaging-pouches"
      heroTitle={t(`${p}.heroTitle`)}
      heroSubtitle={t(`${p}.heroSubtitle`)}
      heroImage="/imgs/seo/pcr_pouch_1.png"
...
export default PcrpackagingpouchesPage
