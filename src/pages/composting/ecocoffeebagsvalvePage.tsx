...
const EcocoffeebagsvalvePage: React.FC = () => {
  const { t } = useTranslation()
  const p = 'seoPages.pages.ecoCoffeeValve'
  ...
  return (
    <SEOPageLayout
      ...
      canonicalUrl="https://achievepack.com/eco-coffee-bags-valve"
...
export default EcocoffeebagsvalvePage
