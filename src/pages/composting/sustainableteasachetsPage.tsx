...
const SustainableteasachetsPage: React.FC = () => {
  const { t } = useTranslation()
  const p = 'seoPages.pages.sustainableTeaSachets'
  ...
  return (
    <SEOPageLayout
      ...
      canonicalUrl="https://achievepack.com/sustainable-tea-sachets"
      heroTitle={t(`${p}.heroTitle`)}
      heroSubtitle={t(`${p}.heroSubtitle`)}
      heroImage="/imgs/seo/tea_sachet_1.png"
...
export default SustainableteasachetsPage
