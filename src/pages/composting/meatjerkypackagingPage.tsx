...
const MeatjerkypackagingPage: React.FC = () => {
  const { t } = useTranslation()
  const p = 'seoPages.pages.meatJerkyPackaging'
  ...
  return (
    <SEOPageLayout
      ...
      canonicalUrl="https://achievepack.com/meat-jerky-packaging"
      heroTitle={t(`${p}.heroTitle`)}
      heroSubtitle={t(`${p}.heroSubtitle`)}
      heroImage="/imgs/seo/meat_jerky_1.png"
...
export default MeatjerkypackagingPage
