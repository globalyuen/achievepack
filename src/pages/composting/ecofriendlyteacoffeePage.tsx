...
const EcofriendlyteacoffeePage: React.FC = () => {
  const { t } = useTranslation()
  const p = 'seoPages.pages.ecoTeaCoffee'
  ...
  return (
    <SEOPageLayout
      ...
      canonicalUrl="https://achievepack.com/eco-friendly-tea-coffee"
...
export default EcofriendlyteacoffeePage
