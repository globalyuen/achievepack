...
const EuroholehangbagsPage: React.FC = () => {
  const { t } = useTranslation()
  const p = 'seoPages.pages.euroHoleHang'
  ...
  return (
    <SEOPageLayout
      ...
      canonicalUrl="https://achievepack.com/euro-hole-hang-bags"
...
export default EuroholehangbagsPage
