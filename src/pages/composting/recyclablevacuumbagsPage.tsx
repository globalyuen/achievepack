...
const RecyclablevacuumbagsPage: React.FC = () => {
  const { t } = useTranslation()
  const p = 'seoPages.pages.recyclableVacuumBags'
  ...
  return (
    <SEOPageLayout
      ...
      canonicalUrl="https://achievepack.com/recyclable-vacuum-bags"
      heroTitle={t(`${p}.heroTitle`)}
      heroSubtitle={t(`${p}.heroSubtitle`)}
      heroImage="/imgs/seo/vacuum_bag_1.png"
...
export default RecyclablevacuumbagsPage
