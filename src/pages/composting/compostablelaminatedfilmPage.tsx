...
const CompostablelaminatedfilmPage: React.FC = () => {
  const { t } = useTranslation()
  const p = 'seoPages.pages.compostableLaminatedFilm'
      ...
      content: (
        <div className="space-y-4 text-neutral-700">
          ...
          <div className="flex justify-center">
            <ClickableImage 
              src="/imgs/illustrated/a_topic_03_coffee_materials_var_c_6491567.webp" 
              alt={t(`${p}.title`)} 
  ...
  return (
    <SEOPageLayout
      ...
      canonicalUrl="https://achievepack.com/compostable-laminated-film"
      heroTitle={t(`${p}.heroTitle`)}
      heroSubtitle={t(`${p}.heroSubtitle`)}
      heroImage="/imgs/illustrated/a_topic_03_coffee_materials_var_c_6491567.webp"
...
export default CompostablelaminatedfilmPage
