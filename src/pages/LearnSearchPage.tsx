...
const ALL_PAGES = [
  ...
  // PCR
  { name: 'What Is PCR Plastic?', link: '/pcr/pcr-plastic-guide', image: '/imgs/pcr/guide/a_pcr_sustainability_impact_story_3330780.webp', category: 'Materials', description: 'Complete guide to PCR (Post-Consumer Recycled) plastic: what it is, how it affects packaging quality, food safety considerations, and practical implementation for SME brands', keywords: ['PCR plastic', 'post-consumer recycled', 'recycled plastic', 'PCR quality', 'PCR food safety', 'recycled content', 'sustainable packaging'] },
  ...
  { name: 'Realistic PCR Content Levels', link: '/pcr/realistic-pcr-content', image: '/imgs/pcr/real/a_pcr_definition_measurement_8980939.webp', category: 'Materials', description: 'How much PCR content is realistic for packaging: what 20%, 50%, and 100% PCR means, retailer expectations, and achievable targets for SME brands', keywords: ['PCR percentage', 'realistic PCR', 'PCR content', 'retailer PCR', 'PCR targets', 'recycled content levels'] },
