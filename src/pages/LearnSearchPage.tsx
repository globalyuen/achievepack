...
const ALL_PAGES = [
  ...
  { name: 'Spout Pouches', link: '/packaging/spout-pouches', image: '/imgs/illustrated/a_achievepack_spout_pouches_4058117.webp', category: 'Packaging', description: 'Pouches with pour spout for liquids and gels', keywords: ['spout', 'liquid', 'pour', 'cap'] },
  ...
  { name: 'Low Barrier', link: '/features/low-barrier', image: '/imgs/illustrated/a_lowbarrier_presentation_c_9188452.webp', category: 'Features', description: 'Low barrier options for dry goods with short shelf life', keywords: ['low barrier', 'dry goods', 'short shelf'] },
  { name: 'Medium Barrier', link: '/features/medium-barrier', image: '/imgs/illustrated/a_mediumbarrier_presentation_c_5439721.webp', category: 'Features', description: 'Medium barrier for coffee, snacks, and everyday products', keywords: ['medium barrier', 'coffee', 'snacks'] },
  { name: 'High Barrier', link: '/features/high-barrier', image: '/imgs/illustrated/a_highbarrier_presentation_c_3827146.webp', category: 'Features', description: 'Maximum protection with aluminum foil barrier', keywords: ['high barrier', 'aluminum', 'foil'] },
  ...
  { name: 'Sauces & Condiments', link: '/industry/sauces-condiments', image: '/imgs/illustrated/a_sauces_condiments_hero_v1_6823941.webp', category: 'Industries', description: 'Liquid-safe packaging for sauces and condiments', keywords: ['sauce', 'condiment', 'ketchup', 'liquid'] },
