...
const ALL_PAGES = [
  ...
  { name: 'Composting Service Finder', link: '/compostable/composting-services', image: '/imgs/compostable/vs/a_lifecycle_compostable_infographic_2163778.webp', category: 'Topics', description: 'Find local composting facilities and drop-off locations across the USA', keywords: ['composting', 'compost service', 'drop-off', 'facility', 'disposal', 'end-of-life'] },
  { name: 'Composting Benefits for Our Planet', link: '/compostable/composting-benefits', image: '/imgs/compostable/benefits/a_achievepack_composting_locator_hero_9733153.webp', category: 'Topics', description: 'How composting cuts emissions, protects soil and water, and what it means for your packaging', keywords: ['composting benefits', 'emissions', 'soil health', 'environment', 'circular economy', 'sustainable packaging'] },
    { name: 'How Commercial Composting Works', link: '/compostable/commercial-composting', image: '/imgs/compostable/commercial/hero.webp', category: 'Topics', description: 'A practical guide to windrow, aerated static pile and in-vessel composting from Achievepack® experts', keywords: ['commercial composting', 'industrial composting', 'windrow', 'aerated static pile', 'in-vessel', 'composting facility', 'EN 13432', 'ASTM D6400'] },
