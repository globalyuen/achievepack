    ...
    <PouchLayout>
      ...
      <section className="relative pt-12 pb-24 border-b-4 border-black bg-[radial-gradient(#4c1d95_1px,transparent_1px)] [background-size:24px_24px] bg-neutral-50">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <h1 className="mt-8 font-black text-6xl md:text-9xl leading-none uppercase italic">Art.<br/>Pure.<br/><span className="text-black drop-shadow-[4px_4px_0px_rgba(212,255,0,1)]">Identity.</span></h1>
          <p className="mt-8 text-xl md:text-2xl font-bold font-['JetBrains_Mono'] text-gray-800 max-w-3xl mx-auto bg-white border-4 border-black p-6 shadow-[12px_12px_0px_0px_rgba(0,0,0,1)]">
            Your brand is a story. We engineer custom printed sustainable pouches that deliver that story with G7-certified precision, 1200 DPI resolution, and zero-plate agility.
          </p>
