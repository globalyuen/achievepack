...
import { Leaf, Package, CheckCircle, Award, Zap, Globe, Factory, Recycle, BarChart3, ArrowLeftRight, TrendingUp, ShoppingBag, Target, Shield, MessageCircle, Thermometer, Wind, Droplets, Microscope, Beaker, Trash2, Layers } from 'lucide-react'
    ...
    <PouchLayout>
      ...
      <section className="relative pt-12 pb-24 border-b-4 border-black bg-[radial-gradient(#065f46_1px,transparent_1px)] [background-size:24px_24px] bg-emerald-50">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <h1 className="mt-8 font-black text-6xl md:text-9xl leading-none uppercase italic">Less.<br/>Waste.<br/><span className="text-emerald-800 drop-shadow-[4px_4px_0px_rgba(212,255,0,1)]">More.</span></h1>
          <p className="mt-8 text-xl md:text-2xl font-bold font-['JetBrains_Mono'] text-gray-800 max-w-3xl mx-auto bg-white border-4 border-black p-6 shadow-[12px_12px_0px_0px_rgba(0,0,0,1)]">
            Efficiency is the ultimate form of sustainability. We engineer source reduction into every pouch structure, utilizing advanced lightweighting tech to eliminate waste before it ever hits the supply chain.
          </p>
