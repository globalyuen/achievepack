...
const PouchSpoutPouchesPage: React.FC = () => {
  const { t, i18n } = useTranslation();
  const baseKey = 'seoPages.pages.spoutPouches';
  ...
  return (
    <PouchLayout>
      <SEOPageLayout
        ...
        secondaryKeywords={["Liquid packaging pouches", "spouted bags", "beverage pouches"]}
        schemaType="Product"
        language={lang}
        ...
        targetUrl={`https://pouch.eco/packaging/spout-pouches`}
      />
    </PouchLayout>
  );
};

export default PouchSpoutPouchesPage;
