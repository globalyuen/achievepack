...
export default function PouchHomePage() {
  ...
  return (
    <PouchLayout>
      <Helmet>
        <title>{t("seoPages.pages.pouchHomePage.meta.title", "POUCH.ECO - Sustainable Eco Packaging for Startups")}</title>
        <meta name="description" content={t("seoPages.pages.pouchHomePage.meta.description", "Sustainable packaging made simple. Low MOQ compostable pouches for startups. Get started with 500 units.")} />
      </Helmet>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8 z-10">
              <div className="inline-block bg-[#D4FF00] border-4 border-black px-4 py-2 transform -rotate-2 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
                <span className="font-['JetBrains_Mono'] font-bold text-sm">{t("seoPages.pages.pouchHomePage.hero.ecoSystem", "ECO_SYSTEM v2026")}</span>
              </div>
              
              <h1 className="font-black text-6xl md:text-8xl leading-[0.9] tracking-tighter uppercase">
                {t("seoPages.pages.pouchHomePage.hero.start", "Start.")}<br/>
                {t("seoPages.pages.pouchHomePage.hero.scale", "Scale.")}<br/>
                <Typewriter words={[t("seoPages.pages.pouchHomePage.hero.sustain", "Sustain."), t("seoPages.pages.pouchHomePage.hero.eco", "Eco."), t("seoPages.pages.pouchHomePage.hero.digital", "Digital.")]} />
              </h1>
              ...
              <div className="bg-white border-2 border-black p-4 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] max-w-md">
                <p className="font-['JetBrains_Mono'] font-bold text-lg md:text-xl">
                  &gt; {t("seoPages.pages.pouchHomePage.hero.bullets.moq", "Eco packaging from 500 units.")}<br/>
                  &gt; {t("seoPages.pages.pouchHomePage.hero.bullets.materials", "Compostable // Recyclable // Bio-based.")}<br/>
                  &gt; {t("seoPages.pages.pouchHomePage.hero.bullets.speed", "Fast turnaround. No BS.")}
                </p>
                {/* Eco Material Badges */}
                <div className="flex gap-4 mt-4 border-t-2 border-black pt-4">
                  <img src="/eco-logo/transparent-bkg/compost.png" alt={t("seoPages.pages.pouchHomePage.hero.alts.compostable", "Compostable")} className="h-12 md:h-16 w-auto hover:scale-110 transition-transform" />
                  <img src="/eco-logo/transparent-bkg/recycle.png" alt={t("seoPages.pages.pouchHomePage.hero.alts.recyclable", "Recyclable")} className="h-12 md:h-16 w-auto hover:scale-110 transition-transform" />
                  <img src="/eco-logo/transparent-bkg/biope.png" alt={t("seoPages.pages.pouchHomePage.hero.alts.biobased", "Bio-based")} className="h-12 md:h-16 w-auto hover:scale-110 transition-transform" />
                  <img src="/eco-logo/transparent-bkg/pcr.png" alt={t("seoPages.pages.pouchHomePage.hero.alts.pcr", "PCR")} className="h-12 md:h-16 w-auto hover:scale-110 transition-transform" />
                </div>
              </div>

              <div className="flex flex-col sm:flex-row gap-4">
                <NeoButton href="https://calendly.com/30-min-free-packaging-consultancy">{t("seoPages.pages.pouchHomePage.hero.buttons.book", "Book Consultation")}</NeoButton>
                <NeoButton to="/materials">{t("seoPages.pages.pouchHomePage.hero.buttons.materials", "View Materials")}</NeoButton>
              </div>
            </div>
            ...
            <div className="relative w-full max-w-md lg:max-w-[540px] aspect-square mx-auto lg:ml-auto lg:mr-0 mb-10 md:mb-0">
              ...
              <button 
                ...
                aria-label={t("seoPages.pages.pouchHomePage.hero.buttons.prev", "Previous video")}
              >
              ...
              <button 
                ...
                aria-label={t("seoPages.pages.pouchHomePage.hero.buttons.next", "Next video")}
              >
              ...
              >
                <NeoCard className="bg-white w-full h-full !p-0 overflow-hidden group relative">
                  ...
                  <motion.div animate={floatAnim} className="absolute top-4 right-4 bg-white border-2 border-black px-2 py-1 font-['JetBrains_Mono'] text-xs font-bold shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] z-20">
                    {t("seoPages.pages.pouchHomePage.hero.tags.compostable", "COMPOSTABLE_OK")}
                  </motion.div>
              ...
              >
                <NeoCard className="bg-white w-full h-full !p-0 overflow-hidden group relative">
                  ...
                  {/* Floating Tag */}
                  <motion.div animate={floatAnim} className="absolute top-4 right-4 bg-white border-2 border-black px-2 py-1 font-['JetBrains_Mono'] text-xs font-bold shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] z-20">
                    {t("seoPages.pages.pouchHomePage.hero.tags.recyclable", "RECYCLABLE_OK")}
                  </motion.div>
              ...
              >
                <NeoCard className="bg-white w-full h-full !p-0 overflow-hidden group relative">
                  ...
                  {/* Floating Tag */}
                  <motion.div animate={floatAnim} className="absolute top-4 right-4 bg-white border-2 border-black px-2 py-1 font-['JetBrains_Mono'] text-xs font-bold shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] z-20">
                    {t("seoPages.pages.pouchHomePage.hero.tags.industrial", "INDUSTRIAL_OK")}
                  </motion.div>
              ...
              >
                <NeoCard className="bg-white w-full h-full !p-0 overflow-hidden group relative">
                  ...
                  {/* Floating Tag */}
                  <motion.div animate={floatAnim} className="absolute top-4 right-4 bg-white border-2 border-black px-2 py-1 font-['JetBrains_Mono'] text-xs font-bold shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] z-20">
                    {t("seoPages.pages.pouchHomePage.hero.tags.pcr", "PCR_BARRIER_OK")}
                  </motion.div>
              ...
              >
                <NeoCard className="bg-white w-full h-full !p-0 overflow-hidden group relative">
                  ...
                  {/* Floating Tag */}
                  <motion.div animate={floatAnim} className="absolute top-4 right-4 bg-white border-2 border-black px-2 py-1 font-['JetBrains_Mono'] text-xs font-bold shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] z-20">
                    {t("seoPages.pages.pouchHomePage.hero.tags.biobased", "BIO_BASED_OK")}
                  </motion.div>
              ...
              <div className="absolute -bottom-6 -left-6 w-24 h-24 md:w-32 md:h-32 bg-[#FF00FF] border-4 border-black flex items-center justify-center animate-bounce z-[70]">
                <span className="font-black text-sm md:text-xl rotate-[-15deg]">{t("seoPages.pages.pouchHomePage.hero.badge", "500!")}</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 px-4 bg-white border-y-4 border-black overflow-hidden">
        <div className="max-w-6xl mx-auto mb-12 text-center">
          <div className="inline-block bg-[#D4FF00] border-4 border-black px-4 py-2 transform rotate-1 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] mb-6">
            <span className="font-['JetBrains_Mono'] font-bold uppercase">{t("seoPages.pages.pouchHomePage.trusted.badge", "TRUSTED_BY")}</span>
          </div>
          <h2 className="font-black text-4xl md:text-5xl uppercase mb-4">
            {t("seoPages.pages.pouchHomePage.trusted.title", "Join 500+ Brands")}
          </h2>
          <p className="text-lg text-gray-700 font-['Space_Grotesk']">
            {t("seoPages.pages.pouchHomePage.trusted.subtitle", "From startups to established names - they all started with 500 units")}
          </p>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-20">
            <div className="inline-block bg-[#10b981] border-4 border-black px-4 py-2 transform -rotate-1 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] text-white font-black text-xs uppercase tracking-wider mb-6">
              {t("seoPages.pages.pouchHomePage.showcase.badge", "✨ Interactive 3D Showcase")}
            </div>
            <h2 className="font-black text-5xl md:text-7xl uppercase leading-[0.9] tracking-tighter text-black">
              {t("seoPages.pages.pouchHomePage.showcase.title", "Eco Bags in 3D Space")}
            </h2>
            <p className="font-['JetBrains_Mono'] text-lg mt-6 leading-relaxed max-w-2xl mx-auto text-neutral-800">
              {t("seoPages.pages.pouchHomePage.showcase.subtitle", "Rotate, tilt, and inspect the certified organic structural barriers of our green pouches. Move your mouse to tilt, scroll to spin, or toggle models below.")}
            </p>
          </div>
            ...
            <div className="lg:col-span-5 space-y-8">
              ...
              >
                ...
                <div className="mt-6 pt-4 border-t-2 border-dashed border-black grid grid-cols-2 gap-4 font-['JetBrains_Mono'] text-xs text-black">
                  <div>
                    <span className="font-bold block uppercase tracking-wider text-black">{t("seoPages.pages.pouchHomePage.showcase.spouted.moqLabel", "MOQ:")}</span>
                    <span className="font-black bg-white px-2 py-0.5 border border-black inline-block mt-1">{t("seoPages.pages.pouchHomePage.showcase.spouted.moqVal", "2,000 units")}</span>
                  </div>
                  <div>
                    <span className="font-bold block uppercase tracking-wider text-black">{t("seoPages.pages.pouchHomePage.showcase.spouted.certLabel", "Certifications:")}</span>
                    <span className="font-black text-[#10b981] bg-white px-2 py-0.5 border border-black inline-block mt-1">{t("seoPages.pages.pouchHomePage.showcase.spouted.certVal", "EN 13432, ASTM D6400")}</span>
                  </div>
                </div>
              </button>
              ...
              >
                ...
                <div className="mt-6 pt-4 border-t-2 border-dashed border-black grid grid-cols-2 gap-4 font-['JetBrains_Mono'] text-xs text-black">
                  <div>
                    <span className="font-bold block uppercase tracking-wider text-black">{t("seoPages.pages.pouchHomePage.showcase.flatBottom.moqLabel", "MOQ:")}</span>
                    <span className="font-black bg-white px-2 py-0.5 border border-black inline-block mt-1">{t("seoPages.pages.pouchHomePage.showcase.flatBottom.moqVal", "1,000 units")}</span>
                  </div>
                  <div>
                    <span className="font-bold block uppercase tracking-wider text-black">{t("seoPages.pages.pouchHomePage.showcase.flatBottom.certLabel", "Certifications:")}</span>
                    <span className="font-black text-[#10b981] bg-white px-2 py-0.5 border border-black inline-block mt-1">{t("seoPages.pages.pouchHomePage.showcase.flatBottom.certVal", "OK Compost HOME")}</span>
                  </div>
                </div>
              </button>
            </div>
      ...
      <section className="py-24 px-4 md:px-6 max-w-[1920px] mx-auto overflow-hidden">
        <div className="text-center mb-16">
          <div className="inline-block bg-black text-[#D4FF00] px-4 py-1 mb-6 font-['JetBrains_Mono'] font-bold transform -rotate-1">
            {t("seoPages.pages.pouchHomePage.social.badge", "REAL PRODUCTS • REAL BRANDS")}
          </div>
          <h2 className="font-black text-5xl md:text-8xl uppercase mb-6 tracking-tighter">
            {t("seoPages.pages.pouchHomePage.social.title", "As Seen In Social")}
          </h2>
          <p className="font-['JetBrains_Mono'] text-lg max-w-2xl mx-auto text-gray-700">
            {t("seoPages.pages.pouchHomePage.social.desc", "Watch how our pouches help brands go viral. Unboxing experiences that customers love to share.")}
          </p>
        </div>
      ...
      <section className="py-24 px-4 md:px-6 max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
          <h2 className="font-black text-5xl md:text-7xl uppercase leading-none">
            {t("seoPages.pages.pouchHomePage.features.title", "Core Features")}
          </h2>
          <div className="font-['JetBrains_Mono'] text-sm font-bold bg-[#D4FF00] border-2 border-black px-4 py-2">
            {t("seoPages.pages.pouchHomePage.features.selectMaterial", "SELECT_MATERIAL_BELOW")}
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <NeoCard className="md:col-span-2 bg-[#F0F0F0] relative overflow-hidden group">
            <div className="relative z-10">
              ...
              <h3 className="font-black text-3xl mb-4 uppercase">{t("seoPages.pages.pouchHomePage.features.moq.title", "Low MOQ Protocol")}</h3>
              <p className="font-['JetBrains_Mono'] text-sm leading-relaxed mb-6 max-w-md">
                {t("seoPages.pages.pouchHomePage.features.moq.desc", "Start with just 500 units. Test your market without massive inventory commitment. Perfect for startups and new product launches.")}
              </p>
              <div className="flex gap-2">
                <NeoBadge color="bg-[#D4FF00]">{t("seoPages.pages.pouchHomePage.features.moq.badge1", "500_MIN")}</NeoBadge>
                <NeoBadge color="bg-[#00FFFF]">{t("seoPages.pages.pouchHomePage.features.moq.badge2", "Fast_Launch")}</NeoBadge>
              </div>
            </div>
          ...
          <NeoCard color="bg-[#00FFFF]" className="flex flex-col justify-between group overflow-hidden relative">
            <div className="relative z-10">
              ...
              <h3 className="font-black text-3xl mb-2 uppercase">{t("seoPages.pages.pouchHomePage.features.compostable.title", "Bio_Matrix")}</h3>
              <p className="font-['JetBrains_Mono'] text-sm mb-4">{t("seoPages.pages.pouchHomePage.features.compostable.desc", "Certified compostable materials. Industrial + home compost ready.")}</p>
            </div>
            <div className="font-['JetBrains_Mono'] text-xs border-t-2 border-black pt-4 mt-4 relative z-10">
              {t("seoPages.pages.pouchHomePage.features.compostable.statusLabel", "STATUS:")} <span className="font-bold">{t("seoPages.pages.pouchHomePage.features.compostable.statusVal", "BPI_CERTIFIED")}</span>
            </div>
          ...
          <NeoCard color="bg-[#D4FF00]" className="flex flex-col justify-between group overflow-hidden relative">
            <div className="relative z-10">
              ...
              <h3 className="font-black text-3xl mb-2 uppercase">{t("seoPages.pages.pouchHomePage.features.fast.title", "Fast_Ship")}</h3>
              <p className="font-['JetBrains_Mono'] text-sm mb-4">{t("seoPages.pages.pouchHomePage.features.fast.desc", "Samples in 2-3 weeks. Production in 6-8 weeks. No delays.")}</p>
            </div>
            <div className="font-['JetBrains_Mono'] text-xs border-t-2 border-black pt-4 mt-4 relative z-10">
              {t("seoPages.pages.pouchHomePage.features.fast.speedLabel", "SPEED:")} <span className="font-bold">{t("seoPages.pages.pouchHomePage.features.fast.speedVal", "OPTIMIZED")}</span>
            </div>
          ...
          <NeoCard className="md:col-span-2 bg-white relative overflow-hidden group">
            <div className="relative z-10">
              ...
              <h3 className="font-black text-3xl mb-4 uppercase">{t("seoPages.pages.pouchHomePage.features.barrier.title", "High-Barrier Tech")}</h3>
              <p className="font-['JetBrains_Mono'] text-sm leading-relaxed mb-6 max-w-lg">
                {t("seoPages.pages.pouchHomePage.features.barrier.desc", "Multi-layer barrier structures. O2 + moisture blocking. Keeps product fresh for 6-18 months shelf life.")}
              </p>
              <NeoButton to="/tech-specs" className="text-sm">{t("seoPages.pages.pouchHomePage.features.barrier.btn", "View Tech Specs")}</NeoButton>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <div className="inline-block bg-black text-[#D4FF00] border-4 border-black px-4 py-2 transform -rotate-1 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] font-['JetBrains_Mono'] font-bold text-xs uppercase mb-6">
              {t("seoPages.pages.pouchHomePage.appSuite.badge", "⚡ INTERACTIVE_UTILITIES")}
            </div>
            <h2 className="font-black text-5xl md:text-7xl uppercase leading-[0.9] tracking-tighter text-black">
              {t("seoPages.pages.pouchHomePage.appSuite.title", "PACKAGING APP SUITE")}
            </h2>
            <p className="font-['Space_Grotesk'] text-lg mt-6 leading-relaxed max-w-2xl mx-auto text-black font-semibold">
              {t("seoPages.pages.pouchHomePage.appSuite.subtitle", "Engineer your pouch sizing and material specifications instantly. No guessing, no errors. Pure technical precision.")}
            </p>
          </div>
            ...
            <div className="bg-white border-4 border-black p-8 shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] hover:shadow-[16px_16px_0px_0px_rgba(0,0,0,1)] transition-all flex flex-col justify-between group">
              <div>
                <div className="flex justify-between items-start mb-6 pb-4 border-b-2 border-black">
                  ...
                  <NeoBadge color="bg-[#FF00FF] text-white">{t("seoPages.pages.pouchHomePage.appSuite.sizing.badge", "SIZING APP")}</NeoBadge>
                </div>
                
                <h3 className="font-black text-3xl mb-4 uppercase">{t("seoPages.pages.pouchHomePage.appSuite.sizing.title", "[SIZING FINDER APP]")}</h3>
                <p className="font-['JetBrains_Mono'] text-sm leading-relaxed mb-6 text-neutral-800">
                  {t("seoPages.pages.pouchHomePage.appSuite.sizing.desc", "Calculate exact dimensions and capacity based on product weight & density presets. Match dimensions instantly with standard manufacturing templates.")}
                </p>
                ...
                <ul className="space-y-3 mb-8 font-['JetBrains_Mono'] text-xs font-bold text-black uppercase">
                  <li className="flex items-center gap-2">
                    ...
                    <span>{t("seoPages.pages.pouchHomePage.appSuite.sizing.bullets.0", "Density presets (Coffee, Powders, Snacks)")}</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="w-2.5 h-2.5 border border-black bg-[#D4FF00]"></span>
                    <span>{t("seoPages.pages.pouchHomePage.appSuite.sizing.bullets.1", "Volume calculations (Ounces, Grams, ML)")}</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="w-2.5 h-2.5 border border-black bg-[#D4FF00]"></span>
                    <span>{t("seoPages.pages.pouchHomePage.appSuite.sizing.bullets.2", "Standard MoQ and size reference matching")}</span>
                  </li>
                </ul>
              </div>

              <NeoButton to="/size-guide" variant="dark" className="w-full text-center py-4 text-base font-black uppercase">
                {t("seoPages.pages.pouchHomePage.appSuite.sizing.btn", "LAUNCH SIZING APP →")}
              </NeoButton>
            </div>
            ...
            <div className="bg-white border-4 border-black p-8 shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] hover:shadow-[16px_16px_0px_0px_rgba(0,0,0,1)] transition-all flex flex-col justify-between group">
              <div>
                <div className="flex justify-between items-start mb-6 pb-4 border-b-2 border-black">
                  ...
                  <NeoBadge color="bg-[#D4FF00] text-black">{t("seoPages.pages.pouchHomePage.appSuite.spec.badge", "MATERIAL SPEC")}</NeoBadge>
                </div>
                
                <h3 className="font-black text-3xl mb-4 uppercase">{t("seoPages.pages.pouchHomePage.appSuite.spec.title", "[SPEC FINDER APP]")}</h3>
                <p className="font-['JetBrains_Mono'] text-sm leading-relaxed mb-6 text-neutral-800">
                  {t("seoPages.pages.pouchHomePage.appSuite.spec.desc", "Search, filter, and compare water vapor & oxygen transmission rates (OTR/WVTR) across 15+ certified compostable, recyclable, PCR, and plant-based biopolymer structures.")}
                </p>

                <ul className="space-y-3 mb-8 font-['JetBrains_Mono'] text-xs font-bold text-black uppercase">
                  <li className="flex items-center gap-2">
                    <span className="w-2.5 h-2.5 border border-black bg-[#FF00FF]"></span>
                    <span>{t("seoPages.pages.pouchHomePage.appSuite.spec.bullets.0", "15+ eco duplex & triplex structures")}</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="w-2.5 h-2.5 border border-black bg-[#FF00FF]"></span>
                    <span>{t("seoPages.pages.pouchHomePage.appSuite.spec.bullets.1", "OTR & WVTR performance level filtering")}</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="w-2.5 h-2.5 border border-black bg-[#FF00FF]"></span>
                    <span>{t("seoPages.pages.pouchHomePage.appSuite.spec.bullets.2", "Full thickness & weight sheets download")}</span>
                  </li>
                </ul>
              </div>

              <NeoButton to="/tech-specs" variant="dark" className="w-full text-center py-4 text-base font-black uppercase">
                {t("seoPages.pages.pouchHomePage.appSuite.spec.btn", "LAUNCH SPEC FINDER →")}
              </NeoButton>
            </div>
          </div>
        </div>
      ...
      <section ref={productsRef} className="py-24 bg-black border-y-4 border-[#D4FF00]">
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          <h2 className="font-black text-5xl md:text-7xl uppercase text-white mb-16 text-center">
            {t("seoPages.pages.pouchHomePage.choosePlan.title", "Choose Plan")}
          </h2>
              ...
              <NeoCard key={product.id} className="h-full flex flex-col p-0 overflow-hidden">
                <div className={`relative bg-white p-6 h-full flex flex-col`}>
                  <div className="bg-gray-100 border-2 border-black aspect-square mb-6 flex items-center justify-center relative overflow-hidden">
                    ...
                    <img 
                      src={product.image} 
                      alt={t("seoPages.pages.pouchHomePage.choosePlan." + (product.id === "stand-up" ? "standUp" : product.id === "flat-bottom" ? "flatBottom" : "spouted") + ".name", product.name)}
                  ...
                  <h3 className="font-black text-3xl mb-2 uppercase">{t("seoPages.pages.pouchHomePage.choosePlan." + (product.id === "stand-up" ? "standUp" : product.id === "flat-bottom" ? "flatBottom" : "spouted") + ".name", product.name)}</h3>
                  <p className="font-['JetBrains_Mono'] text-sm mb-6 flex-grow">{t("seoPages.pages.pouchHomePage.choosePlan." + (product.id === "stand-up" ? "standUp" : product.id === "flat-bottom" ? "flatBottom" : "spouted") + ".desc", product.description)}</p>
                  ...
                  <div className="grid grid-cols-3 gap-2 mb-6 font-['JetBrains_Mono'] text-xs border-y-2 border-black py-4 bg-gray-50">
                    <div className="text-center">
                      ...
                      <div>{t("seoPages.pages.pouchHomePage.choosePlan." + (product.id === "stand-up" ? "standUp" : product.id === "flat-bottom" ? "flatBottom" : "spouted") + ".moq", product.stats.moq)}</div>
                    </div>
                    <div className="text-center border-l-2 border-black">
                      <div className="font-bold">MAT</div>
                      <div>{t("seoPages.pages.pouchHomePage.choosePlan." + (product.id === "stand-up" ? "standUp" : product.id === "flat-bottom" ? "flatBottom" : "spouted") + ".mat", product.stats.material)}</div>
                    </div>
                    <div className="text-center border-l-2 border-black">
                      <div className="font-bold">BAR</div>
                      <div>{t("seoPages.pages.pouchHomePage.choosePlan." + (product.id === "stand-up" ? "standUp" : product.id === "flat-bottom" ? "flatBottom" : "spouted") + ".bar", product.stats.barrier)}</div>
                    </div>
                  </div>
                  ...
                  <NeoButton className="w-full" href="https://calendly.com/30-min-free-packaging-consultancy">
                    {t("seoPages.pages.pouchHomePage.choosePlan.bookCall", "BOOK CALL")}
                  </NeoButton>
                </div>
              </NeoCard>
            ))}
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <div className="inline-block bg-[#FF00FF] text-white border-4 border-black px-4 py-2 transform rotate-1 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] font-['JetBrains_Mono'] font-bold text-xs uppercase mb-6">
              {t("seoPages.pages.pouchHomePage.knowledge.badge", "📚 KNOWLEDGE_PORTAL")}
            </div>
            <h2 className="font-black text-5xl md:text-7xl uppercase leading-[0.9] tracking-tighter text-black">
              {t("seoPages.pages.pouchHomePage.knowledge.title", "ECO RESOURCE & LIBRARY")}
            </h2>
            <p className="font-['Space_Grotesk'] text-lg mt-6 leading-relaxed text-neutral-800 font-semibold">
              {t("seoPages.pages.pouchHomePage.knowledge.subtitle", "Deep-dive technical reports, global compliance playbooks, and circular economy research drafted by certified experts to keep your brand aligned.")}
            </p>
          </div>
              ...
              <div>
                <div className="flex justify-between items-center mb-4">
                  <span className="bg-[#D4FF00] border-2 border-black text-black px-2 py-0.5 text-[10px] font-black uppercase font-['JetBrains_Mono']">
                    {t("seoPages.pages.pouchHomePage.knowledge.guides.compliance.tag", "COMPLIANCE_2026")}
                  </span>
                  <ShieldCheck className="w-5 h-5 text-green-600" />
                </div>
                <h3 className="font-black text-xl mb-3 uppercase leading-tight group-hover:text-[#10b981] transition-colors">
                  {t("seoPages.pages.pouchHomePage.knowledge.guides.compliance.title", "EU PPWR Compliance Guide")}
                </h3>
                <p className="font-['JetBrains_Mono'] text-xs leading-relaxed mb-6 text-neutral-600">
                  {t("seoPages.pages.pouchHomePage.knowledge.guides.compliance.desc", "Detailed analysis of void space ratios, harmonized recycling sorting labels, and eco-modulated modulation fees relief for EU-bound brand owners.")}
                </p>
              </div>
              <NeoButton to="/blog/eu-ppwr-compliance-guide" className="text-xs !py-2.5 !px-4 w-full text-center">
                {t("seoPages.pages.pouchHomePage.knowledge.guides.compliance.btn", "Read Playbook →")}
              </NeoButton>
            </NeoCard>
              ...
              <div>
                <div className="flex justify-between items-center mb-4">
                  <span className="bg-[#00FFFF] border-2 border-black text-black px-2 py-0.5 text-[10px] font-black uppercase font-['JetBrains_Mono']">
                    {t("seoPages.pages.pouchHomePage.knowledge.guides.foil.tag", "RECYCLING_SPECS")}
                  </span>
                  <BookOpen className="w-5 h-5 text-blue-600" />
                </div>
                <h3 className="font-black text-xl mb-3 uppercase leading-tight group-hover:text-[#10b981] transition-colors">
                  {t("seoPages.pages.pouchHomePage.knowledge.guides.foil.title", "Stamp Foil Recyclability")}
                </h3>
                <p className="font-['JetBrains_Mono'] text-xs leading-relaxed mb-6 text-neutral-600">
                  {t("seoPages.pages.pouchHomePage.knowledge.guides.foil.desc", "How hot stamp foils and metallic decorative embellishments affect sorting telemetry in municipal mono-material recycling streams.")}
                </p>
              </div>
              <NeoButton to="/blog/stamp-foil-recyclability" className="text-xs !py-2.5 !px-4 w-full text-center">
                {t("seoPages.pages.pouchHomePage.knowledge.guides.foil.btn", "Read Research →")}
              </NeoButton>
            </NeoCard>
              ...
              <div>
                <div className="flex justify-between items-center mb-4">
                  <span className="bg-[#FF00FF] text-white border-2 border-black px-2 py-0.5 text-[10px] font-black uppercase font-['JetBrains_Mono']">
                    {t("seoPages.pages.pouchHomePage.knowledge.guides.zipper.tag", "MATERIAL_SCIENCE")}
                  </span>
                  <Zap className="w-5 h-5 text-pink-600" />
                </div>
                <h3 className="font-black text-xl mb-3 uppercase leading-tight group-hover:text-[#10b981] transition-colors">
                  {t("seoPages.pages.pouchHomePage.knowledge.guides.zipper.title", "Compostable Zipper Durability")}
                </h3>
                <p className="font-['JetBrains_Mono'] text-xs leading-relaxed mb-6 text-neutral-600">
                  {t("seoPages.pages.pouchHomePage.knowledge.guides.zipper.desc", "Analyzing oxygen transmission rates and tensile grip durability of 100% plant-based reclosure zippers without removal requirements.")}
                </p>
              </div>
              <NeoButton to="/topics/compostable-zipper-durability" className="text-xs !py-2.5 !px-4 w-full text-center">
                {t("seoPages.pages.pouchHomePage.knowledge.guides.zipper.btn", "Read Technical Study →")}
              </NeoButton>
            </NeoCard>
              ...
              <div>
                <div className="flex justify-between items-center mb-4">
                  <span className="bg-black text-[#D4FF00] border-2 border-black px-2 py-0.5 text-[10px] font-black uppercase font-['JetBrains_Mono']">
                    {t("seoPages.pages.pouchHomePage.knowledge.guides.roi.tag", "PROCUREMENT_ROI")}
                  </span>
                  <Leaf className="w-5 h-5 text-black" />
                </div>
                <h3 className="font-black text-xl mb-3 uppercase leading-tight group-hover:text-white transition-colors">
                  {t("seoPages.pages.pouchHomePage.knowledge.guides.roi.title", "Standard Runs vs. Custom Specs")}
                </h3>
                <p className="font-['JetBrains_Mono'] text-xs leading-relaxed mb-6 text-neutral-850">
                  {t("seoPages.pages.pouchHomePage.knowledge.guides.roi.desc", "Decision matrix comparing pre-made online packaging stock models with custom-engineered bulk B2B production specs to optimize unit pricing.")}
                </p>
              </div>
              <NeoButton to="/topics/custom-vs-standard-packaging" variant="secondary" className="text-xs !py-2.5 !px-4 w-full text-center">
                {t("seoPages.pages.pouchHomePage.knowledge.guides.roi.btn", "Compare Spec Sheets →")}
              </NeoButton>
            </NeoCard>
          </div>
          ...
          <div className="mt-12 bg-neutral-50 border-4 border-black p-6 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] grid md:grid-cols-2 lg:grid-cols-3 gap-4 font-['JetBrains_Mono'] text-sm font-bold uppercase">
            <Link to="/topics/real-world-sustainability" className="flex items-center justify-between p-3 border-2 border-black bg-white hover:bg-[#D4FF00] transition-colors group">
              <span>{t("seoPages.pages.pouchHomePage.knowledge.links.sustainability", "🌱 Real-World Circular Sustainability")}</span>
            ...
            <Link to="/topics/compostable-spouted-pouches" className="flex items-center justify-between p-3 border-2 border-black bg-white hover:bg-[#00FFFF] transition-colors group">
              <span>{t("seoPages.pages.pouchHomePage.knowledge.links.spoutedComposting", "💧 Spouted Biopolymer Composting")}</span>
              <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
            </Link>
            <Link to="/solutions/citrus-oil-packaging" className="flex items-center justify-between p-3 border-2 border-black bg-white hover:bg-[#FF00FF] hover:text-white transition-colors group">
              <span className="group-hover:text-white">{t("seoPages.pages.pouchHomePage.knowledge.links.citrus", "🍊 Citrus Oil Protective Barriers")}</span>
      ...
      <section className="py-24 px-4 md:px-6 max-w-5xl mx-auto">
        <NeoCard color="bg-[#FF00FF]" className="text-center">
          ...
          <blockquote className="font-['JetBrains_Mono'] text-xl font-bold text-white mb-6 leading-relaxed">
            {t("seoPages.pages.pouchHomePage.testimonial.quote", "\"Started with 500 pouches from POUCH.ECO. Best decision ever. Now ordering 10K+ monthly.\"")}
          </blockquote>
          <cite className="font-black text-lg text-white uppercase">
            {t("seoPages.pages.pouchHomePage.testimonial.author", "- Sarah M., Brand Founder")}
          </cite>
        </NeoCard>
      </section>
