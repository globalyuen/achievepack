        ...
        <table border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td style="padding-right: 20px;">
                    <img src="https://achievepack.com/imgs/emails/ryan_photo.png" alt="Ryan" width="100" height="100" style="width: 100px; height: 100px; border-radius: 500px; object-fit: cover; border: 4px solid #D4FF00; display: block; -webkit-border-radius: 500px; -moz-border-radius: 500px;">
                </td>
                <td valign="middle">
