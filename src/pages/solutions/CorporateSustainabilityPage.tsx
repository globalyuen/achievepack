        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@graph": [
              {
                "@type": "TechArticle",
                "headline": "Corporate Sustainability Packaging Technical Specifications & Lab Parameters",
              ...
              {
                "@type": "HowTo",
                "name": "How to Customize & Order Corporate Sustainability Packaging",
                "step": [
                  {
                    "@type": "HowToStep",
        ...
        <section className="my-12 bg-primary-950/80 border border-primary-500/40 rounded-3xl p-8 shadow-2xl flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="space-y-2 text-left max-w-2xl">
            ...
            <p className="text-primary-200/90 text-sm leading-relaxed">
              Work 1-on-1 with dedicated packaging engineers to customize barrier films, optimize dieline structural integrity, and ensure zero plate fee multi-SKU printing for Corporate Sustainability.
            </p>
          </div>
