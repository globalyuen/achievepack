...
const SurfaceFinishPage: React.FC = () => {
  ...
  const sections = [
    ...
    },
    {
      ...
      content: (
        <div className="space-y-6">
          <p className="text-neutral-700">Different industries have different surface finish requirements，Choosing the right coating is key to brand differentiation。</p>
          <div className="grid md:grid-cols-3 gap-4">
            <div className="bg-gradient-to-br from-amber-50 to-yellow-50 p-5 rounded-xl border border-amber-200">
              <div className="flex items-center gap-2 mb-3">
                <ShoppingBag className="h-5 w-5 text-amber-600" />
                <h4 className="font-semibold text-amber-800">HighPremium Food Brands</h4>
              </div>
              <p className="text-sm text-amber-700 mb-3">Soft-touch coating、Hot foil stamping elevates brand perceived value。</p>
              <div className="text-xs text-amber-600 bg-amber-100 px-2 py-1 rounded inline-block">Share:: 40%</div>
            </div>
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 p-5 rounded-xl border border-green-200">
              <div className="flex items-center gap-2 mb-3">
                <Sparkles className="h-5 w-5 text-green-600" />
                <h4 className="font-semibold text-green-800">Organic Natural Brands</h4>
              </div>
              <p className="text-sm text-green-700 mb-3">Matte finish、Kraft paper look conveys natural eco-friendly values。</p>
              <div className="text-xs text-green-600 bg-green-100 px-2 py-1 rounded inline-block">Share:: 35%</div>
            </div>
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-5 rounded-xl border border-blue-200">
              <div className="flex items-center gap-2 mb-3">
                <Package className="h-5 w-5 text-blue-600" />
                <h4 className="font-semibold text-blue-800">Retail Foods</h4>
              </div>
              <p className="text-sm text-blue-700 mb-3">Gloss finish、Vibrant colors enhance shelf appeal。</p>
          ...
          <div className="bg-neutral-50 p-4 rounded-lg mt-4">
            ...
            <p className="text-sm text-neutral-600">「After upgrading from standard gloss to soft-touch+Hot foil stampingLOGOAfter，our product retail price increased by15%，Customer feedbackHighhighly praised the packaging texture。」— Premium nut brand founder</p>
          </div>
        </div>
      )
    },
    {
      ...
      content: (
        <div className="space-y-6">
          <p className="text-neutral-700">HighPremium surface finish market continues to grow，Consumer demands for packaging texture are increasinglyHigh。</p>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="bg-white border border-neutral-200 p-4 rounded-xl text-center">
              ...
              <div className="text-xs text-neutral-500">of consumers value packaging texture</div>
            ...
            <div className="bg-white border border-neutral-200 p-4 rounded-xl text-center">
              ...
              <div className="text-xs text-neutral-500">Global packaging print finishing market</div>
              <div className="flex items-center justify-center gap-1 mt-2 text-green-600 text-xs">
                <TrendingUp className="h-3 w-3" />
                <span>yeargrowth 4.5%</span>
              </div>
            </div>
            <div className="bg-white border border-neutral-200 p-4 rounded-xl text-center">
              <div className="text-3xl font-bold text-green-600 mb-1">85%</div>
              <div className="text-xs text-neutral-500">of brands prioritize packaging differentiation</div>
              <div className="flex items-center justify-center gap-1 mt-2 text-green-600 text-xs">
                <TrendingUp className="h-3 w-3" />
                <span>stable</span>
              </div>
            ...
            <div className="bg-white border border-neutral-200 p-4 rounded-xl text-center">
              ...
              <div className="text-xs text-neutral-500">Soft-touch coatinggrowth</div>
              <div className="flex items-center justify-center gap-1 mt-2 text-green-600 text-xs">
                <TrendingUp className="h-3 w-3" />
          ...
          <div className="bg-blue-50 p-4 rounded-lg">
            ...
            <p className="text-sm text-blue-700">Soft-touch coatingfor its uniqueTactile ExperiencebecomingHighpremium brands for its unique tactile experience，Especially in coffee、nuts、Pet Foodcategoriesgrowthsignificant，Expected by2026market share will reach30%。</p>
          </div>
        </div>
      )
    },
    {
      ...
      content: (
        <div className="space-y-6">
          <p className="text-neutral-700">Comparison of different surface finish effects，to help you choose the best solution。</p>
          <div className="overflow-x-auto">
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr className="bg-neutral-100">
                  <th className="text-left p-3 border font-semibold">Surface Finish</th>
                  <th className="text-left p-3 border font-semibold">Visual Effect</th>
                  <th className="text-left p-3 border font-semibold">Tactile Experience</th>
                  <th className="text-left p-3 border font-semibold">Suitable Brands</th>
                  <th className="text-left p-3 border font-semibold">CostCost Impact</th>
                </tr>
              </thead>
              <tbody>
                <tr className="hover:bg-green-50">
                  <td className="p-3 border"><span className="px-2 py-1 bg-green-100 text-green-700 rounded text-xs font-medium">Gloss</span></td>
                  <td className="p-3 border">Vibrant、HighShiny</td>
                  <td className="p-3 border">Smooth</td>
                  <td className="p-3 border">Retail Foods、Beverages</td>
                  <td className="p-3 border text-green-600 font-medium">Baseline</td>
                </tr>
                <tr className="hover:bg-blue-50">
                  <td className="p-3 border"><span className="px-2 py-1 bg-blue-100 text-blue-700 rounded text-xs font-medium">Matte</span></td>
                  <td className="p-3 border">Elegant、Sophisticated</td>
                  <td className="p-3 border">Smooth</td>
                  <td className="p-3 border">HighPremium brands、Organic</td>
                  <td className="p-3 border text-green-600 font-medium">Baseline</td>
                </tr>
                <tr className="hover:bg-amber-50">
                  <td className="p-3 border"><span className="px-2 py-1 bg-amber-100 text-amber-700 rounded text-xs font-medium">Soft-touch</span></td>
                  <td className="p-3 border">HighPremium、Luxurious</td>
                  <td className="p-3 border">Velvet、Silky</td>
                  <td className="p-3 border">Luxury brands、Beauty</td>
                  <td className="p-3 border text-amber-600 font-medium">+10-15%</td>
                </tr>
                <tr className="hover:bg-purple-50">
                  <td className="p-3 border"><span className="px-2 py-1 bg-purple-100 text-purple-700 rounded text-xs font-medium">Spot UVUV</span></td>
                  <td className="p-3 border">Contrast、Highlight</td>
                  <td className="p-3 border">Textured</td>
                  <td className="p-3 border">Brand emphasis</td>
                  <td className="p-3 border text-purple-600 font-medium">+$0.02-0.05/</td>
                </tr>
                <tr className="hover:bg-primary-50">
                  <td className="p-3 border"><span className="px-2 py-1 bg-primary-100 text-primary-700 rounded text-xs font-medium">Hot foil stamping</span></td>
                  <td className="p-3 border">Metallic、Luxurious</td>
                  <td className="p-3 border">Smooth</td>
                  <td className="p-3 border">HighpremiumLuxuriousproducts</td>
                  <td className="p-3 border text-primary-600 font-medium">+$0.05-0.15/</td>
                </tr>
              </tbody>
            </table>
          </div>
          <div className="bg-amber-50 p-4 rounded-lg">
            ...
            <p className="text-sm text-amber-700">choosechooseSurface Finishwhen，consider brand positioning、targetCustomersegment and budget。Combining multiple finishes can enhance packaging sophistication，for exampleMatte+Spot UVUV+Hot foil stampingLOGOcombination。</p>
          </div>
        </div>
      )
    }
