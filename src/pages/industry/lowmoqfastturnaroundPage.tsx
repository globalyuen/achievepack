...
const LowmoqfastturnaroundPage: React.FC = () => {
  const { t } = useTranslation()
  const p = 'seoPages.pages.lowMoqFast'
  ...
  return (
    <SEOPageLayout
      ...
      canonicalUrl="https://achievepack.com/low-moq-fast-turnaround"
...
export default LowmoqfastturnaroundPage
