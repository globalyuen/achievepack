...
const PetfoodquadsealPage: React.FC = () => {
  const { t } = useTranslation()
  const p = 'seoPages.pages.petFoodQuadSeal'
  ...
  return (
    <SEOPageLayout
      ...
      canonicalUrl="https://achievepack.com/pet-food-quad-seal"
      heroTitle={t(`${p}.heroTitle`)}
      heroSubtitle={t(`${p}.heroSubtitle`)}
      heroImage="/imgs/seo/pet_food_1.png"
...
export default PetfoodquadsealPage
