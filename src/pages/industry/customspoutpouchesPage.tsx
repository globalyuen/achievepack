...
const CustomspoutpouchesPage: React.FC = () => {
  const { t } = useTranslation()
  const p = 'seoPages.pages.customSpoutCosmetics'
      ...
      content: (
        <div className="space-y-4 text-neutral-700">
          ...
          <div className="flex justify-center">
            <ClickableImage 
              src="/imgs/illustrated/a_achievepack_spout_pouches_1062736.webp" 
              alt={t(`${p}.title`)} 
  ...
  return (
    <SEOPageLayout
      ...
      canonicalUrl="https://achievepack.com/custom-spout-pouches"
      heroTitle={t(`${p}.heroTitle`)}
      heroSubtitle={t(`${p}.heroSubtitle`)}
      heroImage="/imgs/illustrated/a_achievepack_spout_pouches_1062736.webp"
...
export default CustomspoutpouchesPage
