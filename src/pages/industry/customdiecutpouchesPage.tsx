...
const CustomdiecutpouchesPage: React.FC = () => {
  const { t } = useTranslation()
  const p = 'seoPages.pages.customDieCut'
      ...
      content: (
        <div className="space-y-4 text-neutral-700">
          ...
          <div className="flex justify-center">
            <ClickableImage 
              src="/imgs/illustrated/a_achievepack_standup_pouches_9884402.webp" 
              alt={t(`${p}.title`)} 
  ...
  return (
    <SEOPageLayout
      ...
      canonicalUrl="https://achievepack.com/custom-die-cut-pouches"
      heroTitle={t(`${p}.heroTitle`)}
      heroSubtitle={t(`${p}.heroSubtitle`)}
      heroImage="/imgs/illustrated/a_achievepack_standup_pouches_9884402.webp"
...
export default CustomdiecutpouchesPage
