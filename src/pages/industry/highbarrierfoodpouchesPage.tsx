...
const HighbarrierfoodpouchesPage: React.FC = () => {
  const { t } = useTranslation()
  const p = 'seoPages.pages.highBarrierFood'
        ...
        <div className="space-y-4 text-neutral-700">
          ...
          <div className="grid md:grid-cols-2 gap-6 justify-center">
            <div className="flex flex-col items-center">
              <ClickableImage 
                src="/imgs/seo/barrier_food_1.png" 
                alt={t(`${p}.title`)} 
            ...
            <div className="flex flex-col items-center">
              <ClickableImage 
                src="/imgs/seo/barrier_food_2.png" 
                alt={t(`${p}.title`)} 
                className="max-w-full rounded-lg shadow-lg border border-neutral-200 cursor-pointer hover:shadow-xl transition"
  ...
  return (
    <SEOPageLayout
      ...
      canonicalUrl="https://achievepack.com/high-barrier-food-pouches"
      heroTitle={t(`${p}.heroTitle`)}
      heroSubtitle={t(`${p}.heroSubtitle`)}
      heroImage="/imgs/seo/barrier_food_1.png"
...
export default HighbarrierfoodpouchesPage
