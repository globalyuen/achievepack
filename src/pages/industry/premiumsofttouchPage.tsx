...
const PremiumsofttouchPage: React.FC = () => {
  const { t } = useTranslation()
  const p = 'seoPages.pages.premiumSoftTouch'
  ...
  return (
    <SEOPageLayout
      ...
      canonicalUrl="https://achievepack.com/premium-soft-touch"
...
export default PremiumsofttouchPage
