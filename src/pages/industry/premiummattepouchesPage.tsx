...
const PremiummattepouchesPage: React.FC = () => {
  const { t } = useTranslation()
  const p = 'seoPages.pages.premiumMatte'
      ...
      content: (
        <div className="space-y-4 text-neutral-700">
          ...
          <div className="flex justify-center">
            <ClickableImage 
              src="/imgs/illustrated/a_surface_finish_close_detail_b_2163248.webp" 
              alt={t(`${p}.title`)} 
  ...
  return (
    <SEOPageLayout
      ...
      canonicalUrl="https://achievepack.com/premium-matte-pouches"
...
export default PremiummattepouchesPage
