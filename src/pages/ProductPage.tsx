        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="border-t border-neutral-800 pt-6">
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-6">
              <img src="/imgs/store/payment-logo/a_visa_logo_grey_5781158.webp" alt="Visa" className="h-8 w-auto brightness-0 invert opacity-70" />
              <img src="/imgs/store/payment-logo/a_mastercard_logo_grey_4350426.webp" alt="Mastercard" className="h-8 w-auto brightness-0 invert opacity-70" />
              <img src="/imgs/store/payment-logo/a_amex_logo_grey_3038228.webp" alt="American Express" className="h-8 w-auto brightness-0 invert opacity-70" />
              <img src="/imgs/store/payment-logo/a_paypal_logo_grey_3236525.webp" alt="PayPal" className="h-8 w-auto brightness-0 invert opacity-70" />
              <img src="/imgs/store/payment-logo/a_stripe_logo_grey_3625928.webp" alt="Stripe" className="h-8 w-auto brightness-0 invert opacity-70" />
            </div>
