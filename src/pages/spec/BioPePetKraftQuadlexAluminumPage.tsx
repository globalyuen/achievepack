...
const BioPePetKraftQuadlexAluminumPage: React.FC = () => {
  ...
  const p = 'seoPages.pages.bioPePetKraftQuadlexAluminum'
      ...
      content: (
        <div className="space-y-4 text-neutral-700">
          <div className="bg-amber-50 p-6 rounded-lg border border-amber-200">
            <ClickableImage
              src="/imgs/spec/bio-pe-pet-kraft-quadlex-aluminum.webp"
  ...
  const relatedLinks = [
    ...
    { title: t(`${p}.relatedLinks.link2.title`), url: "/spec/biope-pp-kraft-quadlex-aluminum", description: t(`${p}.relatedLinks.link2.description`) },
    { title: t(`${p}.relatedLinks.link3.title`), url: "/spec/biope-kraft-vmpet", description: t(`${p}.relatedLinks.link3.description`) },
