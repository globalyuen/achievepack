...
const MonoPeDuplexNoWindowPage: React.FC = () => {
  ...
  const p = 'seoPages.pages.monoPeDuplexNoWindow'
      ...
      content: (
        <div className="space-y-4 text-neutral-700">
          <div className="bg-blue-50 p-6 rounded-lg border border-blue-200">
            <ClickableImage
              src="/imgs/spec/mono-pe-duplex-no-window.webp"
            ...
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-sm text-blue-600">{t(`${p}.sections.structureOverview.badge`)}</span>
            </div>
            <div className="grid sm:grid-cols-2 gap-4 mt-4">
              ...
              <div className="bg-white p-3 rounded-lg">
                ...
                <p className="font-semibold text-blue-700">{t(`${p}.sections.structureOverview.layersValue`)}</p>
              </div>
            </div>
          </div>
        </div>
      ...
      content: (
        <div className="space-y-4 text-neutral-700">
          ...
          <div className="bg-blue-50 p-4 rounded-lg mt-4">
            <h4 className="font-semibold text-blue-800 mb-2">{t(`${p}.sections.barrierProperties.premiumShelf`)}</h4>
            <p className="text-sm text-blue-700">{t(`${p}.sections.barrierProperties.premiumShelfDesc`)}</p>
          </div>
        </div>
      )
    },
  ...
  const relatedLinks = [
    ...
    { title: t(`${p}.relatedLinks.link4.title`), url: "/materials/recyclable-mono-pe", description: t(`${p}.relatedLinks.link4.description`) },
  ]
