...
const PcrPpDuplexClearPage: React.FC = () => {
  ...
  const p = 'seoPages.pages.pcrPpDuplexClear'
  ...
  const relatedLinks = [
    ...
    { title: t(`${p}.relatedLinks.link4.title`), url: "/spec/pcr-pet-duplex-clear", description: t(`${p}.relatedLinks.link4.description`) },
  ]
