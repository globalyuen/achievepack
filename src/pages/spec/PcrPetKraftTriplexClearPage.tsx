...
const PcrPetKraftTriplexClearPage: React.FC = () => {
  ...
  const p = 'seoPages.pages.pcrPetKraftTriplexClear'
  ...
  const relatedLinks = [
    ...
    { title: t(`${p}.relatedLinks.link2.title`), url: "/spec/pcr-pet-duplex-clear", description: t(`${p}.relatedLinks.link2.description`) },
    { title: t(`${p}.relatedLinks.link3.title`), url: "/spec/pcr-pp-kraft-triplex-clear", description: t(`${p}.relatedLinks.link3.description`) },
    { title: t(`${p}.relatedLinks.link4.title`), url: "/materials/kraft-high-barrier", description: t(`${p}.relatedLinks.link4.description`) },
  ]
