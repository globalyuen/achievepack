...
const BioPePpDuplexClearPage: React.FC = () => {
  ...
  const p = 'seoPages.pages.bioPePpDuplexClear'
      ...
      content: (
        <div className="space-y-4 text-neutral-700">
          <div className="bg-green-50 p-6 rounded-lg border border-green-200">
            <ClickableImage
              src="/imgs/spec/bio-pe-pp-duplex-clear.webp"
  ...
  const relatedLinks = [
    ...
    { title: t(`${p}.relatedLinks.link4.title`), url: "/spec/biope-kraft-duplex-low", description: t(`${p}.relatedLinks.link4.description`) },
  ]
