...
const BioPeKraftDuplexLowPage: React.FC = () => {
  ...
  const p = 'seoPages.pages.bioPeKraftDuplexLow'
      ...
      content: (
        <div className="space-y-4 text-neutral-700">
          <div className="bg-amber-50 p-6 rounded-lg border border-amber-200">
            <ClickableImage
              src="/imgs/spec/bio-pe-kraft-duplex-low.webp"
        ...
        <div className="space-y-4 text-neutral-700">
          <div className="bg-green-50 p-4 rounded-lg">
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-start gap-2">
                <CheckCircle className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" />
                <span><strong>{t(`${p}.sections.sustainability.item5Name`)}</strong> {t(`${p}.sections.sustainability.item5Desc`)}</span>
              </li>
            </ul>
          </div>
        </div>
  ...
  const relatedLinks = [
    ...
    { title: t(`${p}.relatedLinks.link2.title`), url: "/spec/biope-kraft-vmpet", description: t(`${p}.relatedLinks.link2.description`) },
    { title: t(`${p}.relatedLinks.link3.title`), url: "/spec/biope-pet-kraft-triplex-clear", description: t(`${p}.relatedLinks.link3.description`) },
