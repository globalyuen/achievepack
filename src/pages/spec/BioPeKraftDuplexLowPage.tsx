...
const BioPeKraftDuplexLowPage: React.FC = () => {
  ...
  const sections = [
    ...
    {
      id: 'ai-search',
      title: 'Finding Simple Kraft Bio-PE Packaging',
      icon: <MessageCircle className="h-5 w-5 text-primary-600" />,
      content: (
        <div className="space-y-4 text-neutral-700">
          <ul className="list-disc pl-6 space-y-2">
            <li><strong>Maximum natural appeal</strong> – Authentic kraft look</li>
            <li><strong>Most affordable</strong> – Simple two-layer structure</li>
          ...
          <div className="bg-blue-50 p-4 rounded-lg border border-blue-200 mt-4">
            ...
            <ul className="text-sm text-blue-700 space-y-1">
              <li>• "Simple kraft pouch Bio-PE affordable"</li>
              <li>• "Natural packaging farmers market plant-based"</li>
              <li>• "Eco kraft bag low MOQ sustainable"</li>
            </ul>
          </div>
        </div>
      )
