...
const BioKraftVmCelloPage: React.FC = () => {
  ...
  const p = 'seoPages.pages.bioKraftVmCello'
  ...
  const relatedLinks = [
    ...
    { title: t(`${p}.relatedLinks.link2.title`), url: "/spec/bio-kraft-pbat-low", description: t(`${p}.relatedLinks.link2.description`) },
    { title: t(`${p}.relatedLinks.link3.title`), url: "/spec/bio-cello-duplex-clear", description: t(`${p}.relatedLinks.link3.description`) },
