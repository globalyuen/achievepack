...
const BioPePetDuplexClearPage: React.FC = () => {
  ...
  const p = 'seoPages.pages.bioPePetDuplexClear'
      ...
      content: (
        <div className="space-y-4 text-neutral-700">
          <div className="bg-green-50 p-6 rounded-lg border border-green-200">
            <ClickableImage
              src="/imgs/spec/bio-pe-pet-duplex-clear.webp"
  ...
  const relatedLinks = [
    ...
    { title: t(`${p}.relatedLinks.link3.title`), url: "/spec/biope-pp-duplex-clear", description: t(`${p}.relatedLinks.link3.description`) },
