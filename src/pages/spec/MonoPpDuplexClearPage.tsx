...
const MonoPpDuplexClearPage: React.FC = () => {
  ...
  const p = 'seoPages.pages.monoPpDuplexClear'
      ...
      content: (
        <div className="space-y-4 text-neutral-700">
          ...
          <div className="bg-purple-50 p-4 rounded-lg mt-4 flex items-start gap-3">
            ...
            <div>
              <h4 className="font-semibold text-purple-800 mb-1">{t(`${p}.sections.barrierProperties.premiumShelf`)}</h4>
  ...
  const relatedLinks = [
    ...
    { title: t(`${p}.relatedLinks.link2.title`), url: "/spec/mono-pe-duplex-clear", description: t(`${p}.relatedLinks.link2.description`) },
    { title: t(`${p}.relatedLinks.link3.title`), url: "/spec/mono-pp-duplex-nowindow", description: t(`${p}.relatedLinks.link3.description`) },
