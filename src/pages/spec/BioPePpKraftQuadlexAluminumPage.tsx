...
const BioPePpKraftQuadlexAluminumPage: React.FC = () => {
  ...
  const p = 'seoPages.pages.bioPePpKraftQuadlexAluminum'
      ...
      content: (
        <div className="space-y-4 text-neutral-700">
          <div className="bg-amber-50 p-6 rounded-lg border border-amber-200">
            <ClickableImage
              src="/imgs/spec/bio-pe-pp-kraft-quadlex-aluminum.webp"
  ...
  const relatedLinks = [
    ...
    { title: t(`${p}.relatedLinks.link2.title`), url: "/spec/biope-pet-kraft-quadlex-aluminum", description: t(`${p}.relatedLinks.link2.description`) },
