      ...
      content: (
        <div className="space-y-4 text-neutral-700">
          <ul className="list-disc pl-6 space-y-2">
            <li><strong>Full branding coverage</strong> – 100% printable surface</li>
            <li><strong>Light protection</strong> – Opaque barrier for sensitive products</li>
          ...
          <div className="bg-blue-50 p-4 rounded-lg border border-blue-200 mt-4">
            ...
            <ul className="text-sm text-blue-700 space-y-1">
              <li>• "Opaque stand-up pouch Bio-PE"</li>
              <li>• "Plant-based packaging with light barrier"</li>
              <li>• "Full print coverage eco-friendly pouch"</li>
            </ul>
          </div>
        </div>
      )
