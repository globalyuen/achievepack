...
const localTranslations = {
  "en": {
    "title": "Premium Custom Shape Pouches Digital Printing Infographic 6 Solutions",
    "description": "High quality sustainable packaging for Custom Shape Pouches Digital Printing Infographic 6.",
...
export default function CustomShapePouchesDigitalPrintingInfographic681411() {
  const lang = 'en';
  ...
  return (
    <SEOPageLayout title={t.title} description={t.description}>
      ...
      <div className="max-w-4xl mx-auto py-12 px-4">
        ...
        <img src="/imgs/infographics/custom-shape-pouches-digital-printing-infographic-6.png" alt={t.title} className="w-full max-w-lg mx-auto mb-8 rounded-xl shadow-lg" />
