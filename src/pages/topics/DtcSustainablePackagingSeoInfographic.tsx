...
const localTranslations = {
  "en": {
    "title": "Dtc Sustainable Packaging Seo Infographic",
  ...
  "es": {
    "title": "Dtc Sustainable Packaging Seo Infographic (ES)",
    "description": "Premium sustainable packaging solution.",
    "hook": "Sabemos...",
    "pain_points": [],
  ...
  "fr": {
    "title": "Dtc Sustainable Packaging Seo Infographic (FR)",
    "description": "Premium sustainable packaging solution.",
    "hook": "Nous savons...",
    "pain_points": [],
    "engineering_notebook": "...",
  ...
  "zh-tw": {
    "title": "Dtc Sustainable Packaging Seo Infographic (TW)",
    "description": "Premium sustainable packaging solution.",
    "hook": "我們知道...",
    "pain_points": [],
    "engineering_notebook": "...",
...
export default function DtcSustainablePackagingSeoInfographic() {
  ...
  return (
    <SEOPageLayout title={t.title} description={t.description}>
      ...
      <div className="max-w-4xl mx-auto py-12 px-4">
        ...
        <img src="/imgs/seo-pages/dtc-sustainable-packaging-seo-infographic.png" alt={t.title} className="w-full max-w-lg mx-auto mb-8 rounded-xl shadow-lg" />
