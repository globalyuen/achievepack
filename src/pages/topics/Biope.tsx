...
const localTranslations = {
  en: {
    title: "Biope | Advanced Packaging Solutions",
    description: "Discover the engineering behind our premium Biope. Learn how we solve common packaging challenges with cutting-edge materials and designs.",
    heroTitle: "Engineered Biope",
    heroSubtitle: "Solving Your Top 5 Packaging Pain Points",
    hook: "We know the sinking feeling of opening a shipping box only to find your premium product crushed because the seal failed. You didn't spend months perfecting your recipe just to lose customers over cheap, unreliable packaging. Our Biope is designed to prevent these exact disasters.",
  ...
  es: {
    title: "Biope | Soluciones Avanzadas",
    description: "Descubra la ingeniería detrás de nuestro Biope premium.",
    heroTitle: "Biope Diseñado",
    heroSubtitle: "Resolviendo Sus 5 Principales Puntos Delor",
    hook: "Conocemos la sensación de frustración al encontrar su producto premium dañado. Nuestro Biope está diseñado para prevenir estos desastres exactos.",
  ...
  fr: {
    title: "Biope | Solutions d'Emballage Avancées",
    description: "Découvrez l'ingénierie derrière notre Biope premium.",
    heroTitle: "Biope Conçu",
  ...
  "zh-tw": {
    title: "Biope | 高級包裝解決方案",
    description: "探索我們高級 Biope 背後的工程技術。",
    heroTitle: "精心設計的 Biope",
...
export default function Biope() {
  ...
  const jsonLd = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "How does Biope improve my packaging?",
        "acceptedAnswer": {
          "@type": "Answer",
