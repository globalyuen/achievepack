...
const localTranslations = {
  "en": {
    "title": "Stand Up Pouch Dimensions Chart For Powders",
    "description": "Premium sustainable packaging solution for stand up pouch dimensions chart for powders.",
  ...
  "es": {
    "title": "Stand Up Pouch Dimensions Chart For Powders (ES)",
  ...
  "fr": {
    "title": "Stand Up Pouch Dimensions Chart For Powders (FR)",
  ...
  "zh-tw": {
    "title": "Stand Up Pouch Dimensions Chart For Powders (TW)",
...
export default function StandUpPouchDimensionsChartForPowdersPage() {
