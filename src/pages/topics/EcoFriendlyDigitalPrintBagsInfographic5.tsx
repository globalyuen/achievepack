...
const localTranslations = {
  "en": {
    "title": "Premium Eco Friendly Digital Print Bags Infographic 5 Solutions",
    "description": "High quality sustainable packaging for Eco Friendly Digital Print Bags Infographic 5.",
