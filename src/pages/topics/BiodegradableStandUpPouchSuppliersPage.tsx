...
const localTranslations = {
  "en": {
    "title": "Biodegradable Stand Up Pouch Suppliers",
    "description": "Premium sustainable packaging solution for biodegradable stand up pouch suppliers.",
  ...
  "es": {
    "title": "Biodegradable Stand Up Pouch Suppliers (ES)",
  ...
  "fr": {
    "title": "Biodegradable Stand Up Pouch Suppliers (FR)",
  ...
  "zh-tw": {
    "title": "Biodegradable Stand Up Pouch Suppliers (TW)",
...
export default function BiodegradableStandUpPouchSuppliersPage() {
