    ...
    <div className="topic-container bg-white text-gray-900 font-sans">
      <header className="hero-section relative bg-gray-900 py-24 px-8 text-center text-white">
        ...
        <div className="bg-slate-900 text-white p-8 rounded-xl shadow-lg mb-12 border border-slate-700">
            <h1 className="text-3xl font-bold mb-4">Cacaostandup – Enterprise-Grade Flexible Packaging Engineering</h1>
        ...
        <div className="mb-12 bg-white border-l-4 border-blue-600 p-6 shadow-sm">
            ...
            <p className="text-neutral-700 italic">
                "When addressing the enterprise scale requirements for Cacaostandup, I observed that standard material laminations were failing under high-speed automated filling lines. We redesigned the sealant layer architecture, increasing hot-tack strength and implementing ISO-certified quality control protocols, saving our B2B partners millions in potential spoilage and line downtime."
            </p>
        </div>


        <h2 className="text-4xl md:text-5xl font-bold mb-4 text-amber-500">Premium Stand-Up Pouches for Cacao & Cocoa Products</h2>
        <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto mb-8">
          Engineered for ultimate barrier protection, preserving the complex volatile compounds of premium cacao.
        </p>
        <img 
          src="/imgs/solutions/solution_cacao_stand_up.jpg" 
