...
const localTranslations = {
  "en": {
    "title": "Premium Recyclable Stand Up Pouch Dimensions Chart Hero Solutions",
    "description": "High quality sustainable packaging for Recyclable Stand Up Pouch Dimensions Chart Hero.",
...
export default function RecyclableStandUpPouchDimensionsChartHero99023() {
  const lang = 'en';
  ...
  return (
    <SEOPageLayout title={t.title} description={t.description}>
      ...
      <div className="max-w-4xl mx-auto py-12 px-4">
        ...
        <img src="/imgs/blog/heros/recyclable-stand-up-pouch-dimensions-chart-hero.png" alt={t.title} className="w-full max-w-lg mx-auto mb-8 rounded-xl shadow-lg" />
