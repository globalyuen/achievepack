...
const localTranslations = {
  "en": {
    "title": "Eco Audit",
    "description": "Explore our premium, sustainable Eco Audit solutions designed for modern flexible packaging lines and high barrier requirements.",
    "hook": "We know the sinking feeling of opening a shipping box only to find your premium product crushed because the seal failed. When using standard Eco Audit, you didn't spend months perfecting your recipe just to lose customers over cheap, unreliable packaging.",
    "pain_points": [
      {
        "num": "01",
    ...
    "engineering_notebook": "In my 14 years in packaging design, I've seen countless brands struggle with Eco Audit. By upgrading the lamination tension and employing a secondary curing phase, we've eliminated curling entirely. - Ryan Wong, Co-Founder",
    "schema_faq": [
      {
        "q": "Is this Eco Audit eco-friendly?",
  ...
  "es": {
    "title": "Eco Audit (ES)",
    "description": "Explore nuestras soluciones premium de Eco Audit.",
  ...
  "fr": {
    "title": "Eco Audit (FR)",
    "description": "Découvrez nos solutions premium de Eco Audit.",
    ...
    "schema_faq": [
      {
        "q": "Ce Eco Audit est-il écologique?",
  ...
  "zh-tw": {
    "title": "Eco Audit (TW)",
    "description": "探索我們為 Eco Audit 設計的高級解決方案。",
  ...
  return (
    <SEOPageLayout title={t.title} description={t.description}>
      ...
      <div className="max-w-4xl mx-auto py-12 px-4">
        ...
        <img src="/imgs/generated/eco_audit.png" alt={t.title} className="w-full max-w-lg mx-auto mb-8 rounded-xl shadow-lg" />
