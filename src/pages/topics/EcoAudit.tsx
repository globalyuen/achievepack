...
const localTranslations = {
  en: {
    title: "Eco Audit | Advanced Packaging Solutions",
    description: "Discover the engineering behind our premium Eco Audit. Learn how we solve common packaging challenges with cutting-edge materials and designs.",
    heroTitle: "Engineered Eco Audit",
    heroSubtitle: "Solving Your Top 5 Packaging Pain Points",
    hook: "We know the sinking feeling of opening a shipping box only to find your premium product crushed because the seal failed. You didn't spend months perfecting your recipe just to lose customers over cheap, unreliable packaging. Our Eco Audit is designed to prevent these exact disasters.",
  ...
  es: {
    title: "Eco Audit | Soluciones Avanzadas",
    description: "Descubra la ingeniería detrás de nuestro Eco Audit premium.",
    heroTitle: "Eco Audit Diseñado",
    heroSubtitle: "Resolviendo Sus 5 Principales Puntos Delor",
    hook: "Conocemos la sensación de frustración al encontrar su producto premium dañado. Nuestro Eco Audit está diseñado para prevenir estos desastres exactos.",
  ...
  fr: {
    title: "Eco Audit | Solutions d'Emballage Avancées",
    description: "Découvrez l'ingénierie derrière notre Eco Audit premium.",
    heroTitle: "Eco Audit Conçu",
  ...
  "zh-tw": {
    title: "Eco Audit | 高級包裝解決方案",
    description: "探索我們高級 Eco Audit 背後的工程技術。",
    heroTitle: "精心設計的 Eco Audit",
...
export default function EcoAudit() {
  ...
  const jsonLd = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "How does Eco Audit improve my packaging?",
        "acceptedAnswer": {
          "@type": "Answer",
