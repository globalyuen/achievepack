...
const localTranslations = {
  en: {
    title: "Brc Cert | Advanced Packaging Solutions",
    description: "Discover the engineering behind our premium Brc Cert. Learn how we solve common packaging challenges with cutting-edge materials and designs.",
    heroTitle: "Engineered Brc Cert",
    heroSubtitle: "Solving Your Top 5 Packaging Pain Points",
    hook: "We know the sinking feeling of opening a shipping box only to find your premium product crushed because the seal failed. You didn't spend months perfecting your recipe just to lose customers over cheap, unreliable packaging. Our Brc Cert is designed to prevent these exact disasters.",
  ...
  es: {
    title: "Brc Cert | Soluciones Avanzadas",
    description: "Descubra la ingeniería detrás de nuestro Brc Cert premium.",
    heroTitle: "Brc Cert Diseñado",
    heroSubtitle: "Resolviendo Sus 5 Principales Puntos Delor",
    hook: "Conocemos la sensación de frustración al encontrar su producto premium dañado. Nuestro Brc Cert está diseñado para prevenir estos desastres exactos.",
  ...
  fr: {
    title: "Brc Cert | Solutions d'Emballage Avancées",
    description: "Découvrez l'ingénierie derrière notre Brc Cert premium.",
    heroTitle: "Brc Cert Conçu",
  ...
  "zh-tw": {
    title: "Brc Cert | 高級包裝解決方案",
    description: "探索我們高級 Brc Cert 背後的工程技術。",
    heroTitle: "精心設計的 Brc Cert",
...
export default function BrcCert() {
  ...
  const jsonLd = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "How does Brc Cert improve my packaging?",
        "acceptedAnswer": {
          "@type": "Answer",
