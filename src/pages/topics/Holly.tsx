...
const localTranslations = {
  en: {
    title: "Holly | Advanced Packaging Solutions",
    description: "Discover the engineering behind our premium Holly. Learn how we solve common packaging challenges with cutting-edge materials and designs.",
    heroTitle: "Engineered Holly",
    heroSubtitle: "Solving Your Top 5 Packaging Pain Points",
    hook: "We know the sinking feeling of opening a shipping box only to find your premium product crushed because the seal failed. You didn't spend months perfecting your recipe just to lose customers over cheap, unreliable packaging. Our Holly is designed to prevent these exact disasters.",
  ...
  es: {
    title: "Holly | Soluciones Avanzadas",
    description: "Descubra la ingeniería detrás de nuestro Holly premium.",
    heroTitle: "Holly Diseñado",
    heroSubtitle: "Resolviendo Sus 5 Principales Puntos Delor",
    hook: "Conocemos la sensación de frustración al encontrar su producto premium dañado. Nuestro Holly está diseñado para prevenir estos desastres exactos.",
  ...
  fr: {
    title: "Holly | Solutions d'Emballage Avancées",
    description: "Découvrez l'ingénierie derrière notre Holly premium.",
    heroTitle: "Holly Conçu",
    heroSubtitle: "Résolution de vos 5 principaux problèmes d'emballage",
    hook: "Nous connaissons le sentiment de frustration lorsque vous trouvez votre produit premium endommagé. Notre Holly est conçu pour prévenir ces désastres.",
  ...
  zh: {
    title: "Holly | 高級包裝解決方案",
    description: "探索我們高級 Holly 背後的工程技術。",
    heroTitle: "精心設計的 Holly",
    heroSubtitle: "解決您的前5大包裝痛點",
    hook: "我們知道打開運輸箱卻發現優質產品因密封失敗而破損的沮喪感。我們的 Holly 旨在防止這些災難。",
...
export default function Holly() {
  ...
  const jsonLd = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "How does Holly improve my packaging?",
        "acceptedAnswer": {
          "@type": "Answer",
  ...
  return (
    <SEOPageLayout
      ...
      heroImage="/imgs/testimonials/owner/holly.webp"
    >
