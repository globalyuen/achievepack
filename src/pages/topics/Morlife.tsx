...
const localTranslations = {
  "en": {
    "title": "Morlife",
    "description": "Premium flexible packaging engineering and solutions for Morlife.",
    "heroTitle": "Morlife",
    "heroSubtitle": "Advanced Packaging Solutions",
    "introSummary": "Discover the engineering behind Morlife.",
    "aeoSummary": "Learn more about optimal packaging methodologies for Morlife.",
    "eeatDetails": "Engineered by Achieve Pack.",
    "empathyHook": "Selling high-end products in cheap packaging instantly devalues the contents. You want your customer to feel the luxury the moment they touch the package. Upgrading to premium Morlife packaging can revolutionize customer retention. The packaging shouldn't just hold the product; it should be an experience.",
    ...
    "section2Log": "Optimized Morlife for maximum efficiency and brand impact. Film thickness: 120 microns. Barrier OTR less than 0.05 cc/m2/24hr.",
    ...
    "compTitle": "Standard Mailers vs. Premium Morlife",
    "compDesc": "Compare tactile feel, durability, and customer retention metrics:",
    "faq1Q": "What makes Morlife different?",
    "faq1A": "Our Morlife uses advanced multi-layer films for superior barrier protection and a premium feel.",
...
const Morlife: React.FC = () => {
  ...
  const IMAGES = {
    hero: '/imgs/testimonials/pouch-hover/morlife.webp',
    process: '/imgs/testimonials/pouch-hover/morlife.webp',
    comparison: '/imgs/testimonials/pouch-hover/morlife.webp'
  }
