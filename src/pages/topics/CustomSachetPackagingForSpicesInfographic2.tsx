...
const localTranslations = {
  "en": {
    "title": "Premium Custom Sachet Packaging For Spices Infographic 2 Solutions",
    "description": "High quality sustainable packaging for Custom Sachet Packaging For Spices Infographic 2.",
