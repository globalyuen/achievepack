...
const SurfaceFinishCloseDetail = () => {
  const { t } = useTranslation();
  const p = 'seoPages.pages.surface-finish-close-detail';
  ...
  return (
    <>
      <Helmet>
        <title>{t(`${p}.seo.title`, 'Surface Finish Close Detail | Achieve Pack')}</title>
      </Helmet>
      <SEOPageLayout 
        heroBgColor="#064e3b"
        title="Surface Finish Close Detail"
        description="Comprehensive guide and technical details."
        keywords={['packaging', 'Surface Finish Close Detail']}
        heroTitle="Surface Finish Close Detail"
...
export default SurfaceFinishCloseDetail;
