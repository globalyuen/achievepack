...
const localTranslations = {
  "en": {
    "title": "Premium A Detail Edge Finish 8463428 Solutions",
    "description": "High quality sustainable packaging for A Detail Edge Finish 8463428.",
...
export default function ADetailEdgeFinish846342895367() {
  const lang = 'en';
  ...
  return (
    <SEOPageLayout title={t.title} description={t.description}>
      ...
      <div className="max-w-4xl mx-auto py-12 px-4">
        ...
        <img src="/imgs/store/box/tuck-box/ads/a_detail_edge_finish_8463428.webp" alt={t.title} className="w-full max-w-lg mx-auto mb-8 rounded-xl shadow-lg" />
