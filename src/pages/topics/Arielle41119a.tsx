...
const Arielle41119a: React.FC = () => {
  ...
  const IMAGES = {
    hero: '/imgs/testimonials/owner/arielle.png',
    process: '/imgs/testimonials/owner/arielle.png',
    comparison: '/imgs/testimonials/owner/arielle.png'
  }
