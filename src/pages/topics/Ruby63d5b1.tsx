...
const Ruby63d5b1: React.FC = () => {
  ...
  const IMAGES = {
    hero: '/imgs/testimonials/owner/ruby.png',
    process: '/imgs/testimonials/owner/ruby.png',
    comparison: '/imgs/testimonials/owner/ruby.png'
  }
