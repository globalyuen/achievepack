...
const localTranslations = {
  en: {
    title: "Recyclable Guide | Advanced Packaging Solutions",
    description: "Discover the engineering behind our premium Recyclable Guide. Learn how we solve common packaging challenges with cutting-edge materials and designs.",
    heroTitle: "Engineered Recyclable Guide",
    heroSubtitle: "Solving Your Top 5 Packaging Pain Points",
    hook: "We know the sinking feeling of opening a shipping box only to find your premium product crushed because the seal failed. You didn't spend months perfecting your recipe just to lose customers over cheap, unreliable packaging. Our Recyclable Guide is designed to prevent these exact disasters.",
  ...
  es: {
    title: "Recyclable Guide | Soluciones Avanzadas",
    description: "Descubra la ingeniería detrás de nuestro Recyclable Guide premium.",
    heroTitle: "Recyclable Guide Diseñado",
    heroSubtitle: "Resolviendo Sus 5 Principales Puntos Delor",
    hook: "Conocemos la sensación de frustración al encontrar su producto premium dañado. Nuestro Recyclable Guide está diseñado para prevenir estos desastres exactos.",
  ...
  fr: {
    title: "Recyclable Guide | Solutions d'Emballage Avancées",
    description: "Découvrez l'ingénierie derrière notre Recyclable Guide premium.",
    heroTitle: "Recyclable Guide Conçu",
  ...
  "zh-tw": {
    title: "Recyclable Guide | 高級包裝解決方案",
    description: "探索我們高級 Recyclable Guide 背後的工程技術。",
    heroTitle: "精心設計的 Recyclable Guide",
...
export default function RecyclableGuide() {
  ...
  const jsonLd = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "How does Recyclable Guide improve my packaging?",
        "acceptedAnswer": {
          "@type": "Answer",
