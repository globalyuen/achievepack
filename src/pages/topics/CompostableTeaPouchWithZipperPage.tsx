...
const localTranslations = {
  "en": {
    "title": "Compostable Tea Pouch With Zipper",
    "description": "Premium sustainable packaging solution for compostable tea pouch with zipper.",
  ...
  "es": {
    "title": "Compostable Tea Pouch With Zipper (ES)",
  ...
  "fr": {
    "title": "Compostable Tea Pouch With Zipper (FR)",
  ...
  "zh-tw": {
    "title": "Compostable Tea Pouch With Zipper (TW)",
...
export default function CompostableTeaPouchWithZipperPage() {
