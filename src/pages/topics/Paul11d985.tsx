...
const localTranslations = {
  "en": {
    "title": "Paul",
    "description": "Premium flexible packaging engineering and solutions for Paul.",
    "heroTitle": "Paul",
    "heroSubtitle": "Advanced Packaging Solutions",
    "introSummary": "Discover the engineering behind Paul.",
    "aeoSummary": "Learn more about optimal packaging methodologies for Paul.",
    "eeatDetails": "Engineered by Achieve Pack.",
    "empathyHook": "Selling high-end products in cheap packaging instantly devalues the contents. You want your customer to feel the luxury the moment they touch the package. Upgrading to premium Paul packaging can revolutionize customer retention. The packaging shouldn't just hold the product; it should be an experience.",
    ...
    "section2Log": "Optimized Paul for maximum efficiency and brand impact. Film thickness: 120 microns. Barrier OTR less than 0.05 cc/m2/24hr.",
    ...
    "compTitle": "Standard Mailers vs. Premium Paul",
    "compDesc": "Compare tactile feel, durability, and customer retention metrics:",
    "faq1Q": "What makes Paul different?",
    "faq1A": "Our Paul uses advanced multi-layer films for superior barrier protection and a premium feel.",
...
const Paul11d985: React.FC = () => {
  ...
  const IMAGES = {
    hero: '/imgs/testimonials/owner/Paul.webp',
    process: '/imgs/testimonials/owner/Paul.webp',
    comparison: '/imgs/testimonials/owner/Paul.webp'
  }
