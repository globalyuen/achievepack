...
const CompostablePackagingInsights = () => {
  const { t } = useTranslation();
  const p = 'seoPages.pages.compostable-packaging-insights';
  ...
  return (
    <>
      <Helmet>
        <title>{t(`${p}.seo.title`, 'Compostable Packaging Insights | Achieve Pack')}</title>
      </Helmet>
      <SEOPageLayout 
        heroBgColor="#064e3b"
        title="Compostable Packaging Insights"
        description="Comprehensive guide and technical details."
        keywords={['packaging', 'Compostable Packaging Insights']}
        heroTitle="Compostable Packaging Insights"
...
export default CompostablePackagingInsights;
