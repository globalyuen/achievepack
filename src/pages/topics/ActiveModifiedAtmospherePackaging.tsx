...
const localTranslations = {
  ...
  "empathyHook": "Imagine opening a premium bag of roasted nuts or specialty coffee, only to find it tastes completely stale. It's a brand-killer. We understand the constant anxiety of hoping your product survives its shelf life. You flush the bags with nitrogen, but if the film lets oxygen seep back in, all that effort is wasted. I've engineered packaging for brands who were ready to give up on national distribution because their spoilage rates were too high. Using the right high-barrier Modified Atmosphere Packaging (MAP) film changes everything.",
