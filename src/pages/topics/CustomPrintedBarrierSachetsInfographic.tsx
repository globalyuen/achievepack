...
const localTranslations = {
  "en": {
    "title": "Premium Custom Printed Barrier Sachets Infographic Solutions",
    "description": "High quality sustainable packaging for Custom Printed Barrier Sachets Infographic.",
