...
const localTranslations = {
  ...
  "empathyHook": "We know the panic of finding out a whole pallet of your product has leaked because the bag seams split open. Whether it's coffee oils or fine protein powders getting caught in the seal, watching your hard work end up wasted on a warehouse floor is heartbreaking. Heat sealing can be so inconsistent—one bag is burnt, the next isn't sealed at all. I've worked with production teams who were losing sleep over leak rates. Ultrasonic sealing cuts through that dust and gives you the peace of mind that every single pouch is locked tight.",
