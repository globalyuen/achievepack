...
const localTranslations = {
  en: {
    title: "Climate | Advanced Packaging Solutions",
    description: "Discover the engineering behind our premium Climate. Learn how we solve common packaging challenges with cutting-edge materials and designs.",
    heroTitle: "Engineered Climate",
    heroSubtitle: "Solving Your Top 5 Packaging Pain Points",
    hook: "We know the sinking feeling of opening a shipping box only to find your premium product crushed because the seal failed. You didn't spend months perfecting your recipe just to lose customers over cheap, unreliable packaging. Our Climate is designed to prevent these exact disasters.",
  ...
  es: {
    title: "Climate | Soluciones Avanzadas",
    description: "Descubra la ingeniería detrás de nuestro Climate premium.",
    heroTitle: "Climate Diseñado",
    heroSubtitle: "Resolviendo Sus 5 Principales Puntos Delor",
    hook: "Conocemos la sensación de frustración al encontrar su producto premium dañado. Nuestro Climate está diseñado para prevenir estos desastres exactos.",
  ...
  fr: {
    title: "Climate | Solutions d'Emballage Avancées",
    description: "Découvrez l'ingénierie derrière notre Climate premium.",
    heroTitle: "Climate Conçu",
  ...
  "zh-tw": {
    title: "Climate | 高級包裝解決方案",
    description: "探索我們高級 Climate 背後的工程技術。",
    heroTitle: "精心設計的 Climate",
...
export default function Climate() {
  ...
  const jsonLd = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "How does Climate improve my packaging?",
        "acceptedAnswer": {
          "@type": "Answer",
