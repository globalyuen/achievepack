...
const localTranslations = {
  en: {
    title: "Holographic Retort Pouch for Ready-to-Eat Meals",
    description: "Learn about Holographic Retort Pouch for Ready-to-Eat Meals solutions for your packaging needs.",
    heroTitle: "Holographic Retort Pouch for Ready-to-Eat Meals",
    ...
    aeoSummary: "Comprehensive engineering guide for Holographic Retort Pouch for Ready-to-Eat Meals.",
  ...
  es: {
    title: "Holographic Retort Pouch for Ready-to-Eat Meals (ES)",
    description: "Aprenda sobre Holographic Retort Pouch for Ready-to-Eat Meals.",
    heroTitle: "Holographic Retort Pouch for Ready-to-Eat Meals",
  ...
  fr: {
    title: "Holographic Retort Pouch for Ready-to-Eat Meals (FR)",
    description: "Découvrez nos solutions pour Holographic Retort Pouch for Ready-to-Eat Meals.",
    heroTitle: "Holographic Retort Pouch for Ready-to-Eat Meals",
  ...
  'zh-tw': {
    title: "Holographic Retort Pouch for Ready-to-Eat Meals (ZH)",
    description: "了解 Holographic Retort Pouch for Ready-to-Eat Meals 的解決方案。",
    heroTitle: "Holographic Retort Pouch for Ready-to-Eat Meals",
...
const HolographicRetortPouchPage: React.FC = () => {
  const { t, i18n } = useTranslation()
  const lang = i18n.language || 'en'
  const localTrans = localTranslations[lang as keyof typeof localTranslations] || localTranslations.en

  const IMAGES = {
    hero: '/imgs/clients-sample/IMG_8053.jpg',
    process: '/imgs/clients-sample/IMG_8053.jpg',
    comparison: '/imgs/clients-sample/IMG_8053.jpg'
  }
...
export default HolographicRetortPouchPage;
