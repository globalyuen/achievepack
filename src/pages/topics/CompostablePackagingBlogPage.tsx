...
const localTranslations = {
  en: {
    ...
    heroTag: "Technical Engineering Guide",
    ...
    painPointsHeading: "5 Manufacturing Pain Points & Engineering Solutions",
    ...
    colStandard: "Standard Approach",
    colAchievePack: "Achieve Pack Engineered",
    row1Param: "Material Integrity",
    row1Standard: "High failure rate under stress",
    row1Achieve: "Zero-failure structural mapping",
    row2Param: "Compliance",
    row2Standard: "Often misses localized FDA/EU requirements",
    row2Achieve: "100% Guaranteed Certification",
    row3Param: "Unit Cost Impact",
    row3Standard: "High waste yields expensive per-unit cost",
    row3Achieve: "Optimized layout reduces material waste by 14%",
    faqHeading: "Technical FAQ",
    ...
    profileName: "Ryan Wong",
    profileRole: "Co-Founder & Chief Packaging Engineer",
    profileBadge: "14+ Years Experience | GRS & FSC Auditing Expert",
    profileBio: "Specializing in polymer structures, sustainable material transitions, and high-speed VFFS line optimizations. Helping 500+ global brands scale from prototype to industrial production with zero defect tolerances.",
    ctaButton: "Schedule a Packaging Audit"
  },
  es: {
    ...
    heroTag: "Guía de Ingeniería Técnica",
    ...
    painPointsHeading: "5 Problemas de Fabricación y Soluciones de Ingeniería",
    ...
    colStandard: "Enfoque Estándar",
    colAchievePack: "Ingeniería Achieve Pack",
    row1Param: "Integridad del Material",
    row1Standard: "Alta tasa de fallas bajo estrés",
    row1Achieve: "Mapeo estructural sin fallas",
    row2Param: "Cumplimiento Normativo",
    row2Standard: "A menudo ignora requisitos locales de la FDA/UE",
    row2Achieve: "Certificación 100% Garantizada",
    row3Param: "Impacto en Costo Unitario",
    row3Standard: "Alto desperdicio resulta en costo unitario elevado",
    row3Achieve: "Diseño optimizado reduce el desperdicio en un 14%",
    faqHeading: "Preguntas Frecuentes Técnicas",
    ...
    profileName: "Ryan Wong",
    profileRole: "Cofundador e Ingeniero Jefe de Empaques",
    profileBadge: "14+ Años de Experiencia | Experto en Auditoría GRS y FSC",
    profileBio: "Especializado en estructuras de polímeros, transición a materiales sostenibles y optimización de líneas VFFS de alta velocidad. Ayudando a más de 500 marcas globales a escalar del prototipo a la producción industrial con cero defectos.",
    ctaButton: "Programar Auditoría de Empaque"
  },
  fr: {
    ...
    heroTag: "Guide d'Ingénierie Technique",
    ...
    painPointsHeading: "5 Problèmes de Fabrication & Solutions d'Ingénierie",
    solutionLabel: "Solution",
    ...
    colStandard: "Approche Standard",
    colAchievePack: "Conception Achieve Pack",
    row1Param: "Intégrité du Matériau",
    row1Standard: "Taux de défaillance élevé sous contrainte",
    row1Achieve: "Cartographie structurelle zéro défaut",
    row2Param: "Conformité",
    row2Standard: "Manque souvent les exigences FDA/UE locales",
    row2Achieve: "Certification Garantie à 100%",
    row3Param: "Impact sur le Coût Unitaire",
    row3Standard: "Gaspillage élevé entraînant un coût unitaire cher",
    row3Achieve: "Agencement optimisé réduisant les pertes de 14%",
    faqHeading: "FAQ Technique",
    ...
    profileName: "Ryan Wong",
    profileRole: "Cofondateur & Ingénieur en Chef de l'Emballage",
    profileBadge: "14+ Ans d'Expérience | Expert Audit GRS & FSC",
    profileBio: "Spécialisé dans les structures polymères, les transitions écologiques et l'optimisation des lignes VFFS à haute vitesse. Accompagnement de plus de 500 marques mondiales du prototype à la production industrielle.",
    ctaButton: "Planifier un Audit d'Emballage"
  },
  "zh-tw": {
    ...
    painPointsHeading: "5 大製造痛點與工程解決方案",
    solutionLabel: "解決方案",
    point1Title: "阻隔完整性失效",
    ...
    colParameter: "評估參數",
    colStandard: "傳統標準做法",
    colAchievePack: "Achieve Pack 工程級做法",
    row1Param: "材料結構完整性",
    row1Standard: "高應力下撕裂與脫層率高",
    row1Achieve: "零失效結構對應與映射",
    row2Param: "法規與認證合規",
    row2Standard: "常忽略區域性 FDA / EU 食品級規範",
    row2Achieve: "100% 確保通過權威認證",
    row3Param: "單件生產成本影響",
    row3Standard: "廢品率高導致單個包裝成本高昂",
    row3Achieve: "優化排版與邊角排料降低 14% 材料損耗",
    faqHeading: "技術常見問題 (FAQ)",
    ...
    profileName: "黃立賢 (Ryan Wong)",
    profileRole: "聯合創辦人兼首席包裝工程師",
    profileBadge: "14 年以上行業經驗 | GRS 與 FSC 稽核專家",
    profileBio: "專精於高分子聚合物結構、永續材料轉型及高速 VFFS 自動化包裝線優化。已協助 500+ 全球品牌實現從樣品研發到工業化量產的零缺陷轉型。",
    ctaButton: "預約專業包裝稽核諮詢"
  }
};
  ...
  return (
    <SEOPageLayout title={tLocal.title} description={tLocal.description}>
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        ...
        {/* Pain Points Section */}
        <div className="mb-20">
          <h2 className="text-3xl font-bold text-neutral-900 mb-8">{tLocal.painPointsHeading}</h2>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-neutral-900 text-white">
                  <th className="p-4 rounded-tl-lg font-semibold">{tLocal.colParameter}</th>
                  <th className="p-4 font-semibold border-l border-neutral-700">{tLocal.colStandard}</th>
                  <th className="p-4 rounded-tr-lg font-semibold border-l border-neutral-700">{tLocal.colAchievePack}</th>
                </tr>
              </thead>
              <tbody className="bg-white">
                <tr className="border-b border-neutral-200">
                  <td className="p-4 font-medium text-neutral-900">{tLocal.row1Param}</td>
                  <td className="p-4 text-neutral-600 border-l border-neutral-200">{tLocal.row1Standard}</td>
                ...
                <tr className="border-b border-neutral-200">
                  ...
                  <td className="p-4 text-neutral-600 border-l border-neutral-200">{tLocal.row2Standard}</td>
                ...
                <tr>
                  ...
                  <td className="p-4 text-neutral-600 border-l border-neutral-200">{tLocal.row3Standard}</td>
        ...
        <div className="max-w-3xl mb-20">
          <h2 className="text-3xl font-bold text-neutral-900 mb-8">{tLocal.faqHeading}</h2>
        ...
        <div className="bg-neutral-900 rounded-2xl p-8 md:p-10 text-white max-w-4xl">
          <div className="flex flex-col md:flex-row gap-8 items-center">
            <div className="w-32 h-32 rounded-full bg-neutral-800 border-4 border-primary-500/30 overflow-hidden shrink-0">
              <img src="/imgs/about/ryan-wong.webp" alt={tLocal.profileName} className="w-full h-full object-cover" />
            </div>
            <div>
              <h3 className="text-2xl font-bold mb-2">{tLocal.profileName}</h3>
              <p className="text-primary-400 font-medium mb-4">{tLocal.profileRole}</p>
