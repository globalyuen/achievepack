...
const localTranslations = {
  en: {
    title: "Landing Hero | Advanced Packaging Solutions",
    description: "Discover the engineering behind our premium Landing Hero. Learn how we solve common packaging challenges with cutting-edge materials and designs.",
    heroTitle: "Engineered Landing Hero",
    heroSubtitle: "Solving Your Top 5 Packaging Pain Points",
    hook: "We know the sinking feeling of opening a shipping box only to find your premium product crushed because the seal failed. You didn't spend months perfecting your recipe just to lose customers over cheap, unreliable packaging. Our Landing Hero is designed to prevent these exact disasters.",
  ...
  es: {
    title: "Landing Hero | Soluciones Avanzadas",
    description: "Descubra la ingeniería detrás de nuestro Landing Hero premium.",
    heroTitle: "Landing Hero Diseñado",
    heroSubtitle: "Resolviendo Sus 5 Principales Puntos Delor",
    hook: "Conocemos la sensación de frustración al encontrar su producto premium dañado. Nuestro Landing Hero está diseñado para prevenir estos desastres exactos.",
  ...
  fr: {
    title: "Landing Hero | Solutions d'Emballage Avancées",
    description: "Découvrez l'ingénierie derrière notre Landing Hero premium.",
    heroTitle: "Landing Hero Conçu",
  ...
  "zh-tw": {
    title: "Landing Hero | 高級包裝解決方案",
    description: "探索我們高級 Landing Hero 背後的工程技術。",
    heroTitle: "精心設計的 Landing Hero",
...
export default function LandingHero() {
  ...
  const jsonLd = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "How does Landing Hero improve my packaging?",
        "acceptedAnswer": {
          "@type": "Answer",
  ...
  return (
    <SEOPageLayout
      ...
      heroImage="/imgs/landing-hero.webp"
    >
