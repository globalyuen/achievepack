...
const localTranslations = {
  en: {
    title: "Labeling Guide V2",
    desc: "Discover Labeling Guide V2 with premium eco-friendly materials and custom sizing.",
  ...
  es: {
    title: "Labeling Guide V2 (ES)",
    desc: "Descubra Labeling Guide V2 con materiales ecológicos premium.",
  ...
  fr: {
    title: "Labeling Guide V2 (FR)",
    desc: "Découvrez Labeling Guide V2 avec des matériaux écologiques premium.",
  ...
  'zh-tw': {
    title: "Labeling Guide V2 (ZH)",
    desc: "探索 Labeling Guide V2 結合優質環保材料與客製化尺寸。",
    hook: "我們知道當包裝失敗時的挫折感...",
...
export default function LabelingGuideV2() {
