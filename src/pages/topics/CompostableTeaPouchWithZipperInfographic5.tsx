...
const localTranslations = {
  "en": {
    "title": "Compostable Tea Pouch With Zipper Infographic 5",
    "description": "Explore our premium, sustainable Compostable Tea Pouch With Zipper Infographic 5 solutions designed for modern flexible packaging lines and high barrier requirements.",
    "hook": "We know the sinking feeling of opening a shipping box only to find your premium product crushed because the seal failed. When using standard Compostable Tea Pouch With Zipper Infographic 5, you didn't spend months perfecting your recipe just to lose customers over cheap, unreliable packaging.",
    "pain_points": [
      {
        "num": "01",
    ...
    "engineering_notebook": "In my 14 years in packaging design, I've seen countless brands struggle with Compostable Tea Pouch With Zipper Infographic 5. By upgrading the lamination tension and employing a secondary curing phase, we've eliminated curling entirely. - Ryan Wong, Co-Founder",
    "schema_faq": [
      {
        "q": "Is this Compostable Tea Pouch With Zipper Infographic 5 eco-friendly?",
  ...
  "es": {
    "title": "Compostable Tea Pouch With Zipper Infographic 5 (ES)",
    "description": "Explore nuestras soluciones premium de Compostable Tea Pouch With Zipper Infographic 5.",
    ...
    "schema_faq": [
      {
        "q": "¿Es este Compostable Tea Pouch With Zipper Infographic 5 ecológico?",
  ...
  "fr": {
    "title": "Compostable Tea Pouch With Zipper Infographic 5 (FR)",
    "description": "Découvrez nos solutions premium de Compostable Tea Pouch With Zipper Infographic 5.",
    ...
    "schema_faq": [
      {
        "q": "Ce Compostable Tea Pouch With Zipper Infographic 5 est-il écologique?",
  ...
  "zh-tw": {
    "title": "Compostable Tea Pouch With Zipper Infographic 5 (TW)",
    "description": "探索我們為 Compostable Tea Pouch With Zipper Infographic 5 設計的高級解決方案。",
    ...
    "schema_faq": [
      {
        "q": "這個 Compostable Tea Pouch With Zipper Infographic 5 環保嗎?",
        "a": "是的，我們提供可回收版本。"
      },
      {
        "q": "最低訂購量是多少?",
...
export default function CompostableTeaPouchWithZipperInfographic5() {
  ...
  return (
    <SEOPageLayout title={t.title} description={t.description}>
      ...
      <div className="max-w-4xl mx-auto py-12 px-4">
        ...
        <img src="/imgs/infographics/compostable-tea-pouch-with-zipper-infographic-5.png" alt={t.title} className="w-full max-w-lg mx-auto mb-8 rounded-xl shadow-lg" />
