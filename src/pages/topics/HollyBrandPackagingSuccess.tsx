...
const localTranslations = {
  en: {
    title: "Holly Brand Packaging Success",
    desc: "Comprehensive guide and case study on Holly Brand Packaging Success.",
    ...
    notebook: "In my 14 years in packaging design, I've seen countless brands fail because they underestimated the importance of proper barrier testing. When dealing with Holly Brand Packaging Success, always test the OTR in actual humidity conditions, not just dry lab states. — Ryan Wong, Co-Founder",
    faq1_q: "How does Holly Brand Packaging Success impact shelf life?",
    faq1_a: "By providing structural integrity and optimized barrier layers, Holly Brand Packaging Success extends shelf life up to 12-18 months.",
    faq2_q: "Is it compatible with automatic filling?",
    faq2_a: "Yes, it is designed for high-speed VFFS and rotary filling lines."
  },
  es: {
    title: "Holly Brand Packaging Success (ES)",
    desc: "Guía completa para Holly Brand Packaging Success en envases modernos.",
    ...
    faq1_q: "¿Cómo afecta Holly Brand Packaging Success a la vida útil?",
  ...
  fr: {
    title: "Holly Brand Packaging Success (FR)",
    desc: "Guide complet pour Holly Brand Packaging Success dans l'emballage moderne.",
    ...
    faq1_q: "Comment Holly Brand Packaging Success affecte-t-il la durée de conservation?",
  ...
  'zh-tw': {
    title: "Holly Brand Packaging Success (ZH)",
    desc: "現代包裝的Holly Brand Packaging Success綜合指南。",
    ...
    faq1_q: "Holly Brand Packaging Success如何影響保質期？",
...
export default function HollyBrandPackagingSuccess({ language = 'en' }: { language?: 'en' | 'es' | 'fr' | 'zh-tw' }) {
  ...
  return (
    <SEOPageLayout>
      ...
      <div className="max-w-4xl mx-auto py-12 px-4">
        ...
        <ClickableImage src="/imgs/testimonials/owner/holly.webp" alt={t.title} className="w-full rounded-xl mb-8" />
