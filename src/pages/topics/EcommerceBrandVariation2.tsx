...
const localTranslations = {
  en: {
    title: "E-Commerce Brand Variation 2",
    desc: "Discover E-Commerce Brand Variation 2 with premium eco-friendly materials and custom sizing.",
  ...
  es: {
    title: "E-Commerce Brand Variation 2 (ES)",
    desc: "Descubra E-Commerce Brand Variation 2 con materiales ecológicos premium.",
  ...
  fr: {
    title: "E-Commerce Brand Variation 2 (FR)",
    desc: "Découvrez E-Commerce Brand Variation 2 avec des matériaux écologiques premium.",
  ...
  'zh-tw': {
    title: "E-Commerce Brand Variation 2 (ZH)",
    desc: "探索 E-Commerce Brand Variation 2 結合優質環保材料與客製化尺寸。",
    hook: "我們知道當包裝失敗時的挫折感...",
...
export default function EcommerceBrandVariation2() {
