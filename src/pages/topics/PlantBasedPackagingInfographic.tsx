...
const localTranslations = {
  en: {
    title: "Plant Based Packaging Infographic | Advanced Packaging Solutions",
    description: "Discover the engineering behind Plant Based Packaging Infographic. Learn how we solve common packaging challenges.",
    heroTitle: "Plant Based Packaging Infographic",
    heroSubtitle: "Solving Your Top 5 Packaging Pain Points",
    hook: "We know the sinking feeling of opening a shipping box only to find your premium product crushed. Our Plant Based Packaging Infographic prevents these disasters.",
  ...
  es: {
    title: "Plant Based Packaging Infographic | Soluciones Avanzadas",
    description: "Descubra la ingeniería detrás de Plant Based Packaging Infographic.",
    heroTitle: "Plant Based Packaging Infographic",
  ...
  fr: {
    title: "Plant Based Packaging Infographic | Solutions d'Emballage",
    description: "Découvrez l'ingénierie derrière Plant Based Packaging Infographic.",
    heroTitle: "Plant Based Packaging Infographic",
  ...
  zh: {
    title: "Plant Based Packaging Infographic | 高級包裝解決方案",
    description: "探索 Plant Based Packaging Infographic 背後的工程技術。",
    heroTitle: "Plant Based Packaging Infographic",
...
export default function PlantBasedPackagingInfographic() {
  ...
  const jsonLd = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "How does Plant Based Packaging Infographic improve my packaging?",
        "acceptedAnswer": {
          "@type": "Answer",
