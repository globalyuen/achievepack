...
const localTranslations = {
  "en": {
    "title": "Premium  Benefits Grid Showing Solutions",
    "description": "High quality sustainable packaging for  Benefits Grid Showing.",
...
export default function BenefitsGridShowing() {
  const lang = 'en';
  ...
  return (
    <SEOPageLayout title={t.title} description={t.description}>
      ...
      <div className="max-w-4xl mx-auto py-12 px-4">
        ...
        <img src="/imgs/composting/benefits/ Benefits grid showing.webp" alt={t.title} className="w-full max-w-lg mx-auto mb-8 rounded-xl shadow-lg" />
