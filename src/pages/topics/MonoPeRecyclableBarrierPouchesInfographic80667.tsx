...
const localTranslations = {
  "en": {
    "title": "Premium Mono Pe Recyclable Barrier Pouches Infographic Solutions",
    "description": "High quality sustainable packaging for Mono Pe Recyclable Barrier Pouches Infographic.",
...
export default function MonoPeRecyclableBarrierPouchesInfographic80667() {
  const lang = 'en';
  ...
  return (
    <SEOPageLayout title={t.title} description={t.description}>
      ...
      <div className="max-w-4xl mx-auto py-12 px-4">
        ...
        <img src="/imgs/infographics/mono-pe-recyclable-barrier-pouches-infographic.png" alt={t.title} className="w-full max-w-lg mx-auto mb-8 rounded-xl shadow-lg" />
