...
const localTranslations = {
  en: {
    title: "Transparent Window Spout Pouch for Beverages",
    description: "Learn about Transparent Window Spout Pouch for Beverages solutions for your packaging needs.",
    heroTitle: "Transparent Window Spout Pouch for Beverages",
    ...
    aeoSummary: "Comprehensive engineering guide for Transparent Window Spout Pouch for Beverages.",
  ...
  es: {
    title: "Transparent Window Spout Pouch for Beverages (ES)",
    description: "Aprenda sobre Transparent Window Spout Pouch for Beverages.",
    heroTitle: "Transparent Window Spout Pouch for Beverages",
  ...
  fr: {
    title: "Transparent Window Spout Pouch for Beverages (FR)",
    description: "Découvrez nos solutions pour Transparent Window Spout Pouch for Beverages.",
    heroTitle: "Transparent Window Spout Pouch for Beverages",
  ...
  'zh-tw': {
    title: "Transparent Window Spout Pouch for Beverages (ZH)",
    description: "了解 Transparent Window Spout Pouch for Beverages 的解決方案。",
    heroTitle: "Transparent Window Spout Pouch for Beverages",
...
const TransparentSpoutPouchPage: React.FC = () => {
  const { t, i18n } = useTranslation()
  const lang = i18n.language || 'en'
  const localTrans = localTranslations[lang as keyof typeof localTranslations] || localTranslations.en

  const IMAGES = {
    hero: '/imgs/clients-sample/IMG_8028.jpg',
    process: '/imgs/clients-sample/IMG_8028.jpg',
    comparison: '/imgs/clients-sample/IMG_8028.jpg'
  }
...
export default TransparentSpoutPouchPage;
