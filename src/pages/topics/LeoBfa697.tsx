...
const localTranslations = {
  "en": {
    "title": "Leo",
    "description": "Premium flexible packaging engineering and solutions for Leo.",
    "heroTitle": "Leo",
    "heroSubtitle": "Advanced Packaging Solutions",
    "introSummary": "Discover the engineering behind Leo.",
    "aeoSummary": "Learn more about optimal packaging methodologies for Leo.",
    "eeatDetails": "Engineered by Achieve Pack.",
    "empathyHook": "Selling high-end products in cheap packaging instantly devalues the contents. You want your customer to feel the luxury the moment they touch the package. Upgrading to premium Leo packaging can revolutionize customer retention. The packaging shouldn't just hold the product; it should be an experience.",
    ...
    "section2Log": "Optimized Leo for maximum efficiency and brand impact. Film thickness: 120 microns. Barrier OTR less than 0.05 cc/m2/24hr.",
    ...
    "compTitle": "Standard Mailers vs. Premium Leo",
    "compDesc": "Compare tactile feel, durability, and customer retention metrics:",
    "faq1Q": "What makes Leo different?",
    "faq1A": "Our Leo uses advanced multi-layer films for superior barrier protection and a premium feel.",
...
const LeoBfa697: React.FC = () => {
  ...
  const IMAGES = {
    hero: '/imgs/testimonials/owner/leo.png',
    process: '/imgs/testimonials/owner/leo.png',
    comparison: '/imgs/testimonials/owner/leo.png'
  }
