...
const localTranslations = {
  "en": {
    "title": "Custom Shape Die Cut Pouch Infographic 3",
    "description": "Explore our premium, sustainable Custom Shape Die Cut Pouch Infographic 3 solutions designed for modern flexible packaging lines and high barrier requirements.",
    "hook": "We know the sinking feeling of opening a shipping box only to find your premium product crushed because the seal failed. When using standard Custom Shape Die Cut Pouch Infographic 3, you didn't spend months perfecting your recipe just to lose customers over cheap, unreliable packaging.",
    "pain_points": [
      {
        "num": "01",
    ...
    "engineering_notebook": "In my 14 years in packaging design, I've seen countless brands struggle with Custom Shape Die Cut Pouch Infographic 3. By upgrading the lamination tension and employing a secondary curing phase, we've eliminated curling entirely. - Ryan Wong, Co-Founder",
    "schema_faq": [
      {
        "q": "Is this Custom Shape Die Cut Pouch Infographic 3 eco-friendly?",
  ...
  "es": {
    "title": "Custom Shape Die Cut Pouch Infographic 3 (ES)",
    "description": "Explore nuestras soluciones premium de Custom Shape Die Cut Pouch Infographic 3.",
    ...
    "schema_faq": [
      {
        "q": "¿Es este Custom Shape Die Cut Pouch Infographic 3 ecológico?",
  ...
  "fr": {
    "title": "Custom Shape Die Cut Pouch Infographic 3 (FR)",
    "description": "Découvrez nos solutions premium de Custom Shape Die Cut Pouch Infographic 3.",
    ...
    "schema_faq": [
      {
        "q": "Ce Custom Shape Die Cut Pouch Infographic 3 est-il écologique?",
  ...
  "zh-tw": {
    "title": "Custom Shape Die Cut Pouch Infographic 3 (TW)",
    "description": "探索我們為 Custom Shape Die Cut Pouch Infographic 3 設計的高級解決方案。",
    ...
    "schema_faq": [
      {
        "q": "這個 Custom Shape Die Cut Pouch Infographic 3 環保嗎?",
        "a": "是的，我們提供可回收版本。"
      },
      {
        "q": "最低訂購量是多少?",
...
export default function CustomShapeDieCutPouchInfographic3() {
  ...
  return (
    <SEOPageLayout title={t.title} description={t.description}>
      ...
      <div className="max-w-4xl mx-auto py-12 px-4">
        ...
        <img src="/imgs/infographics/custom-shape-die-cut-pouch-infographic-3.png" alt={t.title} className="w-full max-w-lg mx-auto mb-8 rounded-xl shadow-lg" />
