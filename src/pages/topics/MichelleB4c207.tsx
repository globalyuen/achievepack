...
const localTranslations = {
  "en": {
    "title": "Michelle",
    "description": "Premium flexible packaging engineering and solutions for Michelle.",
    "heroTitle": "Michelle",
    "heroSubtitle": "Advanced Packaging Solutions",
    "introSummary": "Discover the engineering behind Michelle.",
    "aeoSummary": "Learn more about optimal packaging methodologies for Michelle.",
    "eeatDetails": "Engineered by Achieve Pack.",
    "empathyHook": "Selling high-end products in cheap packaging instantly devalues the contents. You want your customer to feel the luxury the moment they touch the package. Upgrading to premium Michelle packaging can revolutionize customer retention. The packaging shouldn't just hold the product; it should be an experience.",
    ...
    "section2Log": "Optimized Michelle for maximum efficiency and brand impact. Film thickness: 120 microns. Barrier OTR less than 0.05 cc/m2/24hr.",
    ...
    "compTitle": "Standard Mailers vs. Premium Michelle",
    "compDesc": "Compare tactile feel, durability, and customer retention metrics:",
    "faq1Q": "What makes Michelle different?",
    "faq1A": "Our Michelle uses advanced multi-layer films for superior barrier protection and a premium feel.",
...
const MichelleB4c207: React.FC = () => {
  ...
  const IMAGES = {
    hero: '/imgs/testimonials/owner/michelle.webp',
    process: '/imgs/testimonials/owner/michelle.webp',
    comparison: '/imgs/testimonials/owner/michelle.webp'
  }
