...
const localTranslations = {
  en: {
    title: "Leo | Advanced Packaging Solutions",
    description: "Discover the engineering behind our premium Leo. Learn how we solve common packaging challenges with cutting-edge materials and designs.",
    heroTitle: "Engineered Leo",
    heroSubtitle: "Solving Your Top 5 Packaging Pain Points",
    hook: "We know the sinking feeling of opening a shipping box only to find your premium product crushed because the seal failed. You didn't spend months perfecting your recipe just to lose customers over cheap, unreliable packaging. Our Leo is designed to prevent these exact disasters.",
  ...
  es: {
    title: "Leo | Soluciones Avanzadas",
    description: "Descubra la ingeniería detrás de nuestro Leo premium.",
    heroTitle: "Leo Diseñado",
    heroSubtitle: "Resolviendo Sus 5 Principales Puntos Delor",
    hook: "Conocemos la sensación de frustración al encontrar su producto premium dañado. Nuestro Leo está diseñado para prevenir estos desastres exactos.",
  ...
  fr: {
    title: "Leo | Solutions d'Emballage Avancées",
    description: "Découvrez l'ingénierie derrière notre Leo premium.",
    heroTitle: "Leo Conçu",
    heroSubtitle: "Résolution de vos 5 principaux problèmes d'emballage",
    hook: "Nous connaissons le sentiment de frustration lorsque vous trouvez votre produit premium endommagé. Notre Leo est conçu pour prévenir ces désastres.",
  ...
  zh: {
    title: "Leo | 高級包裝解決方案",
    description: "探索我們高級 Leo 背後的工程技術。",
    heroTitle: "精心設計的 Leo",
    heroSubtitle: "解決您的前5大包裝痛點",
    hook: "我們知道打開運輸箱卻發現優質產品因密封失敗而破損的沮喪感。我們的 Leo 旨在防止這些災難。",
...
export default function Leo() {
  ...
  const jsonLd = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "How does Leo improve my packaging?",
        "acceptedAnswer": {
          "@type": "Answer",
  ...
  return (
    <SEOPageLayout
      ...
      heroImage="/imgs/testimonials/owner/leo.webp"
    >
