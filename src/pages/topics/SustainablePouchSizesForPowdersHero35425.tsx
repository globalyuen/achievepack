...
const localTranslations = {
  "en": {
    "title": "Premium Sustainable Pouch Sizes For Powders Hero Solutions",
    "description": "High quality sustainable packaging for Sustainable Pouch Sizes For Powders Hero.",
...
export default function SustainablePouchSizesForPowdersHero35425() {
  const lang = 'en';
  ...
  return (
    <SEOPageLayout title={t.title} description={t.description}>
      ...
      <div className="max-w-4xl mx-auto py-12 px-4">
        ...
        <img src="/imgs/blog/heros/sustainable-pouch-sizes-for-powders-hero.png" alt={t.title} className="w-full max-w-lg mx-auto mb-8 rounded-xl shadow-lg" />
