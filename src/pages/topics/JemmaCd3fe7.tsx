...
const localTranslations = {
  "en": {
    "title": "Jemma",
    "description": "Premium flexible packaging engineering and solutions for Jemma.",
    "heroTitle": "Jemma",
    "heroSubtitle": "Advanced Packaging Solutions",
    "introSummary": "Discover the engineering behind Jemma.",
    "aeoSummary": "Learn more about optimal packaging methodologies for Jemma.",
    "eeatDetails": "Engineered by Achieve Pack.",
    "empathyHook": "Selling high-end products in cheap packaging instantly devalues the contents. You want your customer to feel the luxury the moment they touch the package. Upgrading to premium Jemma packaging can revolutionize customer retention. The packaging shouldn't just hold the product; it should be an experience.",
    ...
    "section2Log": "Optimized Jemma for maximum efficiency and brand impact. Film thickness: 120 microns. Barrier OTR less than 0.05 cc/m2/24hr.",
    ...
    "compTitle": "Standard Mailers vs. Premium Jemma",
    "compDesc": "Compare tactile feel, durability, and customer retention metrics:",
    "faq1Q": "What makes Jemma different?",
    "faq1A": "Our Jemma uses advanced multi-layer films for superior barrier protection and a premium feel.",
...
const JemmaCd3fe7: React.FC = () => {
  ...
  const IMAGES = {
    hero: '/imgs/testimonials/owner/jemma.png',
    process: '/imgs/testimonials/owner/jemma.png',
    comparison: '/imgs/testimonials/owner/jemma.png'
  }
