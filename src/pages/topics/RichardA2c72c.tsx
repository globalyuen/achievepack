...
const RichardA2c72c: React.FC = () => {
  ...
  const IMAGES = {
    hero: '/imgs/testimonials/owner/Richard.png',
    process: '/imgs/testimonials/owner/Richard.png',
    comparison: '/imgs/testimonials/owner/Richard.png'
  }
