...
const localTranslations = {
  "en": {
    "title": "A Industrial Compostable Card V1 5916306",
  ...
  "es": {
    "title": "A Industrial Compostable Card V1 5916306 (ES)",
    "description": "Premium sustainable packaging solution.",
    "hook": "Sabemos...",
    "pain_points": [],
  ...
  "fr": {
    "title": "A Industrial Compostable Card V1 5916306 (FR)",
    "description": "Premium sustainable packaging solution.",
    "hook": "Nous savons...",
    "pain_points": [],
    "engineering_notebook": "...",
  ...
  "zh-tw": {
    "title": "A Industrial Compostable Card V1 5916306 (TW)",
    "description": "Premium sustainable packaging solution.",
    "hook": "我們知道...",
    "pain_points": [],
    "engineering_notebook": "...",
...
export default function AIndustrialCompostableCardV15916306() {
