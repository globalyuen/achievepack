...
const PlantBasedBarrierCoatings: React.FC = () => {
  return (
    <>
      <Head>
        <title>Advanced Plant-Based Barrier Coatings | Achieve Pack</title>
        <meta name="description" content="Next-generation plant-based barrier technology for superior moisture and grease resistance." />
      </Head>
      <main className="bg-gray-50 min-h-screen font-sans text-gray-900">
        ...
        <section className="relative w-full h-[600px] flex items-center justify-center bg-gray-900 overflow-hidden">
          <div className="absolute inset-0 z-0">
            <Image
              src="/imgs/topics/plant-based-barrier-coatings/hero.jpg"
              alt="Plant Based Barrier Coatings Hero"
              fill
          ...
          <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
            <h1 className="text-5xl md:text-6xl font-bold text-white mb-6 tracking-tight">
              Advanced Plant-Based Barrier Coatings
            </h1>
        ...
        <section className="py-20 px-4 md:px-8 max-w-5xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-600 leading-relaxed">
            Moving away from traditional plastics often means sacrificing barrier properties, resulting in stale products and grease-stained packaging that ruins brand perception. Our plant-based barrier coatings rival conventional EVOH and PE, ensuring uncompromising moisture and oxygen resistance.
          </p>
        </section>
        ...
        <section className="py-20 bg-white px-4 md:px-8">
          <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative h-[400px] rounded-xl overflow-hidden shadow-2xl">
              <Image
                src="/imgs/topics/plant-based-barrier-coatings/process.jpg"
                alt="Plant Based Barrier Coatings Process"
                fill
                style={{ objectFit: 'cover' }}
              />
            </div>
        ...
        <section className="py-20 bg-gray-50 px-4 md:px-8">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <div className="relative h-[500px] w-full max-w-4xl mx-auto rounded-xl overflow-hidden shadow-2xl">
              <Image
                src="/imgs/topics/plant-based-barrier-coatings/comparison.jpg"
                alt="Plant Based Barrier Coatings Comparison"
                fill
                style={{ objectFit: 'cover' }}
              />
            </div>
