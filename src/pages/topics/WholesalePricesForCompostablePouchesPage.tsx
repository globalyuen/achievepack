...
const localTranslations = {
  "en": {
    "title": "Wholesale Prices For Compostable Pouches",
    "description": "Premium sustainable packaging solution for wholesale prices for compostable pouches.",
  ...
  "es": {
    "title": "Wholesale Prices For Compostable Pouches (ES)",
  ...
  "fr": {
    "title": "Wholesale Prices For Compostable Pouches (FR)",
  ...
  "zh-tw": {
    "title": "Wholesale Prices For Compostable Pouches (TW)",
...
export default function WholesalePricesForCompostablePouchesPage() {
