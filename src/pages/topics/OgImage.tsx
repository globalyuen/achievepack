...
const localTranslations = {
  en: {
    title: "Og Image | Advanced Packaging Solutions",
    description: "Discover the engineering behind our premium Og Image. Learn how we solve common packaging challenges with cutting-edge materials and designs.",
    heroTitle: "Engineered Og Image",
    heroSubtitle: "Solving Your Top 5 Packaging Pain Points",
    hook: "We know the sinking feeling of opening a shipping box only to find your premium product crushed because the seal failed. You didn't spend months perfecting your recipe just to lose customers over cheap, unreliable packaging. Our Og Image is designed to prevent these exact disasters.",
  ...
  es: {
    title: "Og Image | Soluciones Avanzadas",
    description: "Descubra la ingeniería detrás de nuestro Og Image premium.",
    heroTitle: "Og Image Diseñado",
    heroSubtitle: "Resolviendo Sus 5 Principales Puntos Delor",
    hook: "Conocemos la sensación de frustración al encontrar su producto premium dañado. Nuestro Og Image está diseñado para prevenir estos desastres exactos.",
  ...
  fr: {
    title: "Og Image | Solutions d'Emballage Avancées",
    description: "Découvrez l'ingénierie derrière notre Og Image premium.",
    heroTitle: "Og Image Conçu",
  ...
  "zh-tw": {
    title: "Og Image | 高級包裝解決方案",
    description: "探索我們高級 Og Image 背後的工程技術。",
    heroTitle: "精心設計的 Og Image",
...
export default function OgImage() {
  ...
  const jsonLd = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "How does Og Image improve my packaging?",
        "acceptedAnswer": {
          "@type": "Answer",
