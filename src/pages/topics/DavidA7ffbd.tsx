...
const localTranslations = {
  "en": {
    "title": "David",
    "description": "Premium flexible packaging engineering and solutions for David.",
    "heroTitle": "David",
    "heroSubtitle": "Advanced Packaging Solutions",
    "introSummary": "Discover the engineering behind David.",
    "aeoSummary": "Learn more about optimal packaging methodologies for David.",
    "eeatDetails": "Engineered by Achieve Pack.",
    "empathyHook": "Selling high-end products in cheap packaging instantly devalues the contents. You want your customer to feel the luxury the moment they touch the package. Upgrading to premium David packaging can revolutionize customer retention. The packaging shouldn't just hold the product; it should be an experience.",
    ...
    "section2Log": "Optimized David for maximum efficiency and brand impact. Film thickness: 120 microns. Barrier OTR less than 0.05 cc/m2/24hr.",
    ...
    "compTitle": "Standard Mailers vs. Premium David",
    "compDesc": "Compare tactile feel, durability, and customer retention metrics:",
    "faq1Q": "What makes David different?",
    "faq1A": "Our David uses advanced multi-layer films for superior barrier protection and a premium feel.",
...
const DavidA7ffbd: React.FC = () => {
  ...
  const IMAGES = {
    hero: '/imgs/testimonials/owner/david.png',
    process: '/imgs/testimonials/owner/david.png',
    comparison: '/imgs/testimonials/owner/david.png'
  }
