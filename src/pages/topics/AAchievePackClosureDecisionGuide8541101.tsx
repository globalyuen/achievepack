...
const localTranslations = {
  "en": {
    "title": "Premium A Achieve Pack Closure Decision Guide 8541101 Solutions",
    "description": "High quality sustainable packaging for A Achieve Pack Closure Decision Guide 8541101.",
