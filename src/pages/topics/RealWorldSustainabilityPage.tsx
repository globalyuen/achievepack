...
import { BarChart3, Package, CheckCircle, Award, Calendar, MessageCircle, Target, Shield, Zap, Globe, Factory, ArrowLeftRight, TrendingUp, ShoppingBag, Sparkles, Microscope, Beaker, FileSearch, Trash2, MicroscopeIcon } from 'lucide-react'
