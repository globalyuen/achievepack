...
const localTranslations = {
  en: {
    title: "Steph Retail Packaging Showcase",
    desc: "Comprehensive guide and case study on Steph Retail Packaging Showcase.",
    ...
    notebook: "In my 14 years in packaging design, I've seen countless brands fail because they underestimated the importance of proper barrier testing. When dealing with Steph Retail Packaging Showcase, always test the OTR in actual humidity conditions, not just dry lab states. — Ryan Wong, Co-Founder",
    faq1_q: "How does Steph Retail Packaging Showcase impact shelf life?",
    faq1_a: "By providing structural integrity and optimized barrier layers, Steph Retail Packaging Showcase extends shelf life up to 12-18 months.",
    faq2_q: "Is it compatible with automatic filling?",
    faq2_a: "Yes, it is designed for high-speed VFFS and rotary filling lines."
  },
  es: {
    title: "Steph Retail Packaging Showcase (ES)",
    desc: "Guía completa para Steph Retail Packaging Showcase en envases modernos.",
    ...
    faq1_q: "¿Cómo afecta Steph Retail Packaging Showcase a la vida útil?",
  ...
  fr: {
    title: "Steph Retail Packaging Showcase (FR)",
    desc: "Guide complet pour Steph Retail Packaging Showcase dans l'emballage moderne.",
    ...
    faq1_q: "Comment Steph Retail Packaging Showcase affecte-t-il la durée de conservation?",
  ...
  'zh-tw': {
    title: "Steph Retail Packaging Showcase (ZH)",
    desc: "現代包裝的Steph Retail Packaging Showcase綜合指南。",
    ...
    faq1_q: "Steph Retail Packaging Showcase如何影響保質期？",
...
export default function StephRetailPackagingShowcase({ language = 'en' }: { language?: 'en' | 'es' | 'fr' | 'zh-tw' }) {
  ...
  return (
    <SEOPageLayout>
      ...
      <div className="max-w-4xl mx-auto py-12 px-4">
        ...
        <ClickableImage src="/imgs/testimonials/owner/Steph.png" alt={t.title} className="w-full rounded-xl mb-8" />
