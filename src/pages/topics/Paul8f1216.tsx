...
const Paul8f1216: React.FC = () => {
  ...
  const IMAGES = {
    hero: '/imgs/testimonials/owner/Paul.png',
    process: '/imgs/testimonials/owner/Paul.png',
    comparison: '/imgs/testimonials/owner/Paul.png'
  }
