...
const localTranslations = {
  "en": {
    "title": "Compostable High Barrier Film Suppliers",
    "description": "Premium sustainable packaging solution for compostable high barrier film suppliers.",
  ...
  "es": {
    "title": "Compostable High Barrier Film Suppliers (ES)",
  ...
  "fr": {
    "title": "Compostable High Barrier Film Suppliers (FR)",
  ...
  "zh-tw": {
    "title": "Compostable High Barrier Film Suppliers (TW)",
...
export default function CompostableHighBarrierFilmSuppliersPage() {
  ...
  return (
    <SEOPageLayout title={t.title} description={t.description}>
      ...
      <div className="max-w-4xl mx-auto py-12 px-4">
        ...
        <img src="/imgs/infographics/compostable-high-barrier-film-suppliers-infographic-6.png" alt={t.title} className="w-full max-w-lg mx-auto mb-8 rounded-xl shadow-lg" />
