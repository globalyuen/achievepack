...
const localTranslations = {
  en: {
    title: "Infographic Plant Based | Advanced Packaging Solutions",
    description: "Discover the engineering behind our premium Infographic Plant Based. Learn how we solve common packaging challenges with cutting-edge materials and designs.",
    heroTitle: "Engineered Infographic Plant Based",
    heroSubtitle: "Solving Your Top 5 Packaging Pain Points",
    hook: "We know the sinking feeling of opening a shipping box only to find your premium product crushed because the seal failed. You didn't spend months perfecting your recipe just to lose customers over cheap, unreliable packaging. Our Infographic Plant Based is designed to prevent these exact disasters.",
  ...
  es: {
    title: "Infographic Plant Based | Soluciones Avanzadas",
    description: "Descubra la ingeniería detrás de nuestro Infographic Plant Based premium.",
    heroTitle: "Infographic Plant Based Diseñado",
    heroSubtitle: "Resolviendo Sus 5 Principales Puntos Delor",
    hook: "Conocemos la sensación de frustración al encontrar su producto premium dañado. Nuestro Infographic Plant Based está diseñado para prevenir estos desastres exactos.",
  ...
  fr: {
    title: "Infographic Plant Based | Solutions d'Emballage Avancées",
    description: "Découvrez l'ingénierie derrière notre Infographic Plant Based premium.",
    heroTitle: "Infographic Plant Based Conçu",
  ...
  "zh-tw": {
    title: "Infographic Plant Based | 高級包裝解決方案",
    description: "探索我們高級 Infographic Plant Based 背後的工程技術。",
    heroTitle: "精心設計的 Infographic Plant Based",
...
export default function InfographicPlantBased() {
  ...
  const jsonLd = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "How does Infographic Plant Based improve my packaging?",
        "acceptedAnswer": {
          "@type": "Answer",
  ...
  return (
    <SEOPageLayout
      ...
      heroImage="/imgs/infographic-plant-based.webp"
    >
