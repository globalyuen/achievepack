...
const localTranslations = {
  "en": {
    "title": "Premium Process Solutions",
    "description": "High quality sustainable packaging for Process.",
...
export default function Process32178() {
  const lang = 'en';
  ...
  return (
    <SEOPageLayout title={t.title} description={t.description}>
      ...
      <div className="max-w-4xl mx-auto py-12 px-4">
        ...
        <img src="/imgs/topics/custom-compostable-pouch-suppliers/process.png" alt={t.title} className="w-full max-w-lg mx-auto mb-8 rounded-xl shadow-lg" />
