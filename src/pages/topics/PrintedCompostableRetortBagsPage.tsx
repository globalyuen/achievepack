...
const localTranslations = {
  "en": {
    "title": "Printed Compostable Retort Bags",
    "description": "Premium sustainable packaging solution for printed compostable retort bags.",
  ...
  "es": {
    "title": "Printed Compostable Retort Bags (ES)",
  ...
  "fr": {
    "title": "Printed Compostable Retort Bags (FR)",
  ...
  "zh-tw": {
    "title": "Printed Compostable Retort Bags (TW)",
...
export default function PrintedCompostableRetortBagsPage() {
  ...
  return (
    <SEOPageLayout title={t.title} description={t.description}>
      ...
      <div className="max-w-4xl mx-auto py-12 px-4">
        ...
        <img src="/imgs/infographics/printed-compostable-retort-bags-infographic-2.png" alt={t.title} className="w-full max-w-lg mx-auto mb-8 rounded-xl shadow-lg" />
