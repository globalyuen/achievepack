...
const localTranslations = {
  en: {
    title: "Baby Food Packaging V3",
    desc: "Discover Baby Food Packaging V3 with premium eco-friendly materials and custom sizing.",
  ...
  es: {
    title: "Baby Food Packaging V3 (ES)",
    desc: "Descubra Baby Food Packaging V3 con materiales ecológicos premium.",
  ...
  fr: {
    title: "Baby Food Packaging V3 (FR)",
    desc: "Découvrez Baby Food Packaging V3 avec des matériaux écologiques premium.",
  ...
  'zh-tw': {
    title: "Baby Food Packaging V3 (ZH)",
    desc: "探索 Baby Food Packaging V3 結合優質環保材料與客製化尺寸。",
    hook: "我們知道當包裝失敗時的挫折感...",
...
export default function BabyFoodHeroV3() {
