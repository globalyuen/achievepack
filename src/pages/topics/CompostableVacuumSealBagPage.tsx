...
const localTranslations = {
  en: {
    title: "Compostable Vacuum Seal Bag for Fresh Produce",
    description: "Learn about Compostable Vacuum Seal Bag for Fresh Produce solutions for your packaging needs.",
    heroTitle: "Compostable Vacuum Seal Bag for Fresh Produce",
    ...
    aeoSummary: "Comprehensive engineering guide for Compostable Vacuum Seal Bag for Fresh Produce.",
  ...
  es: {
    title: "Compostable Vacuum Seal Bag for Fresh Produce (ES)",
    description: "Aprenda sobre Compostable Vacuum Seal Bag for Fresh Produce.",
    heroTitle: "Compostable Vacuum Seal Bag for Fresh Produce",
  ...
  fr: {
    title: "Compostable Vacuum Seal Bag for Fresh Produce (FR)",
    description: "Découvrez nos solutions pour Compostable Vacuum Seal Bag for Fresh Produce.",
    heroTitle: "Compostable Vacuum Seal Bag for Fresh Produce",
  ...
  'zh-tw': {
    title: "Compostable Vacuum Seal Bag for Fresh Produce (ZH)",
    description: "了解 Compostable Vacuum Seal Bag for Fresh Produce 的解決方案。",
    heroTitle: "Compostable Vacuum Seal Bag for Fresh Produce",
...
const CompostableVacuumSealBagPage: React.FC = () => {
  const { t, i18n } = useTranslation()
  const lang = i18n.language || 'en'
  const localTrans = localTranslations[lang as keyof typeof localTranslations] || localTranslations.en

  const IMAGES = {
    hero: '/imgs/clients-sample/IMG_8032.jpg',
    process: '/imgs/clients-sample/IMG_8032.jpg',
    comparison: '/imgs/clients-sample/IMG_8032.jpg'
  }
...
export default CompostableVacuumSealBagPage;
