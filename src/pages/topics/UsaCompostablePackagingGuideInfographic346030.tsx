...
const localTranslations = {
  "en": {
    "title": "Premium Usa Compostable Packaging Guide Infographic 3 Solutions",
    "description": "High quality sustainable packaging for Usa Compostable Packaging Guide Infographic 3.",
...
export default function UsaCompostablePackagingGuideInfographic346030() {
  const lang = 'en';
  ...
  return (
    <SEOPageLayout title={t.title} description={t.description}>
      ...
      <div className="max-w-4xl mx-auto py-12 px-4">
        ...
        <img src="/imgs/infographics/usa-compostable-packaging-guide-infographic-3.png" alt={t.title} className="w-full max-w-lg mx-auto mb-8 rounded-xl shadow-lg" />
