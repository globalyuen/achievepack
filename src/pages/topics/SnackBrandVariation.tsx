...
const SnackBrandVariation = () => {
  const { t } = useTranslation();
  const p = 'seoPages.pages.snack-brand-variation';
  ...
  return (
    <>
      <Helmet>
        <title>{t(`${p}.seo.title`, 'Snack Brand Packaging Variation | Achieve Pack')}</title>
      </Helmet>
      <SEOPageLayout 
        heroBgColor="#064e3b"
        title="Snack Brand Packaging Variation"
        description="Comprehensive guide and technical details."
        keywords={['packaging', 'Snack Brand Packaging Variation']}
        heroTitle="Snack Brand Packaging Variation"
...
export default SnackBrandVariation;
