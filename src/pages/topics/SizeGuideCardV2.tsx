...
const localTranslations = {
  en: {
    title: "Size Guide Card V2",
    desc: "Discover Size Guide Card V2 with premium eco-friendly materials and custom sizing.",
  ...
  es: {
    title: "Size Guide Card V2 (ES)",
    desc: "Descubra Size Guide Card V2 con materiales ecológicos premium.",
  ...
  fr: {
    title: "Size Guide Card V2 (FR)",
    desc: "Découvrez Size Guide Card V2 avec des matériaux écologiques premium.",
  ...
  'zh-tw': {
    title: "Size Guide Card V2 (ZH)",
    desc: "探索 Size Guide Card V2 結合優質環保材料與客製化尺寸。",
    hook: "我們知道當包裝失敗時的挫折感...",
...
export default function SizeGuideCardV2() {
