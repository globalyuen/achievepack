...
const localTranslations = {
  en: {
    title: "Jemma | Advanced Packaging Solutions",
    description: "Discover the engineering behind our premium Jemma. Learn how we solve common packaging challenges with cutting-edge materials and designs.",
    heroTitle: "Engineered Jemma",
    heroSubtitle: "Solving Your Top 5 Packaging Pain Points",
    hook: "We know the sinking feeling of opening a shipping box only to find your premium product crushed because the seal failed. You didn't spend months perfecting your recipe just to lose customers over cheap, unreliable packaging. Our Jemma is designed to prevent these exact disasters.",
  ...
  es: {
    title: "Jemma | Soluciones Avanzadas",
    description: "Descubra la ingeniería detrás de nuestro Jemma premium.",
    heroTitle: "Jemma Diseñado",
    heroSubtitle: "Resolviendo Sus 5 Principales Puntos Delor",
    hook: "Conocemos la sensación de frustración al encontrar su producto premium dañado. Nuestro Jemma está diseñado para prevenir estos desastres exactos.",
  ...
  fr: {
    title: "Jemma | Solutions d'Emballage Avancées",
    description: "Découvrez l'ingénierie derrière notre Jemma premium.",
    heroTitle: "Jemma Conçu",
    heroSubtitle: "Résolution de vos 5 principaux problèmes d'emballage",
    hook: "Nous connaissons le sentiment de frustration lorsque vous trouvez votre produit premium endommagé. Notre Jemma est conçu pour prévenir ces désastres.",
  ...
  zh: {
    title: "Jemma | 高級包裝解決方案",
    description: "探索我們高級 Jemma 背後的工程技術。",
    heroTitle: "精心設計的 Jemma",
    heroSubtitle: "解決您的前5大包裝痛點",
    hook: "我們知道打開運輸箱卻發現優質產品因密封失敗而破損的沮喪感。我們的 Jemma 旨在防止這些災難。",
...
export default function Jemma() {
  ...
  const jsonLd = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "How does Jemma improve my packaging?",
        "acceptedAnswer": {
          "@type": "Answer",
  ...
  return (
    <SEOPageLayout
      ...
      heroImage="/imgs/testimonials/owner/jemma.webp"
    >
