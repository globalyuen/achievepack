...
const EcommerceBrandPackagingSolutions = () => {
  const { t } = useTranslation();
  const p = 'seoPages.pages.ecommerce-brand-packaging-solutions';
  ...
  return (
    <>
      <Helmet>
        <title>{t(`${p}.seo.title`, 'Ecommerce Brand Packaging Solutions | Achieve Pack')}</title>
      </Helmet>
      <SEOPageLayout 
        heroBgColor="#064e3b"
        title="Ecommerce Brand Packaging Solutions"
        description="Comprehensive guide and technical details."
        keywords={['packaging', 'Ecommerce Brand Packaging Solutions']}
        heroTitle="Ecommerce Brand Packaging Solutions"
...
export default EcommerceBrandPackagingSolutions;
