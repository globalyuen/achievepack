...
const localTranslations = {
  "en": {
    "title": "Custom Shape Die Cut Pouch",
    "description": "Premium sustainable packaging solution for custom shape die cut pouch.",
  ...
  "es": {
    "title": "Custom Shape Die Cut Pouch (ES)",
  ...
  "fr": {
    "title": "Custom Shape Die Cut Pouch (FR)",
  ...
  "zh-tw": {
    "title": "Custom Shape Die Cut Pouch (TW)",
...
export default function CustomShapeDieCutPouchPage() {
