...
const localTranslations = {
  "en": {
    "title": "Digital Printing Flexible Packaging Small Runs",
    "description": "Premium sustainable packaging solution for digital printing flexible packaging small runs.",
  ...
  "es": {
    "title": "Digital Printing Flexible Packaging Small Runs (ES)",
  ...
  "fr": {
    "title": "Digital Printing Flexible Packaging Small Runs (FR)",
  ...
  "zh-tw": {
    "title": "Digital Printing Flexible Packaging Small Runs (TW)",
...
export default function DigitalPrintingFlexiblePackagingSmallRunsPage() {
  ...
  return (
    <SEOPageLayout title={t.title} description={t.description}>
      ...
      <div className="max-w-4xl mx-auto py-12 px-4">
        ...
        <img src="/imgs/infographics/digital-printing-flexible-packaging-small-runs-infographic-3.png" alt={t.title} className="w-full max-w-lg mx-auto mb-8 rounded-xl shadow-lg" />
