...
const localTranslations = {
  "en": {
    "title": "Remi",
    "description": "Premium flexible packaging engineering and solutions for Remi.",
    "heroTitle": "Remi",
    "heroSubtitle": "Advanced Packaging Solutions",
    "introSummary": "Discover the engineering behind Remi.",
    "aeoSummary": "Learn more about optimal packaging methodologies for Remi.",
    "eeatDetails": "Engineered by Achieve Pack.",
    "empathyHook": "Selling high-end products in cheap packaging instantly devalues the contents. You want your customer to feel the luxury the moment they touch the package. Upgrading to premium Remi packaging can revolutionize customer retention. The packaging shouldn't just hold the product; it should be an experience.",
    ...
    "section2Log": "Optimized Remi for maximum efficiency and brand impact. Film thickness: 120 microns. Barrier OTR less than 0.05 cc/m2/24hr.",
    ...
    "compTitle": "Standard Mailers vs. Premium Remi",
    "compDesc": "Compare tactile feel, durability, and customer retention metrics:",
    "faq1Q": "What makes Remi different?",
    "faq1A": "Our Remi uses advanced multi-layer films for superior barrier protection and a premium feel.",
...
const RemiEeb5ae: React.FC = () => {
  ...
  const IMAGES = {
    hero: '/imgs/testimonials/owner/remi.png',
    process: '/imgs/testimonials/owner/remi.png',
    comparison: '/imgs/testimonials/owner/remi.png'
  }
