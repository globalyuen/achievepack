...
const localTranslations = {
  "en": {
    "title": "Premium  Educational Cross Section Solutions",
    "description": "High quality sustainable packaging for  Educational Cross Section.",
...
export default function EducationalCrossSection() {
  const lang = 'en';
  ...
  return (
    <SEOPageLayout title={t.title} description={t.description}>
      ...
      <div className="max-w-4xl mx-auto py-12 px-4">
        ...
        <img src="/imgs/composting/benefits/ Educational cross-section.webp" alt={t.title} className="w-full max-w-lg mx-auto mb-8 rounded-xl shadow-lg" />
