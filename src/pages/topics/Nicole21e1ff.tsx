...
const localTranslations = {
  "en": {
    "title": "Nicole",
    "description": "Premium flexible packaging engineering and solutions for Nicole.",
    "heroTitle": "Nicole",
    "heroSubtitle": "Advanced Packaging Solutions",
    "introSummary": "Discover the engineering behind Nicole.",
    "aeoSummary": "Learn more about optimal packaging methodologies for Nicole.",
    "eeatDetails": "Engineered by Achieve Pack.",
    "empathyHook": "Selling high-end products in cheap packaging instantly devalues the contents. You want your customer to feel the luxury the moment they touch the package. Upgrading to premium Nicole packaging can revolutionize customer retention. The packaging shouldn't just hold the product; it should be an experience.",
    ...
    "section2Log": "Optimized Nicole for maximum efficiency and brand impact. Film thickness: 120 microns. Barrier OTR less than 0.05 cc/m2/24hr.",
    ...
    "compTitle": "Standard Mailers vs. Premium Nicole",
    "compDesc": "Compare tactile feel, durability, and customer retention metrics:",
    "faq1Q": "What makes Nicole different?",
    "faq1A": "Our Nicole uses advanced multi-layer films for superior barrier protection and a premium feel.",
...
const Nicole21e1ff: React.FC = () => {
  ...
  const IMAGES = {
    hero: '/imgs/testimonials/owner/nicole.webp',
    process: '/imgs/testimonials/owner/nicole.webp',
    comparison: '/imgs/testimonials/owner/nicole.webp'
  }
