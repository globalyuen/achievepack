...
const localTranslations = {
  "en": {
    "title": "Premium Commercial Composting Facility Illustration Solutions",
    "description": "High quality sustainable packaging for Commercial Composting Facility Illustration.",
...
export default function CommercialCompostingFacilityIllustration() {
  const lang = 'en';
  ...
  return (
    <SEOPageLayout title={t.title} description={t.description}>
      ...
      <div className="max-w-4xl mx-auto py-12 px-4">
        ...
        <img src="/imgs/composting/benefits/Commercial composting facility illustration.webp" alt={t.title} className="w-full max-w-lg mx-auto mb-8 rounded-xl shadow-lg" />
