...
const localTranslations = {
  en: {
    title: "Matte Finish Aluminum Foil Coffee Bag with Valve",
    description: "Learn about Matte Finish Aluminum Foil Coffee Bag with Valve solutions for your packaging needs.",
    heroTitle: "Matte Finish Aluminum Foil Coffee Bag with Valve",
    ...
    aeoSummary: "Comprehensive engineering guide for Matte Finish Aluminum Foil Coffee Bag with Valve.",
  ...
  es: {
    title: "Matte Finish Aluminum Foil Coffee Bag with Valve (ES)",
    description: "Aprenda sobre Matte Finish Aluminum Foil Coffee Bag with Valve.",
    heroTitle: "Matte Finish Aluminum Foil Coffee Bag with Valve",
  ...
  fr: {
    title: "Matte Finish Aluminum Foil Coffee Bag with Valve (FR)",
    description: "Découvrez nos solutions pour Matte Finish Aluminum Foil Coffee Bag with Valve.",
    heroTitle: "Matte Finish Aluminum Foil Coffee Bag with Valve",
  ...
  'zh-tw': {
    title: "Matte Finish Aluminum Foil Coffee Bag with Valve (ZH)",
    description: "了解 Matte Finish Aluminum Foil Coffee Bag with Valve 的解決方案。",
    heroTitle: "Matte Finish Aluminum Foil Coffee Bag with Valve",
...
const MatteFoilCoffeeBagPage: React.FC = () => {
  const { t, i18n } = useTranslation()
  const lang = i18n.language || 'en'
  const localTrans = localTranslations[lang as keyof typeof localTranslations] || localTranslations.en

  const IMAGES = {
    hero: '/imgs/clients-sample/IMG_8013.jpg',
    process: '/imgs/clients-sample/IMG_8013.jpg',
    comparison: '/imgs/clients-sample/IMG_8013.jpg'
  }
...
export default MatteFoilCoffeeBagPage;
