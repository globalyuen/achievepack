...
const localTranslations = {
  "en": {
    "title": "Ruby",
    "description": "Premium flexible packaging engineering and solutions for Ruby.",
    "heroTitle": "Ruby",
    "heroSubtitle": "Advanced Packaging Solutions",
    "introSummary": "Discover the engineering behind Ruby.",
    "aeoSummary": "Learn more about optimal packaging methodologies for Ruby.",
    "eeatDetails": "Engineered by Achieve Pack.",
    "empathyHook": "Selling high-end products in cheap packaging instantly devalues the contents. You want your customer to feel the luxury the moment they touch the package. Upgrading to premium Ruby packaging can revolutionize customer retention. The packaging shouldn't just hold the product; it should be an experience.",
    ...
    "section2Log": "Optimized Ruby for maximum efficiency and brand impact. Film thickness: 120 microns. Barrier OTR less than 0.05 cc/m2/24hr.",
    ...
    "compTitle": "Standard Mailers vs. Premium Ruby",
    "compDesc": "Compare tactile feel, durability, and customer retention metrics:",
    "faq1Q": "What makes Ruby different?",
    "faq1A": "Our Ruby uses advanced multi-layer films for superior barrier protection and a premium feel.",
...
const Ruby67bc0a: React.FC = () => {
  ...
  const IMAGES = {
    hero: '/imgs/testimonials/owner/ruby.webp',
    process: '/imgs/testimonials/owner/ruby.webp',
    comparison: '/imgs/testimonials/owner/ruby.webp'
  }
