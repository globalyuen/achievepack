...
const localTranslations = {
  "en": {
    "title": "Premium Spouted Foil 31 Solutions",
    "description": "High quality sustainable packaging for Spouted Foil 31.",
...
export default function SpoutedFoil3179874() {
  const lang = 'en';
  ...
  return (
    <SEOPageLayout title={t.title} description={t.description}>
      ...
      <div className="max-w-4xl mx-auto py-12 px-4">
        ...
        <img src="/imgs/seo/spouted_foil_31.png" alt={t.title} className="w-full max-w-lg mx-auto mb-8 rounded-xl shadow-lg" />
