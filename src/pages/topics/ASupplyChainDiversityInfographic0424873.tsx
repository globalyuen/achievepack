...
const localTranslations = {
  ...
  fr: {
    ...
    hook: "Nous connaissons le sentiment de frustration lorsque vous trouvez votre produit premium endommagé. Notre A Supply Chain Diversity Infographic 0424873 est conçu pour prévenir ces désastres.",
  ...
  zh: {
    ...
    hook: "我們知道打開運輸箱卻發現優質產品因密封失敗而破損的沮喪感。我們的 A Supply Chain Diversity Infographic 0424873 旨在防止這些災難。",
