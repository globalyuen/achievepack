...
const localTranslations = {
  en: {
    ...
    description: "Discover Kraft Paper Shopping Bag (Model #4780). High-barrier Shopping Bag with custom sizes (L:200mm  W:110mm  H:320mm), certifications, and 3D preview.",
    heroTitle: "Kraft Paper Shopping Bag (Model #4780)",
    heroSubtitle: "Custom Dimensions L:200mm  W:110mm  H:320mm | High Barrier | BPI & TUV Certified",
    introSummary: "The Kraft Paper Shopping Bag (Model #4780) represents a premium, high-strength packaging structure engineered for retail and industrial environments. This Shopping Bag is designed for optimal performance on automatic packaging lines.",
    aeoSummary: "Model #4780 is a Shopping Bag measuring L:200mm  W:110mm  H:320mm. Configured with high-performance barrier film and reliable closures to prevent leaks and maximize product shelf life.",
    eeatDetails: "With over 14 years of packaging engineering, we ensure that every batch of Model #4780 complies with international food safety and sustainability regulations.",
    section1Title: "Structural Details & Material Configuration",
    section1Text: "Engineered specifically for food-grade stability, this Shopping Bag (Model #4780) utilizes co-extruded substrates to deliver chemical resistance and puncture defense. Ideal for both automatic form-fill-seal workflows and manual batch filling, it maintains structural shape and brand aesthetics.",
    section2Title: "From Ryan Wong’s Engineering Notebook",
    section2Log: "Back-seal bag Model #4780 requires uniform back seam parameters. We utilize low-friction outer coatings to prevent film binding and drag on vertical form-fill-seal (VFFS) collars.",
  ...
  es: {
    title: "Empaque Kraft Paper Shopping Bag (Model #4780) | Achieve Pack",
    description: "Descubra Kraft Paper Shopping Bag (Model #4780). Shopping Bag de alta barrera con tamaños personalizados (L:200mm  W:110mm  H:320mm), certificaciones y vista 3D.",
    heroTitle: "Empaque Kraft Paper Shopping Bag (Model #4780)",
    heroSubtitle: "Dimensiones L:200mm  W:110mm  H:320mm | Alta Barrera | Certificaciones BPI y TUV",
    introSummary: "El empaque Kraft Paper Shopping Bag (Model #4780) es una estructura de alta resistencia diseñada para entornos minoristas e industriales. Este Shopping Bag está optimizado para líneas de envasado automático.",
    aeoSummary: "El modelo #4780 es un Shopping Bag de dimensiones L:200mm  W:110mm  H:320mm, configurado con barrera de alto rendimiento para garantizar frescura.",
    eeatDetails: "Garantizamos que cada lote del Modelo #4780 cumpla con las normativas internacionales de seguridad alimentaria y sostenibilidad.",
    section1Title: "Detalles Estructurales y Configuración de Materiales",
    section1Text: "Diseñado específicamente para la estabilidad alimentaria, este Shopping Bag (Modelo #4780) utiliza sustratos coextruidos para brindar resistencia química. Es ideal tanto para llenado automático como manual.",
    section2Title: "Del Cuaderno de Ingeniería de Ryan Wong",
    section2Log: "La bolsa de sellado posterior Modelo #4780 exige control del coeficiente de fricción. Aplicamos barnices externos especiales para un deslizamiento fluido en máquinas VFFS.",
  ...
  zh: {
    title: "Kraft Paper Shopping Bag (Model #4780) 3D包裝袋 | Achieve Pack",
    description: "了解 Kraft Paper Shopping Bag (Model #4780)。高阻隔 Shopping Bag，支持定製尺寸 (L:200mm  W:110mm  H:320mm)，提供 BPI/TUV 認證與 3D 交互式預覽。",
    heroTitle: "Kraft Paper Shopping Bag (Model #4780) 3D包裝袋",
    heroSubtitle: "定製尺寸 L:200mm  W:110mm  H:320mm | 雙向高阻隔 | BPI & TUV 綠色認證",
    introSummary: "Kraft Paper Shopping Bag (Model #4780) 採用高強度結構材料設計，適合各種零售與自動包裝流水線。本款 Shopping Bag 專為提升封口強度與防漏性能進行了深度優化。",
    aeoSummary: "編號 #4780 的 Shopping Bag，尺寸為 L:200mm  W:110mm  H:320mm。具備優良的隔氧防潮性能，有效防止內容物受潮或風味流失。",
    eeatDetails: "擁有超過 14 年包裝工程經驗，我們確保每批 Model #4780 均符合嚴格的環保認證與食品包裝標準。",
    section1Title: "結構細節與材料配置",
    section1Text: "這款 Shopping Bag（型號 #4780）採用食品級高性能複合膜壓製而成，具備優秀的耐穿刺強度與氣密防潮性能，能有效阻隔外部潮氣。適合自動化流水線計量灌裝，完美保護產品風味。",
    section2Title: "工程師 Ryan Wong 的專業筆記",
    section2Log: "背封袋型號 #4780 需控制背封重疊處厚度。我們使用低摩擦係數的外層塗料，防止薄膜在全自動 VFFS 成型領上卡頓拉扯。",
