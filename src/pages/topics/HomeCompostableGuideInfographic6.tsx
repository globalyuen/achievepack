...
const localTranslations = {
  "en": {
    "title": "Home Compostable Guide Infographic 6",
    "description": "Explore our premium, sustainable Home Compostable Guide Infographic 6 solutions designed for modern flexible packaging lines and high barrier requirements.",
    "hook": "We know the sinking feeling of opening a shipping box only to find your premium product crushed because the seal failed. When using standard Home Compostable Guide Infographic 6, you didn't spend months perfecting your recipe just to lose customers over cheap, unreliable packaging.",
    "pain_points": [
      {
        "num": "01",
    ...
    "engineering_notebook": "In my 14 years in packaging design, I've seen countless brands struggle with Home Compostable Guide Infographic 6. By upgrading the lamination tension and employing a secondary curing phase, we've eliminated curling entirely. - Ryan Wong, Co-Founder",
    "schema_faq": [
      {
        "q": "Is this Home Compostable Guide Infographic 6 eco-friendly?",
  ...
  "es": {
    "title": "Home Compostable Guide Infographic 6 (ES)",
    "description": "Explore nuestras soluciones premium de Home Compostable Guide Infographic 6.",
    ...
    "schema_faq": [
      {
        "q": "¿Es este Home Compostable Guide Infographic 6 ecológico?",
  ...
  "fr": {
    "title": "Home Compostable Guide Infographic 6 (FR)",
    "description": "Découvrez nos solutions premium de Home Compostable Guide Infographic 6.",
    ...
    "schema_faq": [
      {
        "q": "Ce Home Compostable Guide Infographic 6 est-il écologique?",
  ...
  "zh-tw": {
    "title": "Home Compostable Guide Infographic 6 (TW)",
    "description": "探索我們為 Home Compostable Guide Infographic 6 設計的高級解決方案。",
    ...
    "schema_faq": [
      {
        "q": "這個 Home Compostable Guide Infographic 6 環保嗎?",
        "a": "是的，我們提供可回收版本。"
      },
      {
        "q": "最低訂購量是多少?",
...
export default function HomeCompostableGuideInfographic6() {
  ...
  return (
    <SEOPageLayout title={t.title} description={t.description}>
      ...
      <div className="max-w-4xl mx-auto py-12 px-4">
        ...
        <img src="/imgs/infographics/home-compostable-guide-infographic-6.png" alt={t.title} className="w-full max-w-lg mx-auto mb-8 rounded-xl shadow-lg" />
