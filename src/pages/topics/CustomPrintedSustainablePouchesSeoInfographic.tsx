...
const localTranslations = {
  "en": {
    "title": "Custom Printed Sustainable Pouches Seo Infographic",
  ...
  "es": {
    "title": "Custom Printed Sustainable Pouches Seo Infographic (ES)",
    "description": "Premium sustainable packaging solution.",
    "hook": "Sabemos...",
    "pain_points": [],
  ...
  "fr": {
    "title": "Custom Printed Sustainable Pouches Seo Infographic (FR)",
    "description": "Premium sustainable packaging solution.",
    "hook": "Nous savons...",
    "pain_points": [],
    "engineering_notebook": "...",
  ...
  "zh-tw": {
    "title": "Custom Printed Sustainable Pouches Seo Infographic (TW)",
    "description": "Premium sustainable packaging solution.",
    "hook": "我們知道...",
    "pain_points": [],
    "engineering_notebook": "...",
...
export default function CustomPrintedSustainablePouchesSeoInfographic() {
  ...
  return (
    <SEOPageLayout title={t.title} description={t.description}>
      ...
      <div className="max-w-4xl mx-auto py-12 px-4">
        ...
        <img src="/imgs/seo-pages/custom-printed-sustainable-pouches-seo-infographic.png" alt={t.title} className="w-full max-w-lg mx-auto mb-8 rounded-xl shadow-lg" />
