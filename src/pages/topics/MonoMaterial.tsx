...
const localTranslations = {
  en: {
    title: "Mono Material | Advanced Packaging Solutions",
    description: "Discover the engineering behind our premium Mono Material. Learn how we solve common packaging challenges with cutting-edge materials and designs.",
    heroTitle: "Engineered Mono Material",
    heroSubtitle: "Solving Your Top 5 Packaging Pain Points",
    hook: "We know the sinking feeling of opening a shipping box only to find your premium product crushed because the seal failed. You didn't spend months perfecting your recipe just to lose customers over cheap, unreliable packaging. Our Mono Material is designed to prevent these exact disasters.",
  ...
  es: {
    title: "Mono Material | Soluciones Avanzadas",
    description: "Descubra la ingeniería detrás de nuestro Mono Material premium.",
    heroTitle: "Mono Material Diseñado",
    heroSubtitle: "Resolviendo Sus 5 Principales Puntos Delor",
    hook: "Conocemos la sensación de frustración al encontrar su producto premium dañado. Nuestro Mono Material está diseñado para prevenir estos desastres exactos.",
  ...
  fr: {
    title: "Mono Material | Solutions d'Emballage Avancées",
    description: "Découvrez l'ingénierie derrière notre Mono Material premium.",
    heroTitle: "Mono Material Conçu",
  ...
  "zh-tw": {
    title: "Mono Material | 高級包裝解決方案",
    description: "探索我們高級 Mono Material 背後的工程技術。",
    heroTitle: "精心設計的 Mono Material",
...
export default function MonoMaterial() {
  ...
  const jsonLd = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "How does Mono Material improve my packaging?",
        "acceptedAnswer": {
          "@type": "Answer",
