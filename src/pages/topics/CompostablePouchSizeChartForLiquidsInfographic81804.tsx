...
const localTranslations = {
  "en": {
    "title": "Premium Compostable Pouch Size Chart For Liquids Infographic Solutions",
    "description": "High quality sustainable packaging for Compostable Pouch Size Chart For Liquids Infographic.",
...
export default function CompostablePouchSizeChartForLiquidsInfographic81804() {
  const lang = 'en';
  ...
  return (
    <SEOPageLayout title={t.title} description={t.description}>
      ...
      <div className="max-w-4xl mx-auto py-12 px-4">
        ...
        <img src="/imgs/infographics/compostable-pouch-size-chart-for-liquids-infographic.png" alt={t.title} className="w-full max-w-lg mx-auto mb-8 rounded-xl shadow-lg" />
