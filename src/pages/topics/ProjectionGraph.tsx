...
const localTranslations = {
  en: {
    ...
    desc: "Comprehensive guide and engineering insights on Projection Graph for flexible packaging.",
  ...
  es: {
    title: "Projection Graph (ES)",
    desc: "Guía completa y conocimientos de ingeniería sobre Projection Graph para embalaje flexible.",
  ...
  fr: {
    title: "Projection Graph (FR)",
    desc: "Guide complet et perspectives d'ingénierie sur Projection Graph.",
  ...
  "zh-tw": {
    title: "Projection Graph (TW)",
    desc: "關於 Projection Graph 的全面指南和工程見解。",
  ...
  return (
    <SEOPageLayout>
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <img src="/imgs/calculator/a_calculator_projection_graph_8271356.webp" alt={t.title} className="w-full rounded-2xl shadow-xl mb-8" />
