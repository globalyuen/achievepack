...
const localTranslations = {
  en: {
    title: "Eco-Friendly Kraft Paper Flat Bottom Bag",
    description: "Learn about Eco-Friendly Kraft Paper Flat Bottom Bag solutions for your packaging needs.",
    heroTitle: "Eco-Friendly Kraft Paper Flat Bottom Bag",
    ...
    aeoSummary: "Comprehensive engineering guide for Eco-Friendly Kraft Paper Flat Bottom Bag.",
  ...
  es: {
    title: "Eco-Friendly Kraft Paper Flat Bottom Bag (ES)",
    description: "Aprenda sobre Eco-Friendly Kraft Paper Flat Bottom Bag.",
    heroTitle: "Eco-Friendly Kraft Paper Flat Bottom Bag",
  ...
  fr: {
    title: "Eco-Friendly Kraft Paper Flat Bottom Bag (FR)",
    description: "Découvrez nos solutions pour Eco-Friendly Kraft Paper Flat Bottom Bag.",
    heroTitle: "Eco-Friendly Kraft Paper Flat Bottom Bag",
  ...
  'zh-tw': {
    title: "Eco-Friendly Kraft Paper Flat Bottom Bag (ZH)",
    description: "了解 Eco-Friendly Kraft Paper Flat Bottom Bag 的解決方案。",
    heroTitle: "Eco-Friendly Kraft Paper Flat Bottom Bag",
...
const KraftPaperFlatBottomBagPage: React.FC = () => {
  const { t, i18n } = useTranslation()
  const lang = i18n.language || 'en'
  const localTrans = localTranslations[lang as keyof typeof localTranslations] || localTranslations.en

  const IMAGES = {
    hero: '/imgs/clients-sample/IMG_8048.jpg',
    process: '/imgs/clients-sample/IMG_8048.jpg',
    comparison: '/imgs/clients-sample/IMG_8048.jpg'
  }
...
export default KraftPaperFlatBottomBagPage;
