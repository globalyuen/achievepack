...
const BpiCertifiedCompostablePouchesPage: React.FC = () => {
  const { t, i18n } = useTranslation();
  const lang = i18n.language || 'en';

  const translations: any = {
    en: { title: "Bpi", desc: "Discover our comprehensive guide on bpi." },
    es: { title: "Bpi (ES)", desc: "Descubra nuestra guía completa sobre bpi." },
    fr: { title: "Bpi (FR)", desc: "Découvrez notre guide complet sur bpi." },
    zh: { title: "Bpi (ZH)", desc: "了解我们关于bpi的全面指南。" }
  };
  ...
  return (
    <SEOPageLayout
        ...
        },
        {
          ...
          content: (
            <div className="bg-gray-50 p-6 rounded-lg border border-gray-200 font-mono text-sm">
              <p className="text-blue-700 mb-2"># TECH_SPEC: BPI</p>
      ...
      faqs={[
        { question: "How does bpi improve ROI?", answer: "By reducing material waste and optimizing barrier performance, brands see a 15% drop in spoilage." },
...
export default BpiCertifiedCompostablePouchesPage;
