...
const localTranslations = {
  en: {
    title: "Cheryl Eco Design Case",
    desc: "Comprehensive guide and case study on Cheryl Eco Design Case.",
    ...
    notebook: "In my 14 years in packaging design, I've seen countless brands fail because they underestimated the importance of proper barrier testing. When dealing with Cheryl Eco Design Case, always test the OTR in actual humidity conditions, not just dry lab states. — Ryan Wong, Co-Founder",
    faq1_q: "How does Cheryl Eco Design Case impact shelf life?",
    faq1_a: "By providing structural integrity and optimized barrier layers, Cheryl Eco Design Case extends shelf life up to 12-18 months.",
    faq2_q: "Is it compatible with automatic filling?",
    faq2_a: "Yes, it is designed for high-speed VFFS and rotary filling lines."
  },
  es: {
    title: "Cheryl Eco Design Case (ES)",
    desc: "Guía completa para Cheryl Eco Design Case en envases modernos.",
    ...
    faq1_q: "¿Cómo afecta Cheryl Eco Design Case a la vida útil?",
  ...
  fr: {
    title: "Cheryl Eco Design Case (FR)",
    desc: "Guide complet pour Cheryl Eco Design Case dans l'emballage moderne.",
    ...
    faq1_q: "Comment Cheryl Eco Design Case affecte-t-il la durée de conservation?",
  ...
  'zh-tw': {
    title: "Cheryl Eco Design Case (ZH)",
    desc: "現代包裝的Cheryl Eco Design Case綜合指南。",
    ...
    faq1_q: "Cheryl Eco Design Case如何影響保質期？",
...
export default function CherylEcoDesignCase({ language = 'en' }: { language?: 'en' | 'es' | 'fr' | 'zh-tw' }) {
  ...
  return (
    <SEOPageLayout>
      ...
      <div className="max-w-4xl mx-auto py-12 px-4">
        ...
        <ClickableImage src="/imgs/testimonials/owner/cheryl.png" alt={t.title} className="w-full rounded-xl mb-8" />
