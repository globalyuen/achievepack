    ...
    <div className="topic-container p-8 max-w-7xl mx-auto">
      ...
      <header className="mb-12 text-center">
        ...
        <div className="bg-slate-900 text-white p-8 rounded-xl shadow-lg mb-12 border border-slate-700">
            <h1 className="text-3xl font-bold mb-4">Fastairfreight – Enterprise-Grade Flexible Packaging Engineering</h1>
