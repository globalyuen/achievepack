...
const localTranslations = {
  en: {
    title: "How To Start Your Packaging Journey",
    desc: "Comprehensive guide and case study on How To Start Your Packaging Journey.",
    ...
    notebook: "In my 14 years in packaging design, I've seen countless brands fail because they underestimated the importance of proper barrier testing. When dealing with How To Start Your Packaging Journey, always test the OTR in actual humidity conditions, not just dry lab states. — Ryan Wong, Co-Founder",
    faq1_q: "How does How To Start Your Packaging Journey impact shelf life?",
    faq1_a: "By providing structural integrity and optimized barrier layers, How To Start Your Packaging Journey extends shelf life up to 12-18 months.",
    faq2_q: "Is it compatible with automatic filling?",
    faq2_a: "Yes, it is designed for high-speed VFFS and rotary filling lines."
  },
  es: {
    title: "How To Start Your Packaging Journey (ES)",
    desc: "Guía completa para How To Start Your Packaging Journey en envases modernos.",
    ...
    faq1_q: "¿Cómo afecta How To Start Your Packaging Journey a la vida útil?",
  ...
  fr: {
    title: "How To Start Your Packaging Journey (FR)",
    desc: "Guide complet pour How To Start Your Packaging Journey dans l'emballage moderne.",
    ...
    faq1_q: "Comment How To Start Your Packaging Journey affecte-t-il la durée de conservation?",
  ...
  'zh-tw': {
    title: "How To Start Your Packaging Journey (ZH)",
    desc: "現代包裝的How To Start Your Packaging Journey綜合指南。",
    ...
    faq1_q: "How To Start Your Packaging Journey如何影響保質期？",
...
export default function HowToStartPackagingJourney({ language = 'en' }: { language?: 'en' | 'es' | 'fr' | 'zh-tw' }) {
  ...
  return (
    <SEOPageLayout>
      ...
      <div className="max-w-4xl mx-auto py-12 px-4">
        ...
        <ClickableImage src="/imgs/testimonials/start.webp" alt={t.title} className="w-full rounded-xl mb-8" />
