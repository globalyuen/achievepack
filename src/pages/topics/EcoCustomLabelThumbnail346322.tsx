...
const localTranslations = {
  "en": {
    "title": "Premium Eco Custom Label Thumbnail 3 Solutions",
    "description": "High quality sustainable packaging for Eco Custom Label Thumbnail 3.",
...
export default function EcoCustomLabelThumbnail346322() {
  const lang = 'en';
  ...
  return (
    <SEOPageLayout title={t.title} description={t.description}>
      ...
      <div className="max-w-4xl mx-auto py-12 px-4">
        ...
        <img src="/imgs/store/products-ai/eco-custom-label-thumbnail-3.webp" alt={t.title} className="w-full max-w-lg mx-auto mb-8 rounded-xl shadow-lg" />
