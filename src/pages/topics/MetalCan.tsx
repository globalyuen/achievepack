...
const localTranslations = {
  en: {
    title: "Metal Can",
    desc: "Comprehensive guide and engineering insights on Metal Can for flexible packaging.",
  ...
  es: {
    title: "Metal Can (ES)",
    desc: "Guía completa y conocimientos de ingeniería sobre Metal Can para embalaje flexible.",
  ...
  fr: {
    title: "Metal Can (FR)",
    desc: "Guide complet et perspectives d'ingénierie sur Metal Can.",
...
export default function MetalCan() {
