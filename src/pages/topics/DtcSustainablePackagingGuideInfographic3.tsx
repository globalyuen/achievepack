...
const localTranslations = {
  "en": {
    "title": "Premium Dtc Sustainable Packaging Guide Infographic 3 Solutions",
    "description": "High quality sustainable packaging for Dtc Sustainable Packaging Guide Infographic 3.",
