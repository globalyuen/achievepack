...
const localTranslations = {
  "en": {
    "title": "Premium Humidity Pack Eco Solutions",
    "description": "High quality sustainable packaging for Humidity Pack Eco.",
...
export default function HumidityPackEco26973() {
  const lang = 'en';
  ...
  return (
    <SEOPageLayout title={t.title} description={t.description}>
      ...
      <div className="max-w-4xl mx-auto py-12 px-4">
        ...
        <img src="/imgs/samples/humidity_pack_eco.png" alt={t.title} className="w-full max-w-lg mx-auto mb-8 rounded-xl shadow-lg" />
