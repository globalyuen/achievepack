...
const localTranslations = {
  ...
  "empathyHook": "It's incredibly frustrating to get hit with a massive, unexpected packaging tax bill at the end of the quarter. You're trying to grow your brand, and suddenly you are penalized just because your barrier film has a tiny layer of aluminum. I've spoken with operations managers who were pulling their hair out trying to understand eco-modulation fees. Navigating Extended Producer Responsibility (EPR) taxes feels like a maze designed to eat your margins. But switching to a mono-material structure that slashes those fees is entirely achievable without sacrificing freshness.",
