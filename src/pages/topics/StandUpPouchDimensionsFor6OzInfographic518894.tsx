...
const localTranslations = {
  "en": {
    "title": "Premium Stand Up Pouch Dimensions For 6 Oz Infographic 5 Solutions",
    "description": "High quality sustainable packaging for Stand Up Pouch Dimensions For 6 Oz Infographic 5.",
...
export default function StandUpPouchDimensionsFor6OzInfographic518894() {
  const lang = 'en';
  ...
  return (
    <SEOPageLayout title={t.title} description={t.description}>
      ...
      <div className="max-w-4xl mx-auto py-12 px-4">
        ...
        <img src="/imgs/infographics/stand-up-pouch-dimensions-for-6-oz-infographic-5.png" alt={t.title} className="w-full max-w-lg mx-auto mb-8 rounded-xl shadow-lg" />
