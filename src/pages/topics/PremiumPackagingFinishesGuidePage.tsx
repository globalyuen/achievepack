...
const PremiumPackagingFinishesGuidePage: React.FC = () => {
  const { t, i18n } = useTranslation();
  const lang = i18n.language || 'en';

  const translations: any = {
    en: { title: "Infographic Premium Finishes", desc: "Discover our comprehensive guide on infographic premium finishes." },
    es: { title: "Infographic Premium Finishes (ES)", desc: "Descubra nuestra guía completa sobre infographic premium finishes." },
    fr: { title: "Infographic Premium Finishes (FR)", desc: "Découvrez notre guide complet sur infographic premium finishes." },
    zh: { title: "Infographic Premium Finishes (ZH)", desc: "了解我们关于infographic premium finishes的全面指南。" }
  };
  ...
  return (
    <SEOPageLayout
        ...
        },
        {
          ...
          content: (
            <div className="bg-gray-50 p-6 rounded-lg border border-gray-200 font-mono text-sm">
              <p className="text-blue-700 mb-2"># TECH_SPEC: INFOGRAPHIC_PREMIUM_FINISHES</p>
      ...
      faqs={[
        { question: "How does infographic premium finishes improve ROI?", answer: "By reducing material waste and optimizing barrier performance, brands see a 15% drop in spoilage." },
...
export default PremiumPackagingFinishesGuidePage;
