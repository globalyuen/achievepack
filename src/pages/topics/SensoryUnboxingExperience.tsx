...
const localTranslations = {
  ...
  "empathyHook": "There's nothing worse than pouring your heart and soul into creating a premium product, only for your customer to receive it in a flimsy, crushed bag that's impossible to tear open cleanly. You know that disappointment when a matte finish scratches in transit, making your brand look cheap before they even taste what's inside. We've seen brands lose repeat customers purely because the unboxing felt frustrating and low-quality. A truly satisfying unboxing—that soft-touch feel, that perfect tear—is what turns a one-time buyer into a lifelong fan.",
