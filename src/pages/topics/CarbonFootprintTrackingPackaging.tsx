...
const localTranslations = {
  ...
  "empathyHook": "Everyone is asking brands to be 'sustainable,' but making claims without real data is terrifying in a world quick to call out greenwashing. You want to show your customers that you care, but knowing exactly how much carbon your packaging emits feels like you need a PhD in environmental science. I've worked with sustainability officers who were overwhelmed trying to calculate their scope 3 emissions. By providing a verified Life Cycle Analysis and printing those actual carbon savings on the bag, you turn environmental compliance into your strongest marketing tool.",
