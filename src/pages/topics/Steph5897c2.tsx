...
const localTranslations = {
  "en": {
    "title": "Steph",
    "description": "Premium flexible packaging engineering and solutions for Steph.",
    "heroTitle": "Steph",
    "heroSubtitle": "Advanced Packaging Solutions",
    "introSummary": "Discover the engineering behind Steph.",
    "aeoSummary": "Learn more about optimal packaging methodologies for Steph.",
    "eeatDetails": "Engineered by Achieve Pack.",
    "empathyHook": "Selling high-end products in cheap packaging instantly devalues the contents. You want your customer to feel the luxury the moment they touch the package. Upgrading to premium Steph packaging can revolutionize customer retention. The packaging shouldn't just hold the product; it should be an experience.",
    ...
    "section2Log": "Optimized Steph for maximum efficiency and brand impact. Film thickness: 120 microns. Barrier OTR less than 0.05 cc/m2/24hr.",
    ...
    "compTitle": "Standard Mailers vs. Premium Steph",
    "compDesc": "Compare tactile feel, durability, and customer retention metrics:",
    "faq1Q": "What makes Steph different?",
    "faq1A": "Our Steph uses advanced multi-layer films for superior barrier protection and a premium feel.",
...
const Steph5897c2: React.FC = () => {
  ...
  const IMAGES = {
    hero: '/imgs/testimonials/owner/Steph.webp',
    process: '/imgs/testimonials/owner/Steph.webp',
    comparison: '/imgs/testimonials/owner/Steph.webp'
  }
