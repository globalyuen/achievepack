...
const localTranslations = {
  "en": {
    "title": "Arielle",
    "description": "Premium flexible packaging engineering and solutions for Arielle.",
    "heroTitle": "Arielle",
    "heroSubtitle": "Advanced Packaging Solutions",
    "introSummary": "Discover the engineering behind Arielle.",
    "aeoSummary": "Learn more about optimal packaging methodologies for Arielle.",
    "eeatDetails": "Engineered by Achieve Pack.",
    "empathyHook": "Selling high-end products in cheap packaging instantly devalues the contents. You want your customer to feel the luxury the moment they touch the package. Upgrading to premium Arielle packaging can revolutionize customer retention. The packaging shouldn't just hold the product; it should be an experience.",
    ...
    "section2Log": "Optimized Arielle for maximum efficiency and brand impact. Film thickness: 120 microns. Barrier OTR less than 0.05 cc/m2/24hr.",
    ...
    "compTitle": "Standard Mailers vs. Premium Arielle",
    "compDesc": "Compare tactile feel, durability, and customer retention metrics:",
    "faq1Q": "What makes Arielle different?",
    "faq1A": "Our Arielle uses advanced multi-layer films for superior barrier protection and a premium feel.",
...
const Arielle40af85: React.FC = () => {
  ...
  const IMAGES = {
    hero: '/imgs/testimonials/owner/arielle.webp',
    process: '/imgs/testimonials/owner/arielle.webp',
    comparison: '/imgs/testimonials/owner/arielle.webp'
  }
