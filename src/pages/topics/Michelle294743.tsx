...
const Michelle294743: React.FC = () => {
  ...
  const IMAGES = {
    hero: '/imgs/testimonials/owner/michelle.png',
    process: '/imgs/testimonials/owner/michelle.png',
    comparison: '/imgs/testimonials/owner/michelle.png'
  }
