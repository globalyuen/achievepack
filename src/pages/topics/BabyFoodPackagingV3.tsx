...
const BabyFoodPackagingV3 = () => {
  const { t } = useTranslation();
  const p = 'seoPages.pages.baby-food-packaging-v3';
  ...
  return (
    <>
      <Helmet>
        <title>{t(`${p}.seo.title`, 'Baby Food Packaging Solutions V3 | Achieve Pack')}</title>
      </Helmet>
      <SEOPageLayout 
        heroBgColor="#064e3b"
        title="Baby Food Packaging Solutions V3"
        description="Comprehensive guide and technical details."
        keywords={['packaging', 'Baby Food Packaging Solutions V3']}
        heroTitle="Baby Food Packaging Solutions V3"
...
export default BabyFoodPackagingV3;
