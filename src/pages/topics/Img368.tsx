...
const localTranslations = {
  "en": {
    "title": "Premium 368 Solutions",
    "description": "High quality sustainable packaging for 368.",
...
export default function Img368() {
  const lang = 'en';
  ...
  return (
    <SEOPageLayout title={t.title} description={t.description}>
      ...
      <div className="max-w-4xl mx-auto py-12 px-4">
        ...
        <img src="/imgs/shapes/368.jpg" alt={t.title} className="w-full max-w-lg mx-auto mb-8 rounded-xl shadow-lg" />
