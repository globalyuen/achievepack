...
const BabyFoodPackagingV2 = () => {
  const { t } = useTranslation();
  const p = 'seoPages.pages.baby-food-packaging-v2';
  ...
  return (
    <>
      <Helmet>
        <title>{t(`${p}.seo.title`, 'Baby Food Packaging Solutions V2 | Achieve Pack')}</title>
      </Helmet>
      <SEOPageLayout 
        heroBgColor="#064e3b"
        title="Baby Food Packaging Solutions V2"
        description="Comprehensive guide and technical details."
        keywords={['packaging', 'Baby Food Packaging Solutions V2']}
        heroTitle="Baby Food Packaging Solutions V2"
...
export default BabyFoodPackagingV2;
