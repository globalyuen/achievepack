...
const localTranslations = {
  en: {
    title: "Surface Finish Close Detail B",
    desc: "Discover Surface Finish Close Detail B with premium eco-friendly materials and custom sizing.",
  ...
  es: {
    title: "Surface Finish Close Detail B (ES)",
    desc: "Descubra Surface Finish Close Detail B con materiales ecológicos premium.",
  ...
  fr: {
    title: "Surface Finish Close Detail B (FR)",
    desc: "Découvrez Surface Finish Close Detail B avec des matériaux écologiques premium.",
  ...
  'zh-tw': {
    title: "Surface Finish Close Detail B (ZH)",
    desc: "探索 Surface Finish Close Detail B 結合優質環保材料與客製化尺寸。",
    hook: "我們知道當包裝失敗時的挫折感...",
...
export default function SurfaceFinishCloseDetailB() {
