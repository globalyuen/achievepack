...
const localTranslations = {
  "en": {
    "title": "Compostable Pouch Size Chart For Liquids",
    "description": "Premium sustainable packaging solution for compostable pouch size chart for liquids.",
  ...
  "es": {
    "title": "Compostable Pouch Size Chart For Liquids (ES)",
  ...
  "fr": {
    "title": "Compostable Pouch Size Chart For Liquids (FR)",
  ...
  "zh-tw": {
    "title": "Compostable Pouch Size Chart For Liquids (TW)",
...
export default function CompostablePouchSizeChartForLiquidsPage() {
