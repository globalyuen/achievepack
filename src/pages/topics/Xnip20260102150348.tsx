...
const localTranslations = {
  "en": {
    "title": "Premium Xnip2026 01 02 15 03 48 Solutions",
    "description": "High quality sustainable packaging for Xnip2026 01 02 15 03 48.",
...
export default function Xnip20260102150348() {
  const lang = 'en';
