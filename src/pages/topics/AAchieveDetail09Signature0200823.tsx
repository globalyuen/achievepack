...
const localTranslations = {
  "en": {
    "title": "A Achieve Detail 09 Signature 0200823",
  ...
  "es": {
    "title": "A Achieve Detail 09 Signature 0200823 (ES)",
    "description": "Premium sustainable packaging solution.",
    "hook": "Sabemos...",
    "pain_points": [],
  ...
  "fr": {
    "title": "A Achieve Detail 09 Signature 0200823 (FR)",
    "description": "Premium sustainable packaging solution.",
    "hook": "Nous savons...",
    "pain_points": [],
    "engineering_notebook": "...",
  ...
  "zh-tw": {
    "title": "A Achieve Detail 09 Signature 0200823 (TW)",
    "description": "Premium sustainable packaging solution.",
    "hook": "我們知道...",
    "pain_points": [],
    "engineering_notebook": "...",
...
export default function AAchieveDetail09Signature0200823() {
  ...
  return (
    <SEOPageLayout title={t.title} description={t.description}>
      ...
      <div className="max-w-4xl mx-auto py-12 px-4">
        ...
        <img src="/imgs/demo-site/coffee/a_achieve_detail_09_signature_0200823.webp" alt={t.title} className="w-full max-w-lg mx-auto mb-8 rounded-xl shadow-lg" />
