...
const localTranslations = {
  en: {
    title: "Pattern Dots | Advanced Packaging Solutions",
    description: "Discover the engineering behind our premium Pattern Dots. Learn how we solve common packaging challenges with cutting-edge materials and designs.",
    heroTitle: "Engineered Pattern Dots",
    heroSubtitle: "Solving Your Top 5 Packaging Pain Points",
    hook: "We know the sinking feeling of opening a shipping box only to find your premium product crushed because the seal failed. You didn't spend months perfecting your recipe just to lose customers over cheap, unreliable packaging. Our Pattern Dots is designed to prevent these exact disasters.",
  ...
  es: {
    title: "Pattern Dots | Soluciones Avanzadas",
    description: "Descubra la ingeniería detrás de nuestro Pattern Dots premium.",
    heroTitle: "Pattern Dots Diseñado",
    heroSubtitle: "Resolviendo Sus 5 Principales Puntos Delor",
    hook: "Conocemos la sensación de frustración al encontrar su producto premium dañado. Nuestro Pattern Dots está diseñado para prevenir estos desastres exactos.",
  ...
  fr: {
    title: "Pattern Dots | Solutions d'Emballage Avancées",
    description: "Découvrez l'ingénierie derrière notre Pattern Dots premium.",
    heroTitle: "Pattern Dots Conçu",
  ...
  "zh-tw": {
    title: "Pattern Dots | 高級包裝解決方案",
    description: "探索我們高級 Pattern Dots 背後的工程技術。",
    heroTitle: "精心設計的 Pattern Dots",
...
export default function PatternDots() {
  ...
  const jsonLd = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "How does Pattern Dots improve my packaging?",
        "acceptedAnswer": {
          "@type": "Answer",
  ...
  return (
    <SEOPageLayout
      ...
      heroImage="/imgs/pattern-dots.svg"
    >
