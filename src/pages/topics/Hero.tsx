...
const localTranslations = {
  en: {
    title: "Hero | Advanced Packaging Solutions",
    description: "Discover the engineering behind our premium Hero. Learn how we solve common packaging challenges with cutting-edge materials and designs.",
    heroTitle: "Engineered Hero",
    heroSubtitle: "Solving Your Top 5 Packaging Pain Points",
    hook: "We know the sinking feeling of opening a shipping box only to find your premium product crushed because the seal failed. You didn't spend months perfecting your recipe just to lose customers over cheap, unreliable packaging. Our Hero is designed to prevent these exact disasters.",
  ...
  es: {
    title: "Hero | Soluciones Avanzadas",
    description: "Descubra la ingeniería detrás de nuestro Hero premium.",
    heroTitle: "Hero Diseñado",
    heroSubtitle: "Resolviendo Sus 5 Principales Puntos Delor",
    hook: "Conocemos la sensación de frustración al encontrar su producto premium dañado. Nuestro Hero está diseñado para prevenir estos desastres exactos.",
  ...
  fr: {
    title: "Hero | Solutions d'Emballage Avancées",
    description: "Découvrez l'ingénierie derrière notre Hero premium.",
    heroTitle: "Hero Conçu",
  ...
  "zh-tw": {
    title: "Hero | 高級包裝解決方案",
    description: "探索我們高級 Hero 背後的工程技術。",
    heroTitle: "精心設計的 Hero",
...
export default function Hero() {
  ...
  const jsonLd = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "How does Hero improve my packaging?",
        "acceptedAnswer": {
          "@type": "Answer",
