...
const localTranslations = {
  "en": {
    "title": "Achieve Pack Branding Spotlight",
  ...
  "es": {
    "title": "Achieve Pack Branding Spotlight (ES)",
    "description": "Premium sustainable packaging solution.",
    "hook": "Sabemos...",
    "pain_points": [],
  ...
  "fr": {
    "title": "Achieve Pack Branding Spotlight (FR)",
    "description": "Premium sustainable packaging solution.",
    "hook": "Nous savons...",
    "pain_points": [],
    "engineering_notebook": "...",
  ...
  "zh-tw": {
    "title": "Achieve Pack Branding Spotlight (TW)",
    "description": "Premium sustainable packaging solution.",
    "hook": "我們知道...",
    "pain_points": [],
    "engineering_notebook": "...",
...
export default function AchievePackBrandingSpotlight() {
  ...
  return (
    <SEOPageLayout title={t.title} description={t.description}>
      ...
      <div className="max-w-4xl mx-auto py-12 px-4">
        ...
        <img src="/imgs/pouch-shape/achieve-pack-branding-spotlight.png" alt={t.title} className="w-full max-w-lg mx-auto mb-8 rounded-xl shadow-lg" />
