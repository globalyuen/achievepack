...
const localTranslations = {
  "en": {
    "title": "Premium Mono Pe Vs Mono Pp Infographic Solutions",
    "description": "High quality sustainable packaging for Mono Pe Vs Mono Pp Infographic.",
...
export default function MonoPeVsMonoPpInfographic59032() {
  const lang = 'en';
