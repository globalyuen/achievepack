...
const localTranslations = {
  "en": {
    "title": "Premium Material Solutions",
    "description": "High quality sustainable packaging for Material.",
...
export default function Material45943() {
  const lang = 'en';
  ...
  return (
    <SEOPageLayout title={t.title} description={t.description}>
      ...
      <div className="max-w-4xl mx-auto py-12 px-4">
        ...
        <img src="/imgs/store/eco-stock/tea-bags/material.webp" alt={t.title} className="w-full max-w-lg mx-auto mb-8 rounded-xl shadow-lg" />
