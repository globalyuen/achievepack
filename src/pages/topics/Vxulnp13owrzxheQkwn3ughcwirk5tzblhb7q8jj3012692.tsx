...
const localTranslations = {
  "en": {
    "title": "Premium Vxulnp13Owrzxhe Qkwn3Ughcwirk5Tzblhb7Q8Jj30= Solutions",
    "description": "High quality sustainable packaging for Vxulnp13Owrzxhe Qkwn3Ughcwirk5Tzblhb7Q8Jj30=.",
...
export default function Vxulnp13owrzxheQkwn3ughcwirk5tzblhb7q8jj3012692() {
  const lang = 'en';
  ...
  return (
    <SEOPageLayout title={t.title} description={t.description}>
      ...
      <div className="max-w-4xl mx-auto py-12 px-4">
        ...
        <img src="/imgs/menu/eco-digital/vxuLNp13OWRZXhe-qkwn3UgHCWirk5TzBLhB7q8JJ30=.webp" alt={t.title} className="w-full max-w-lg mx-auto mb-8 rounded-xl shadow-lg" />
