...
const localTranslations = {
  en: {
    title: "Stand Up Pouch Sizing Guide Infographic | Advanced Packaging Solutions",
    description: "Discover the engineering behind our premium Stand Up Pouch Sizing Guide Infographic. Learn how we solve common packaging challenges with cutting-edge materials and designs.",
    heroTitle: "Engineered Stand Up Pouch Sizing Guide Infographic",
    heroSubtitle: "Solving Your Top 5 Packaging Pain Points",
    hook: "We know the sinking feeling of opening a shipping box only to find your premium product crushed because the seal failed. You didn't spend months perfecting your recipe just to lose customers over cheap, unreliable packaging. Our Stand Up Pouch Sizing Guide Infographic is designed to prevent these exact disasters.",
  ...
  es: {
    title: "Stand Up Pouch Sizing Guide Infographic | Soluciones Avanzadas",
    description: "Descubra la ingeniería detrás de nuestro Stand Up Pouch Sizing Guide Infographic premium.",
    heroTitle: "Stand Up Pouch Sizing Guide Infographic Diseñado",
    heroSubtitle: "Resolviendo Sus 5 Principales Puntos Delor",
    hook: "Conocemos la sensación de frustración al encontrar su producto premium dañado. Nuestro Stand Up Pouch Sizing Guide Infographic está diseñado para prevenir estos desastres exactos.",
  ...
  fr: {
    title: "Stand Up Pouch Sizing Guide Infographic | Solutions d'Emballage Avancées",
    description: "Découvrez l'ingénierie derrière notre Stand Up Pouch Sizing Guide Infographic premium.",
    heroTitle: "Stand Up Pouch Sizing Guide Infographic Conçu",
  ...
  zh: {
    title: "Stand Up Pouch Sizing Guide Infographic | 高級包裝解決方案",
    description: "探索我們高級 Stand Up Pouch Sizing Guide Infographic 背後的工程技術。",
    heroTitle: "精心設計的 Stand Up Pouch Sizing Guide Infographic",
...
export default function StandUpPouchSizingGuideInfographic() {
  ...
  const jsonLd = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "How does Stand Up Pouch Sizing Guide Infographic improve my packaging?",
        "acceptedAnswer": {
          "@type": "Answer",
  ...
  return (
    <SEOPageLayout
      ...
      heroImage="/imgs/infographics/stand-up-pouch-sizing-guide-infographic.png"
    >
