...
const localTranslations = {
  en: {
    title: "Img",
    desc: "Comprehensive guide and engineering insights on Img for flexible packaging.",
  ...
  es: {
    title: "Img (ES)",
    desc: "Guía completa y conocimientos de ingeniería sobre Img para embalaje flexible.",
  ...
  fr: {
    title: "Img (FR)",
    desc: "Guide complet et perspectives d'ingénierie sur Img.",
  ...
  return (
    <SEOPageLayout>
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <img src="/imgs/clients-sample/IMG_6311.jpg" alt={t.title} className="w-full rounded-2xl shadow-xl mb-8" />
