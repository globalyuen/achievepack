...
const localTranslations = {
  en: {
    title: "Bpi | Advanced Packaging Solutions",
    description: "Discover the engineering behind our premium Bpi. Learn how we solve common packaging challenges with cutting-edge materials and designs.",
    heroTitle: "Engineered Bpi",
    heroSubtitle: "Solving Your Top 5 Packaging Pain Points",
    hook: "We know the sinking feeling of opening a shipping box only to find your premium product crushed because the seal failed. You didn't spend months perfecting your recipe just to lose customers over cheap, unreliable packaging. Our Bpi is designed to prevent these exact disasters.",
  ...
  es: {
    title: "Bpi | Soluciones Avanzadas",
    description: "Descubra la ingeniería detrás de nuestro Bpi premium.",
    heroTitle: "Bpi Diseñado",
    heroSubtitle: "Resolviendo Sus 5 Principales Puntos Delor",
    hook: "Conocemos la sensación de frustración al encontrar su producto premium dañado. Nuestro Bpi está diseñado para prevenir estos desastres exactos.",
  ...
  fr: {
    title: "Bpi | Solutions d'Emballage Avancées",
    description: "Découvrez l'ingénierie derrière notre Bpi premium.",
    heroTitle: "Bpi Conçu",
  ...
  "zh-tw": {
    title: "Bpi | 高級包裝解決方案",
    description: "探索我們高級 Bpi 背後的工程技術。",
    heroTitle: "精心設計的 Bpi",
...
export default function Bpi() {
  ...
  const jsonLd = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "How does Bpi improve my packaging?",
        "acceptedAnswer": {
          "@type": "Answer",
