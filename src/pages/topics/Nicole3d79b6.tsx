...
const Nicole3d79b6: React.FC = () => {
  ...
  const IMAGES = {
    hero: '/imgs/testimonials/owner/nicole.png',
    process: '/imgs/testimonials/owner/nicole.png',
    comparison: '/imgs/testimonials/owner/nicole.png'
  }
