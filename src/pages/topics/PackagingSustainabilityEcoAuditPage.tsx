...
const PackagingSustainabilityEcoAuditPage: React.FC = () => {
  const { t, i18n } = useTranslation();
  const lang = i18n.language || 'en';

  const translations: any = {
    en: { title: "Eco Audit", desc: "Discover our comprehensive guide on eco audit." },
    es: { title: "Eco Audit (ES)", desc: "Descubra nuestra guía completa sobre eco audit." },
    fr: { title: "Eco Audit (FR)", desc: "Découvrez notre guide complet sur eco audit." },
    zh: { title: "Eco Audit (ZH)", desc: "了解我们关于eco audit的全面指南。" }
  };
  ...
  return (
    <SEOPageLayout
        ...
        },
        {
          ...
          content: (
            <div className="bg-gray-50 p-6 rounded-lg border border-gray-200 font-mono text-sm">
              <p className="text-blue-700 mb-2"># TECH_SPEC: ECO_AUDIT</p>
      ...
      faqs={[
        { question: "How does eco audit improve ROI?", answer: "By reducing material waste and optimizing barrier performance, brands see a 15% drop in spoilage." },
...
export default PackagingSustainabilityEcoAuditPage;
