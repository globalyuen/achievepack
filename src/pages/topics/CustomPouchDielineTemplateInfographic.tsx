...
const localTranslations = {
  "en": {
    "title": "Custom Pouch Dieline Template Infographic",
    "description": "Explore our premium, sustainable Custom Pouch Dieline Template Infographic solutions designed for modern flexible packaging lines and high barrier requirements.",
    "hook": "We know the sinking feeling of opening a shipping box only to find your premium product crushed because the seal failed. When using standard Custom Pouch Dieline Template Infographic, you didn't spend months perfecting your recipe just to lose customers over cheap, unreliable packaging.",
    "pain_points": [
      {
        "num": "01",
    ...
    "engineering_notebook": "In my 14 years in packaging design, I've seen countless brands struggle with Custom Pouch Dieline Template Infographic. By upgrading the lamination tension and employing a secondary curing phase, we've eliminated curling entirely. - Ryan Wong, Co-Founder",
    "schema_faq": [
      {
        "q": "Is this Custom Pouch Dieline Template Infographic eco-friendly?",
  ...
  "es": {
    "title": "Custom Pouch Dieline Template Infographic (ES)",
    "description": "Explore nuestras soluciones premium de Custom Pouch Dieline Template Infographic.",
    ...
    "schema_faq": [
      {
        "q": "¿Es este Custom Pouch Dieline Template Infographic ecológico?",
  ...
  "fr": {
    "title": "Custom Pouch Dieline Template Infographic (FR)",
    "description": "Découvrez nos solutions premium de Custom Pouch Dieline Template Infographic.",
    ...
    "schema_faq": [
      {
        "q": "Ce Custom Pouch Dieline Template Infographic est-il écologique?",
  ...
  "zh-tw": {
    "title": "Custom Pouch Dieline Template Infographic (TW)",
    "description": "探索我們為 Custom Pouch Dieline Template Infographic 設計的高級解決方案。",
    ...
    "schema_faq": [
      {
        "q": "這個 Custom Pouch Dieline Template Infographic 環保嗎?",
        "a": "是的，我們提供可回收版本。"
      },
      {
        "q": "最低訂購量是多少?",
...
export default function CustomPouchDielineTemplateInfographic() {
  ...
  return (
    <SEOPageLayout title={t.title} description={t.description}>
      ...
      <div className="max-w-4xl mx-auto py-12 px-4">
        ...
        <img src="/imgs/infographics/custom-pouch-dieline-template-infographic.png" alt={t.title} className="w-full max-w-lg mx-auto mb-8 rounded-xl shadow-lg" />
