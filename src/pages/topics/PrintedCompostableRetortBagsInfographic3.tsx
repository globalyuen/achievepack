...
const localTranslations = {
  "en": {
    "title": "Premium Printed Compostable Retort Bags Infographic 3 Solutions",
    "description": "High quality sustainable packaging for Printed Compostable Retort Bags Infographic 3.",
