...
const localTranslations = {
  "en": {
    "title": "Premium Low Minimum Digital Pouch Printing Infographic 4 Solutions",
    "description": "High quality sustainable packaging for Low Minimum Digital Pouch Printing Infographic 4.",
