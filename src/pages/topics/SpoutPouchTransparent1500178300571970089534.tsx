...
const localTranslations = {
  "en": {
    "title": "Premium Spout Pouch Transparent 1500 1783005719700 Solutions",
    "description": "High quality sustainable packaging for Spout Pouch Transparent 1500 1783005719700.",
...
export default function SpoutPouchTransparent1500178300571970089534() {
  const lang = 'en';
  ...
  return (
    <SEOPageLayout title={t.title} description={t.description}>
      ...
      <div className="max-w-4xl mx-auto py-12 px-4">
        ...
        <img src="/imgs/pouches/spout_pouch_transparent_1500_1783005719700.jpg" alt={t.title} className="w-full max-w-lg mx-auto mb-8 rounded-xl shadow-lg" />
