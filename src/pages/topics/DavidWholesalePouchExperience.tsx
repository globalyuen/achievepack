...
const localTranslations = {
  en: {
    title: "David Wholesale Pouch Experience",
    desc: "Comprehensive guide and case study on David Wholesale Pouch Experience.",
    ...
    notebook: "In my 14 years in packaging design, I've seen countless brands fail because they underestimated the importance of proper barrier testing. When dealing with David Wholesale Pouch Experience, always test the OTR in actual humidity conditions, not just dry lab states. — Ryan Wong, Co-Founder",
    faq1_q: "How does David Wholesale Pouch Experience impact shelf life?",
    faq1_a: "By providing structural integrity and optimized barrier layers, David Wholesale Pouch Experience extends shelf life up to 12-18 months.",
    faq2_q: "Is it compatible with automatic filling?",
    faq2_a: "Yes, it is designed for high-speed VFFS and rotary filling lines."
  },
  es: {
    title: "David Wholesale Pouch Experience (ES)",
    desc: "Guía completa para David Wholesale Pouch Experience en envases modernos.",
    ...
    faq1_q: "¿Cómo afecta David Wholesale Pouch Experience a la vida útil?",
  ...
  fr: {
    title: "David Wholesale Pouch Experience (FR)",
    desc: "Guide complet pour David Wholesale Pouch Experience dans l'emballage moderne.",
    ...
    faq1_q: "Comment David Wholesale Pouch Experience affecte-t-il la durée de conservation?",
  ...
  'zh-tw': {
    title: "David Wholesale Pouch Experience (ZH)",
    desc: "現代包裝的David Wholesale Pouch Experience綜合指南。",
    ...
    faq1_q: "David Wholesale Pouch Experience如何影響保質期？",
...
export default function DavidWholesalePouchExperience({ language = 'en' }: { language?: 'en' | 'es' | 'fr' | 'zh-tw' }) {
  ...
  return (
    <SEOPageLayout>
      ...
      <div className="max-w-4xl mx-auto py-12 px-4">
        ...
        <ClickableImage src="/imgs/testimonials/owner/david.webp" alt={t.title} className="w-full rounded-xl mb-8" />
