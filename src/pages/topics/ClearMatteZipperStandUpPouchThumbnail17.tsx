...
const localTranslations = {
  en: {
    ...
    notebookText: "In my 14 years in packaging design, I've seen countless brands struggle with barrier failures. When designing the Clear Matte Zipper Stand Up Pouch Thumbnail 17, we specifically calibrated the MVTR (Moisture Vapor Transmission Rate) to &lt; 0.1 g/m²/day and ensured a minimum seal strength of 45N/15mm to guarantee structural integrity on automated VFFS lines. Real-world performance always beats theoretical specs."
  },
  es: {
