...
const localTranslations = {
  "en": {
    "title": "Premium Eco Friendly Stand Up Pouch Dimensions Infographic 5 Solutions",
    "description": "High quality sustainable packaging for Eco Friendly Stand Up Pouch Dimensions Infographic 5.",
