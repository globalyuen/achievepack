...
const localTranslations = {
  "en": {
    "title": "A Achieve Detail 10 Final Masterpiece 6237738",
  ...
  "es": {
    "title": "A Achieve Detail 10 Final Masterpiece 6237738 (ES)",
    "description": "Premium sustainable packaging solution.",
    "hook": "Sabemos...",
    "pain_points": [],
  ...
  "fr": {
    "title": "A Achieve Detail 10 Final Masterpiece 6237738 (FR)",
    "description": "Premium sustainable packaging solution.",
    "hook": "Nous savons...",
    "pain_points": [],
    "engineering_notebook": "...",
  ...
  "zh-tw": {
    "title": "A Achieve Detail 10 Final Masterpiece 6237738 (TW)",
    "description": "Premium sustainable packaging solution.",
    "hook": "我們知道...",
    "pain_points": [],
    "engineering_notebook": "...",
...
export default function AAchieveDetail10FinalMasterpiece6237738() {
  ...
  return (
    <SEOPageLayout title={t.title} description={t.description}>
      ...
      <div className="max-w-4xl mx-auto py-12 px-4">
        ...
        <img src="/imgs/demo-site/coffee/a_achieve_detail_10_final_masterpiece_6237738.webp" alt={t.title} className="w-full max-w-lg mx-auto mb-8 rounded-xl shadow-lg" />
