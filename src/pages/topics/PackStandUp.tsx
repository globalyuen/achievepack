...
const localTranslations = {
  en: {
    title: "Pack Stand Up | Advanced Packaging Solutions",
    description: "Discover the engineering behind our premium Pack Stand Up. Learn how we solve common packaging challenges with cutting-edge materials and designs.",
    heroTitle: "Engineered Pack Stand Up",
    heroSubtitle: "Solving Your Top 5 Packaging Pain Points",
    hook: "We know the sinking feeling of opening a shipping box only to find your premium product crushed because the seal failed. You didn't spend months perfecting your recipe just to lose customers over cheap, unreliable packaging. Our Pack Stand Up is designed to prevent these exact disasters.",
  ...
  es: {
    title: "Pack Stand Up | Soluciones Avanzadas",
    description: "Descubra la ingeniería detrás de nuestro Pack Stand Up premium.",
    heroTitle: "Pack Stand Up Diseñado",
    heroSubtitle: "Resolviendo Sus 5 Principales Puntos Delor",
    hook: "Conocemos la sensación de frustración al encontrar su producto premium dañado. Nuestro Pack Stand Up está diseñado para prevenir estos desastres exactos.",
  ...
  fr: {
    title: "Pack Stand Up | Solutions d'Emballage Avancées",
    description: "Découvrez l'ingénierie derrière notre Pack Stand Up premium.",
    heroTitle: "Pack Stand Up Conçu",
    heroSubtitle: "Résolution de vos 5 principaux problèmes d'emballage",
    hook: "Nous connaissons le sentiment de frustration lorsque vous trouvez votre produit premium endommagé. Notre Pack Stand Up est conçu pour prévenir ces désastres.",
  ...
  zh: {
    title: "Pack Stand Up | 高級包裝解決方案",
    description: "探索我們高級 Pack Stand Up 背後的工程技術。",
    heroTitle: "精心設計的 Pack Stand Up",
    heroSubtitle: "解決您的前5大包裝痛點",
    hook: "我們知道打開運輸箱卻發現優質產品因密封失敗而破損的沮喪感。我們的 Pack Stand Up 旨在防止這些災難。",
...
export default function PackStandUp() {
  ...
  const jsonLd = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "How does Pack Stand Up improve my packaging?",
        "acceptedAnswer": {
          "@type": "Answer",
