...
const localTranslations = {
  "en": {
    "title": "Biope Kraft Duplex Low",
    "description": "Explore our premium, sustainable Biope Kraft Duplex Low solutions designed for modern flexible packaging lines and high barrier requirements.",
    "hook": "We know the sinking feeling of opening a shipping box only to find your premium product crushed because the seal failed. When using standard Biope Kraft Duplex Low, you didn't spend months perfecting your recipe just to lose customers over cheap, unreliable packaging.",
    "pain_points": [
      {
        "num": "01",
    ...
    "engineering_notebook": "In my 14 years in packaging design, I've seen countless brands struggle with Biope Kraft Duplex Low. By upgrading the lamination tension and employing a secondary curing phase, we've eliminated curling entirely. - Ryan Wong, Co-Founder",
    "schema_faq": [
      {
        "q": "Is this Biope Kraft Duplex Low eco-friendly?",
  ...
  "es": {
    "title": "Biope Kraft Duplex Low (ES)",
    "description": "Explore nuestras soluciones premium de Biope Kraft Duplex Low.",
    ...
    "schema_faq": [
      {
        "q": "¿Es este Biope Kraft Duplex Low ecológico?",
  ...
  "fr": {
    "title": "Biope Kraft Duplex Low (FR)",
    "description": "Découvrez nos solutions premium de Biope Kraft Duplex Low.",
    ...
    "schema_faq": [
      {
        "q": "Ce Biope Kraft Duplex Low est-il écologique?",
  ...
  "zh-tw": {
    "title": "Biope Kraft Duplex Low (TW)",
    "description": "探索我們為 Biope Kraft Duplex Low 設計的高級解決方案。",
    ...
    "schema_faq": [
      {
        "q": "這個 Biope Kraft Duplex Low 環保嗎?",
        "a": "是的，我們提供可回收版本。"
      },
      {
        "q": "最低訂購量是多少?",
...
export default function BiopeKraftDuplexLow() {
  ...
  return (
    <SEOPageLayout title={t.title} description={t.description}>
      ...
      <div className="max-w-4xl mx-auto py-12 px-4">
        ...
        <img src="/imgs/spec/biope-kraft-duplex-low.webp" alt={t.title} className="w-full max-w-lg mx-auto mb-8 rounded-xl shadow-lg" />
