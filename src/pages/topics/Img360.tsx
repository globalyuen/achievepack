...
const localTranslations = {
  "en": {
    "title": "Premium 360 Solutions",
    "description": "High quality sustainable packaging for 360.",
  ...
  return (
    <SEOPageLayout title={t.title} description={t.description}>
      ...
      <div className="max-w-4xl mx-auto py-12 px-4">
        ...
        <img src="/imgs/shapes/360.jpg" alt={t.title} className="w-full max-w-lg mx-auto mb-8 rounded-xl shadow-lg" />
