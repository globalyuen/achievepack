...
const localTranslations = {
  en: {
    title: "Heavy Duty Woven Polypropylene Sack for Agriculture",
    description: "Learn about Heavy Duty Woven Polypropylene Sack for Agriculture solutions for your packaging needs.",
    heroTitle: "Heavy Duty Woven Polypropylene Sack for Agriculture",
    ...
    aeoSummary: "Comprehensive engineering guide for Heavy Duty Woven Polypropylene Sack for Agriculture.",
  ...
  es: {
    title: "Heavy Duty Woven Polypropylene Sack for Agriculture (ES)",
    description: "Aprenda sobre Heavy Duty Woven Polypropylene Sack for Agriculture.",
    heroTitle: "Heavy Duty Woven Polypropylene Sack for Agriculture",
  ...
  fr: {
    title: "Heavy Duty Woven Polypropylene Sack for Agriculture (FR)",
    description: "Découvrez nos solutions pour Heavy Duty Woven Polypropylene Sack for Agriculture.",
    heroTitle: "Heavy Duty Woven Polypropylene Sack for Agriculture",
  ...
  'zh-tw': {
    title: "Heavy Duty Woven Polypropylene Sack for Agriculture (ZH)",
    description: "了解 Heavy Duty Woven Polypropylene Sack for Agriculture 的解決方案。",
    heroTitle: "Heavy Duty Woven Polypropylene Sack for Agriculture",
...
const WovenPolypropyleneSackPage: React.FC = () => {
  const { t, i18n } = useTranslation()
  const lang = i18n.language || 'en'
  const localTrans = localTranslations[lang as keyof typeof localTranslations] || localTranslations.en

  const IMAGES = {
    hero: '/imgs/clients-sample/IMG_8020.jpg',
    process: '/imgs/clients-sample/IMG_8020.jpg',
    comparison: '/imgs/clients-sample/IMG_8020.jpg'
  }
...
export default WovenPolypropyleneSackPage;
