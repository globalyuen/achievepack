...
const localTranslations = {
  "en": {
    "title": "Premium Side Gusset Premium Box Solutions",
    "description": "High quality sustainable packaging for Side Gusset Premium Box.",
...
export default function SideGussetPremiumBox84039() {
  const lang = 'en';
  ...
  return (
    <SEOPageLayout title={t.title} description={t.description}>
      ...
      <div className="max-w-4xl mx-auto py-12 px-4">
        ...
        <img src="/imgs/seo/side_gusset_premium_box.png" alt={t.title} className="w-full max-w-lg mx-auto mb-8 rounded-xl shadow-lg" />
