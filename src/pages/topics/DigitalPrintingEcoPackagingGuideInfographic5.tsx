...
const localTranslations = {
  "en": {
    "title": "Premium Digital Printing Eco Packaging Guide Infographic 5 Solutions",
    "description": "High quality sustainable packaging for Digital Printing Eco Packaging Guide Infographic 5.",
