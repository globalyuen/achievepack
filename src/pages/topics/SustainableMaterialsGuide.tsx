...
const SustainableMaterialsGuide = () => {
  const { t } = useTranslation();
  const p = 'seoPages.pages.sustainable-materials-guide';
  ...
  return (
    <>
      <Helmet>
        <title>{t(`${p}.seo.title`, 'Sustainable Materials Guide | Achieve Pack')}</title>
      </Helmet>
      <SEOPageLayout 
        heroBgColor="#064e3b"
        title="Sustainable Materials Guide"
        description="Comprehensive guide and technical details."
        keywords={['packaging', 'Sustainable Materials Guide']}
        heroTitle="Sustainable Materials Guide"
...
export default SustainableMaterialsGuide;
