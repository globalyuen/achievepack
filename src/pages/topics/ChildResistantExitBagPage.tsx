...
const localTranslations = {
  en: {
    title: "Child-Resistant Exit Bag for Pharmaceuticals",
    description: "Learn about Child-Resistant Exit Bag for Pharmaceuticals solutions for your packaging needs.",
    heroTitle: "Child-Resistant Exit Bag for Pharmaceuticals",
    ...
    aeoSummary: "Comprehensive engineering guide for Child-Resistant Exit Bag for Pharmaceuticals.",
  ...
  es: {
    title: "Child-Resistant Exit Bag for Pharmaceuticals (ES)",
    description: "Aprenda sobre Child-Resistant Exit Bag for Pharmaceuticals.",
    heroTitle: "Child-Resistant Exit Bag for Pharmaceuticals",
  ...
  fr: {
    title: "Child-Resistant Exit Bag for Pharmaceuticals (FR)",
    description: "Découvrez nos solutions pour Child-Resistant Exit Bag for Pharmaceuticals.",
    heroTitle: "Child-Resistant Exit Bag for Pharmaceuticals",
  ...
  'zh-tw': {
    title: "Child-Resistant Exit Bag for Pharmaceuticals (ZH)",
    description: "了解 Child-Resistant Exit Bag for Pharmaceuticals 的解決方案。",
    heroTitle: "Child-Resistant Exit Bag for Pharmaceuticals",
...
const ChildResistantExitBagPage: React.FC = () => {
  ...
  const IMAGES = {
    hero: '/imgs/clients-sample/IMG_8016.jpg',
    process: '/imgs/clients-sample/IMG_8016.jpg',
    comparison: '/imgs/clients-sample/IMG_8016.jpg'
  }
