...
const localTranslations = {
  "en": {
    "title": "Premium Kraft Stand Up Pouches With Window Infographic 6 Solutions",
    "description": "High quality sustainable packaging for Kraft Stand Up Pouches With Window Infographic 6.",
