...
const localTranslations = {
  "en": {
    "title": "Premium Test Slug Schema Infographic 6 Solutions",
    "description": "High quality sustainable packaging for Test Slug Schema Infographic 6.",
...
export default function TestSlugSchemaInfographic6() {
  const lang = 'en';
