...
const localTranslations = {
  "en": {
    "title": "Premium Eco Flatbottom Premium Solutions",
    "description": "High quality sustainable packaging for Eco Flatbottom Premium.",
...
export default function EcoFlatbottomPremium31645() {
  const lang = 'en';
  ...
  return (
    <SEOPageLayout title={t.title} description={t.description}>
      ...
      <div className="max-w-4xl mx-auto py-12 px-4">
        ...
        <img src="/imgs/seo/eco_flatbottom_premium.png" alt={t.title} className="w-full max-w-lg mx-auto mb-8 rounded-xl shadow-lg" />
