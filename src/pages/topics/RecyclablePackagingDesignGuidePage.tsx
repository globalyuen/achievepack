...
const RecyclablePackagingDesignGuidePage: React.FC = () => {
  const { t, i18n } = useTranslation();
  const lang = i18n.language || 'en';

  const translations: any = {
    en: { title: "Recyclable Guide", desc: "Discover our comprehensive guide on recyclable guide." },
    es: { title: "Recyclable Guide (ES)", desc: "Descubra nuestra guía completa sobre recyclable guide." },
    fr: { title: "Recyclable Guide (FR)", desc: "Découvrez notre guide complet sur recyclable guide." },
    zh: { title: "Recyclable Guide (ZH)", desc: "了解我们关于recyclable guide的全面指南。" }
  };
  ...
  return (
    <SEOPageLayout
      ...
      faqs={[
        { question: "How does recyclable guide improve ROI?", answer: "By reducing material waste and optimizing barrier performance, brands see a 15% drop in spoilage." },
...
export default RecyclablePackagingDesignGuidePage;
