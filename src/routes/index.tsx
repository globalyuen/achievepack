...
const routes = [
  ...
  { path: "/shop", element: <LazyRoute component={() => import('../pages/pouch/PouchShopPage')} fallback={<LoadingFallback />} /> },
  { path: "/shop/:productId", element: <LazyRoute component={() => import('../pages/pouch/PouchProductDetailPage')} fallback={<LoadingFallback />} /> },
  ...
  { path: "/topics/compostable-humidity-control", element: <LazyRoute component={() => import('../pages/topics/CompostableHumidityControlPage')} fallback={<LoadingFallback />} /> },
    ...
    // Phase 2 Topics (hyphen-based URLs - SEO standard)
  { path: "/topics/cacao-stand-up", element: <LazyRoute component={() => import('../pages/topics/CacaoStandUp')} fallback={<LoadingFallback />} /> },
  { path: "/topics/spices-moisture-proof", element: <LazyRoute component={() => import('../pages/topics/SpicesMoistureProof')} fallback={<LoadingFallback />} /> },
  { path: "/topics/premium-tea", element: <LazyRoute component={() => import('../pages/topics/PremiumTea')} fallback={<LoadingFallback />} /> },
  { path: "/topics/cocktail-spout", element: <LazyRoute component={() => import('../pages/topics/CocktailSpout')} fallback={<LoadingFallback />} /> },
  { path: "/topics/candy-uv", element: <LazyRoute component={() => import('../pages/topics/CandyUv')} fallback={<LoadingFallback />} /> },
  { path: "/topics/crisps-shaped", element: <LazyRoute component={() => import('../pages/topics/CrispsShaped')} fallback={<LoadingFallback />} /> },
  { path: "/topics/dried-fruits-tear-notch", element: <LazyRoute component={() => import('../pages/topics/DriedFruitsTearNotch')} fallback={<LoadingFallback />} /> },
  { path: "/topics/cheese-pocket-zipper", element: <LazyRoute component={() => import('../pages/topics/CheesePocketZipper')} fallback={<LoadingFallback />} /> },
  { path: "/topics/euro-hole-hang", element: <LazyRoute component={() => import('../pages/topics/EuroHoleHang')} fallback={<LoadingFallback />} /> },
  { path: "/topics/pharma-velcro", element: <LazyRoute component={() => import('../pages/topics/PharmaVelcro')} fallback={<LoadingFallback />} /> },
  { path: "/topics/detergent-spout", element: <LazyRoute component={() => import('../pages/topics/DetergentSpout')} fallback={<LoadingFallback />} /> },
  { path: "/topics/electronics-anti-static", element: <LazyRoute component={() => import('../pages/topics/ElectronicsAntiStatic')} fallback={<LoadingFallback />} /> },
  { path: "/topics/apparel-zipper", element: <LazyRoute component={() => import('../pages/topics/ApparelZipper')} fallback={<LoadingFallback />} /> },
  { path: "/topics/hologram-hot-stamping", element: <LazyRoute component={() => import('../pages/topics/HologramHotStamping')} fallback={<LoadingFallback />} /> },
  { path: "/topics/granola-soft-touch", element: <LazyRoute component={() => import('../pages/topics/GranolaSoftTouch')} fallback={<LoadingFallback />} /> },
  { path: "/topics/collagen-high-barrier", element: <LazyRoute component={() => import('../pages/topics/CollagenHighBarrier')} fallback={<LoadingFallback />} /> },
  { path: "/topics/pla-rice", element: <LazyRoute component={() => import('../pages/topics/PlaRice')} fallback={<LoadingFallback />} /> },
  { path: "/topics/rice-paper-artisanal", element: <LazyRoute component={() => import('../pages/topics/RicePaperArtisanal')} fallback={<LoadingFallback />} /> },
  { path: "/topics/ddp-packaging", element: <LazyRoute component={() => import('../pages/topics/DdpPackaging')} fallback={<LoadingFallback />} /> },
  { path: "/topics/fast-air-freight", element: <LazyRoute component={() => import('../pages/topics/FastAirFreight')} fallback={<LoadingFallback />} /> },
  { path: "/topics/fda-brc-certified", element: <LazyRoute component={() => import('../pages/topics/FdaBrcCertified')} fallback={<LoadingFallback />} /> },
  { path: "/topics/iso-sustainable", element: <LazyRoute component={() => import('../pages/topics/IsoSustainable')} fallback={<LoadingFallback />} /> },
  { path: "/topics/urgent-orders", element: <LazyRoute component={() => import('../pages/topics/UrgentOrders')} fallback={<LoadingFallback />} /> },
  { path: "/topics/frozen-vacuum", element: <LazyRoute component={() => import('../pages/topics/FrozenVacuum')} fallback={<LoadingFallback />} /> },
  { path: "/topics/evoh-retort", element: <LazyRoute component={() => import('../pages/topics/EvohRetort')} fallback={<LoadingFallback />} /> },
  { path: "/topics/beef-jerky-barrier", element: <LazyRoute component={() => import('../pages/topics/BeefJerkyBarrier')} fallback={<LoadingFallback />} /> },
  { path: "/topics/home-vs-industrial-compostable", element: <LazyRoute component={() => import('../pages/topics/HomeVsIndustrialCompostable')} fallback={<LoadingFallback />} /> },
  { path: "/topics/pet-food-quad-seal", element: <LazyRoute component={() => import('../pages/topics/PetFoodQuadSeal')} fallback={<LoadingFallback />} /> },
  { path: "/topics/valve-coffee-bags", element: <LazyRoute component={() => import('../pages/topics/ValveCoffeeBags')} fallback={<LoadingFallback />} /> },
  // Underscore aliases → redirect to canonical hyphen URLs (backwards compatibility)
  { path: "/topics/cacao_stand_up", element: <Navigate to="/topics/cacao-stand-up" replace /> },
  { path: "/topics/spices_moisture_proof", element: <Navigate to="/topics/spices-moisture-proof" replace /> },
  { path: "/topics/premium_tea", element: <Navigate to="/topics/premium-tea" replace /> },
  { path: "/topics/cocktail_spout", element: <Navigate to="/topics/cocktail-spout" replace /> },
  { path: "/topics/candy_uv", element: <Navigate to="/topics/candy-uv" replace /> },
  { path: "/topics/crisps_shaped", element: <Navigate to="/topics/crisps-shaped" replace /> },
  { path: "/topics/dried_fruits_tear_notch", element: <Navigate to="/topics/dried-fruits-tear-notch" replace /> },
  { path: "/topics/cheese_pocket_zipper", element: <Navigate to="/topics/cheese-pocket-zipper" replace /> },
  { path: "/topics/euro_hole_hang", element: <Navigate to="/topics/euro-hole-hang" replace /> },
  { path: "/topics/pharma_velcro", element: <Navigate to="/topics/pharma-velcro" replace /> },
  { path: "/topics/detergent_spout", element: <Navigate to="/topics/detergent-spout" replace /> },
  { path: "/topics/electronics_anti_static", element: <Navigate to="/topics/electronics-anti-static" replace /> },
  { path: "/topics/apparel_zipper", element: <Navigate to="/topics/apparel-zipper" replace /> },
  { path: "/topics/hologram_hot_stamping", element: <Navigate to="/topics/hologram-hot-stamping" replace /> },
  { path: "/topics/granola_soft_touch", element: <Navigate to="/topics/granola-soft-touch" replace /> },
  { path: "/topics/collagen_high_barrier", element: <Navigate to="/topics/collagen-high-barrier" replace /> },
  { path: "/topics/pla_rice", element: <Navigate to="/topics/pla-rice" replace /> },
  { path: "/topics/rice_paper_artisanal", element: <Navigate to="/topics/rice-paper-artisanal" replace /> },
  { path: "/topics/ddp_packaging", element: <Navigate to="/topics/ddp-packaging" replace /> },
  { path: "/topics/fast_air_freight", element: <Navigate to="/topics/fast-air-freight" replace /> },
  { path: "/topics/fda_brc_certified", element: <Navigate to="/topics/fda-brc-certified" replace /> },
  { path: "/topics/iso_sustainable", element: <Navigate to="/topics/iso-sustainable" replace /> },
  { path: "/topics/urgent_orders", element: <Navigate to="/topics/urgent-orders" replace /> },
  { path: "/topics/frozen_vacuum", element: <Navigate to="/topics/frozen-vacuum" replace /> },
  { path: "/topics/evoh_retort", element: <Navigate to="/topics/evoh-retort" replace /> },
  { path: "/topics/beef_jerky_barrier", element: <Navigate to="/topics/beef-jerky-barrier" replace /> },
  { path: "/topics/home_vs_industrial_compostable", element: <Navigate to="/topics/home-vs-industrial-compostable" replace /> },
  { path: "/topics/pet_food_quad_seal", element: <Navigate to="/topics/pet-food-quad-seal" replace /> },
  { path: "/topics/valve_coffee_bags", element: <Navigate to="/topics/valve-coffee-bags" replace /> },
  ...
  // SEO & AIEO B2B Packaging Showcase Pages
  { path: "/solutions", element: <LazyRoute component={() => import('../pages/FormulaDirectoryPage').then(m => ({ default: m.FormulaDirectoryPage }))} fallback={<LoadingFallback />} /> },
  { path: "/solutions/:slug", element: <LazyRoute component={() => import('../pages/FormulaShowcasePage').then(m => ({ default: m.FormulaShowcasePage }))} fallback={<LoadingFallback />} /> },
  ...
  { path: "/studio-v2", element: <LazyRoute component={() => import('../pages/PackageEditorPageV2')} fallback={<LoadingFallback />} /> },
