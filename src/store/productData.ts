...
const CONVENTIONAL_PRODUCTS: ConventionalProduct[] = [
  // ===== 3 Side Seal Pouches =====
  {
    ...
    images: [
      '/imgs/store/products/conven-3ss-clear-xzip-premium.png?v=2',
  ...
  },
  {
    ...
    images: [
      '/imgs/store/products/conven-3ss-clear-zip-premium.png?v=2',
  ...
  },
  {
    ...
    images: [
      '/imgs/store/products/conven-3ss-met-xzip-premium.png?v=2',
  ...
  },
  {
    ...
    images: [
      '/imgs/store/products/conven-3ss-met-zip-premium.png?v=2',
  ...
  // ===== Stand Up Pouches =====
  {
    ...
    images: [
      '/imgs/store/products/conven-sup-clear-xzip-premium.png?v=2',
  ...
  },
  {
    ...
    images: [
      '/imgs/store/products/conven-sup-clear-zip-premium.png?v=2',
  ...
  },
  {
    ...
    images: [
      '/imgs/store/products/conven-sup-met-xzip-premium.png?v=2',
  ...
  },
  {
    ...
    images: [
      '/imgs/store/products/conven-sup-met-zip-premium.png?v=2',
...
const ECO_STOCK_PRODUCTS: EcoStockProduct[] = [
  ...
  // Honeycomb Paper Wrap
  {
    ...
    images: [
      '/imgs/store/products/eco-friendly-kraft-honeycomb-packing-paper-wrap-thumbnail-1.jpg',
      '/imgs/store/products/eco-friendly-kraft-honeycomb-packing-paper-wrap-thumbnail-2.jpg',
      '/imgs/store/products/eco-friendly-kraft-honeycomb-packing-paper-wrap-thumbnail-3.jpg',
      '/imgs/store/products/eco-friendly-kraft-honeycomb-packing-paper-wrap-thumbnail-4.jpg',
      '/imgs/store/products/eco-friendly-kraft-honeycomb-packing-paper-wrap-thumbnail-5.jpg',
      '/imgs/store/products/eco-friendly-kraft-honeycomb-packing-paper-wrap-thumbnail-6.jpg',
      '/imgs/store/products/eco-friendly-kraft-honeycomb-packing-paper-wrap-thumbnail-7.jpg',
      '/imgs/store/products/eco-friendly-kraft-honeycomb-packing-paper-wrap-thumbnail-8.jpg',
      '/imgs/store/products/eco-friendly-kraft-honeycomb-packing-paper-wrap-thumbnail-9.jpg',
      '/imgs/store/products/eco-friendly-kraft-honeycomb-packing-paper-wrap-thumbnail-10.jpg',
      '/imgs/store/products/eco-friendly-kraft-honeycomb-packing-paper-wrap-thumbnail-11.jpg',
      '/imgs/store/products/eco-friendly-kraft-honeycomb-packing-paper-wrap-thumbnail-12.jpg'
    ],
  ...
  // Retro Horizontal Kraft Food Bag with Handle
  {
    ...
    images: [
      '/imgs/store/products/retro-horizontal-kraft-food-handle-bag-thumbnail-1.webp',
      '/imgs/store/products/retro-horizontal-kraft-food-handle-bag-thumbnail-2.webp',
      '/imgs/store/products/retro-horizontal-kraft-food-handle-bag-thumbnail-3.webp',
      '/imgs/store/products/retro-horizontal-kraft-food-handle-bag-thumbnail-4.webp',
      '/imgs/store/products/retro-horizontal-kraft-food-handle-bag-thumbnail-5.webp',
      '/imgs/store/products/retro-horizontal-kraft-food-handle-bag-thumbnail-6.webp',
      '/imgs/store/products/retro-horizontal-kraft-food-handle-bag-thumbnail-7.webp',
      '/imgs/store/products/retro-horizontal-kraft-food-handle-bag-thumbnail-8.webp',
      '/imgs/store/products/retro-horizontal-kraft-food-handle-bag-thumbnail-9.webp',
      '/imgs/store/products/retro-horizontal-kraft-food-handle-bag-thumbnail-10.webp',
      '/imgs/store/products/retro-horizontal-kraft-food-handle-bag-thumbnail-11.webp',
      '/imgs/store/products/retro-horizontal-kraft-food-handle-bag-thumbnail-12.webp'
    ],
  ...
  // 100% Recyclable PE Wire Cut Zipper Bag
  {
    ...
    images: [
      '/imgs/store/products/100-recyclable-pe-wire-cut-zipper-bag-thumbnail-1.png',
      '/imgs/store/products/100-recyclable-pe-wire-cut-zipper-bag-thumbnail-2.png',
      '/imgs/store/products/100-recyclable-pe-wire-cut-zipper-bag-thumbnail-3.png'
    ],
...
const CONVENTIONAL_STOCK_PRODUCTS: EcoStockProduct[] = [
  ...
  // Flat Bottom Pouch with Card Insert
  {
    ...
    images: [
      '/imgs/store/products/flat-bottom-pouch-with-card-insert-thumbnail-1.webp', // White Kraft Cubical
      '/imgs/store/products/flat-bottom-pouch-with-card-insert-thumbnail-2.webp', // Brown Kraft Cubical
      '/imgs/store/products/flat-bottom-pouch-with-card-insert-thumbnail-3.webp', // White Kraft Long
      '/imgs/store/products/flat-bottom-pouch-with-card-insert-thumbnail-4.webp'  // Brown Kraft Long
    ],
  ...
  // Textured Burlap & Cork Pattern Stand Up Pouch with Valve
  {
    ...
    images: [
      '/imgs/store/products/textured-burlap-cork-pattern-coffee-pouch-with-valve-thumbnail-1.webp',
      '/imgs/store/products/textured-burlap-cork-pattern-coffee-pouch-with-valve-thumbnail-2.webp',
      '/imgs/store/products/textured-burlap-cork-pattern-coffee-pouch-with-valve-thumbnail-3.webp',
      '/imgs/store/products/textured-burlap-cork-pattern-coffee-pouch-with-valve-thumbnail-4.webp',
      '/imgs/store/products/textured-burlap-cork-pattern-coffee-pouch-with-valve-thumbnail-5.jpg',
      '/imgs/store/products/textured-burlap-cork-pattern-coffee-pouch-with-valve-thumbnail-6.jpg',
      '/imgs/store/products/textured-burlap-cork-pattern-coffee-pouch-with-valve-thumbnail-7.jpg',
      '/imgs/store/products/textured-burlap-cork-pattern-coffee-pouch-with-valve-thumbnail-8.jpg',
      '/imgs/store/products/textured-burlap-cork-pattern-coffee-pouch-with-valve-thumbnail-9.jpg'
    ],
  ...
  // Coffee & Tea Flat Bottom Pouch with Hanging Strip and One-Sided Zipper
  {
    ...
    images: [
      '/imgs/store/products/coffee-tea-one-sided-zipper-flat-bottom-pouch-with-hanging-strip-thumbnail-1.jpg',
      '/imgs/store/products/coffee-tea-one-sided-zipper-flat-bottom-pouch-with-hanging-strip-thumbnail-2.webp',
      '/imgs/store/products/coffee-tea-one-sided-zipper-flat-bottom-pouch-with-hanging-strip-thumbnail-3.webp',
      '/imgs/store/products/coffee-tea-one-sided-zipper-flat-bottom-pouch-with-hanging-strip-thumbnail-4.webp',
      '/imgs/store/products/coffee-tea-one-sided-zipper-flat-bottom-pouch-with-hanging-strip-thumbnail-5.webp',
      '/imgs/store/products/coffee-tea-one-sided-zipper-flat-bottom-pouch-with-hanging-strip-thumbnail-6.png',
      '/imgs/store/products/coffee-tea-one-sided-zipper-flat-bottom-pouch-with-hanging-strip-thumbnail-7.jpg',
      '/imgs/store/products/coffee-tea-one-sided-zipper-flat-bottom-pouch-with-hanging-strip-thumbnail-8.jpg',
      '/imgs/store/products/coffee-tea-one-sided-zipper-flat-bottom-pouch-with-hanging-strip-thumbnail-9.jpg',
      '/imgs/store/products/coffee-tea-one-sided-zipper-flat-bottom-pouch-with-hanging-strip-thumbnail-10.jpg',
      '/imgs/store/products/coffee-tea-one-sided-zipper-flat-bottom-pouch-with-hanging-strip-thumbnail-11.jpg'
    ],
  ...
  // Flat Bottom Pouch with Tin Tie
  {
    ...
    images: [
      '/imgs/store/products/flat-bottom-pouch-tin-tie-thumbnail-1.jpg',
      '/imgs/store/products/flat-bottom-pouch-tin-tie-thumbnail-2.webp',
      '/imgs/store/products/flat-bottom-pouch-tin-tie-thumbnail-3.webp',
      '/imgs/store/products/flat-bottom-pouch-tin-tie-thumbnail-4.webp',
      '/imgs/store/products/flat-bottom-pouch-tin-tie-thumbnail-5.webp',
      '/imgs/store/products/flat-bottom-pouch-tin-tie-thumbnail-6.webp',
      '/imgs/store/products/flat-bottom-pouch-tin-tie-thumbnail-7.webp',
      '/imgs/store/products/flat-bottom-pouch-tin-tie-thumbnail-8.webp',
      '/imgs/store/products/flat-bottom-pouch-tin-tie-thumbnail-9.webp',
      '/imgs/store/products/flat-bottom-pouch-tin-tie-thumbnail-10.webp',
      '/imgs/store/products/flat-bottom-pouch-tin-tie-thumbnail-11.webp',
      '/imgs/store/products/flat-bottom-pouch-tin-tie-thumbnail-12.webp',
      '/imgs/store/products/flat-bottom-pouch-tin-tie-thumbnail-13.webp'
    ],
  ...
  // Bottle-Shaped Specialty Foil Sachet Pouch
  {
    ...
    images: [
      ...
      '/imgs/store/products/bottle-shape-sachet-bag-thumbnail-5.jpg',
      '/imgs/store/products/bottle-shape-sachet-bag-thumbnail-6.jpg',
      '/imgs/store/products/bottle-shape-sachet-bag-thumbnail-7.jpg',
  ...
  },
  {
    ...
    images: [
      ...
      '/imgs/store/products/spouted-foil-pouch-thumbnail-4.webp',
      '/imgs/store/products/spouted-foil-pouch-thumbnail-5.webp',
      '/imgs/store/products/spouted-foil-pouch-thumbnail-6.webp',
      '/imgs/store/products/spouted-foil-pouch-thumbnail-7.webp',
      '/imgs/store/products/spouted-foil-pouch-thumbnail-8.webp',
      '/imgs/store/products/spouted-foil-pouch-thumbnail-9.webp',
      '/imgs/store/products/spouted-foil-pouch-thumbnail-10.webp',
      '/imgs/store/products/spouted-foil-pouch-thumbnail-11.webp',
      '/imgs/store/products/spouted-foil-pouch-thumbnail-12.webp',
      '/imgs/store/products/spouted-foil-pouch-thumbnail-13.webp',
      '/imgs/store/products/spouted-foil-pouch-thumbnail-14.webp',
      '/imgs/store/products/spouted-foil-pouch-thumbnail-15.webp',
      '/imgs/store/products/spouted-foil-pouch-thumbnail-16.webp',
      '/imgs/store/products/spouted-foil-pouch-thumbnail-17.webp',
      '/imgs/store/products/spouted-foil-pouch-thumbnail-18.jpg',
      '/imgs/store/products/spouted-foil-pouch-thumbnail-19.webp',
      '/imgs/store/products/spouted-foil-pouch-thumbnail-20.webp',
      '/imgs/store/products/spouted-foil-pouch-thumbnail-21.webp',
      '/imgs/store/products/spouted-foil-pouch-thumbnail-22.webp',
      '/imgs/store/products/spouted-foil-pouch-thumbnail-23.webp',
      '/imgs/store/products/spouted-foil-pouch-thumbnail-24.webp',
      '/imgs/store/products/spouted-foil-pouch-thumbnail-25.webp',
      '/imgs/store/products/spouted-foil-pouch-thumbnail-26.webp',
      '/imgs/store/products/spouted-foil-pouch-thumbnail-27.webp',
      '/imgs/store/products/spouted-foil-pouch-thumbnail-28.webp',
      '/imgs/store/products/spouted-foil-pouch-thumbnail-29.webp',
      '/imgs/store/products/spouted-foil-pouch-thumbnail-30.webp',
      '/imgs/store/products/spouted-foil-pouch-thumbnail-31.webp',
      "/imgs/pouch-shape/ads/a_achieve_pack_spout_pouch_closeup_5874382.webp",
      "/imgs/illustrated/a_achievepack_spout_pouches_1062736.webp",
      "/imgs/function/spout/a_detail_spout_cap_2155787.webp",
      "/imgs/store/closure/spout.webp"
  ...
  },
  {
    ...
    images: [
      '/imgs/store/products/rice-paper-flat-bottom-flat-bottom-thumbnail-1.jpg',
      '/imgs/store/products/rice-paper-flat-bottom-flat-bottom-thumbnail-2.jpg',
      '/imgs/store/products/rice-paper-flat-bottom-flat-bottom-thumbnail-3.jpg',
      '/imgs/store/products/rice-paper-flat-bottom-flat-bottom-thumbnail-4.jpg',
      '/imgs/store/products/rice-paper-flat-bottom-flat-bottom-thumbnail-5.jpg'
    ],
    badge: '⭐ Premium Stock',
    rating: 4.9,
    reviews: 42,
  ...
  },
  {
    ...
    images: [
      '/imgs/store/products/clear-matte-zipper-stand-up-pouch-thumbnail-1.webp',
      '/imgs/store/products/clear-matte-zipper-stand-up-pouch-thumbnail-2.webp',
      '/imgs/store/products/clear-matte-zipper-stand-up-pouch-thumbnail-3.webp',
      '/imgs/store/products/clear-matte-zipper-stand-up-pouch-thumbnail-4.webp',
      '/imgs/store/products/clear-matte-zipper-stand-up-pouch-thumbnail-5.webp',
      '/imgs/store/products/clear-matte-zipper-stand-up-pouch-thumbnail-6.webp',
      '/imgs/store/products/clear-matte-zipper-stand-up-pouch-thumbnail-7.webp',
      '/imgs/store/products/clear-matte-zipper-stand-up-pouch-thumbnail-8.webp',
      '/imgs/store/products/clear-matte-zipper-stand-up-pouch-thumbnail-9.webp',
      '/imgs/store/products/clear-matte-zipper-stand-up-pouch-thumbnail-10.webp',
      '/imgs/store/products/clear-matte-zipper-stand-up-pouch-thumbnail-11.webp',
      '/imgs/store/products/clear-matte-zipper-stand-up-pouch-thumbnail-12.webp',
      '/imgs/store/products/clear-matte-zipper-stand-up-pouch-thumbnail-13.webp',
      '/imgs/store/products/clear-matte-zipper-stand-up-pouch-thumbnail-14.webp',
      '/imgs/store/products/clear-matte-zipper-stand-up-pouch-thumbnail-15.webp',
      '/imgs/store/products/clear-matte-zipper-stand-up-pouch-thumbnail-16.webp',
      '/imgs/store/products/clear-matte-zipper-stand-up-pouch-thumbnail-17.webp',
      '/imgs/store/products/clear-matte-zipper-stand-up-pouch-thumbnail-18.webp',
      '/imgs/store/products/clear-matte-zipper-stand-up-pouch-thumbnail-19.webp',
      '/imgs/store/products/clear-matte-zipper-stand-up-pouch-thumbnail-20.webp'
    ],
    badge: '⚡ New Stock',
    rating: 4.8,
    reviews: 19,
  ...
  },
  {
    ...
    images: [
      '/imgs/store/products/flat-bottom-zipper-pouch-thumbnail-1.webp',
      '/imgs/store/products/flat-bottom-zipper-pouch-thumbnail-2.jpg',
      '/imgs/store/products/flat-bottom-zipper-pouch-thumbnail-3.webp',
      '/imgs/store/products/flat-bottom-zipper-pouch-thumbnail-4.webp',
      '/imgs/store/products/flat-bottom-zipper-pouch-thumbnail-5.webp',
      '/imgs/store/products/flat-bottom-zipper-pouch-thumbnail-6.webp',
      '/imgs/store/products/flat-bottom-zipper-pouch-thumbnail-7.webp',
      '/imgs/store/products/flat-bottom-zipper-pouch-thumbnail-8.webp',
      '/imgs/store/products/flat-bottom-zipper-pouch-thumbnail-9.webp',
      '/imgs/store/products/flat-bottom-zipper-pouch-thumbnail-10.webp',
      '/imgs/store/products/flat-bottom-zipper-pouch-thumbnail-11.webp',
      '/imgs/store/products/flat-bottom-zipper-pouch-thumbnail-12.webp',
      '/imgs/store/products/flat-bottom-zipper-pouch-thumbnail-13.webp',
      '/imgs/store/products/flat-bottom-zipper-pouch-thumbnail-14.webp',
      '/imgs/store/products/flat-bottom-zipper-pouch-thumbnail-15.webp',
      '/imgs/store/products/flat-bottom-zipper-pouch-thumbnail-16.webp',
      '/imgs/store/products/flat-bottom-zipper-pouch-thumbnail-17.webp'
    ],
    badge: '⚡ New Stock',
    rating: 4.9,
    reviews: 14,
  ...
  // Custom Biodegradable Clear PLA Adhesive Sticker & Label (Stock ready-made sizes)
  {
    ...
    images: [
      '/imgs/store/products/eco-custom-label-thumbnail-1.jpg',
      '/imgs/store/products/eco-custom-label-thumbnail-2.webp',
      '/imgs/store/products/eco-custom-label-thumbnail-3.webp',
      '/imgs/store/products/eco-custom-label-thumbnail-4.webp',
      '/imgs/store/products/eco-custom-label-thumbnail-5.jpg',
      '/imgs/store/products/eco-custom-label-thumbnail-6.jpg',
      '/imgs/store/products/eco-custom-label-thumbnail-7.png',
      '/imgs/store/products/eco-custom-label-thumbnail-8.png',
      '/imgs/store/products/eco-custom-label-thumbnail-9.png',
      '/imgs/store/products/eco-custom-label-thumbnail-10.jpg',
      '/imgs/store/products/eco-custom-label-thumbnail-11.jpg'
    ],
  ...
  // Premium PLA Biodegradable Clear Sealing Sticker
  {
    ...
    images: [
      '/imgs/store/products/eco-pla-sealing-sticker-thumbnail-1.png',
      '/imgs/store/products/eco-pla-sealing-sticker-thumbnail-2.jpg',
      '/imgs/store/products/eco-pla-sealing-sticker-thumbnail-3.png',
      '/imgs/store/products/eco-pla-sealing-sticker-thumbnail-4.jpg',
      '/imgs/store/products/eco-pla-sealing-sticker-thumbnail-5.jpg',
      '/imgs/store/products/eco-pla-sealing-sticker-thumbnail-6.jpg',
      '/imgs/store/products/eco-pla-sealing-sticker-thumbnail-7.jpg'
    ],
  ...
  },
  {
    ...
    category: '3d-print',
    description: 'Transform your packaging prototyping and dieline test fits with our Loopha PHA Sustainable 3D Printing Filament. Engineered from Polyhydroxyalkanoate (PHA) and upcycled organic waste, this high-performance material represents the next generation of bioplastics. It is available in 10 raw-material composites including Orange Peel, Coffee Grounds, Tea/Matcha, Grape skins, Peach, Bamboo, Oyster Shell, Charcoal, Rice, and Seaweed. Unlike standard PLA, which requires strict industrial composting and mandatory 4-hour pre-drying, Loopha PHA is natively home-compostable and marine-degradable. Crucially, it features a softening temperature above 60°C (PLA is 50-55°C), high toughness, low cooling shrinkage (allowing prints without a heated bed), and emits a subtle, pleasant organic scent during printing instead of chemical fumes.',
    shortDesc: 'Marine-degradable, 100% bio-based PHA filament made from upcycled organic waste. No pre-drying needed.',
    features: [
      '10 Organic Composites: Choose from Orange, Coffee, Green Tea, Grape, Peach, Bamboo, Oyster Shell, Charcoal, Rice, or Seaweed, each showcasing unique natural textures and colors.',
      '6 Core Advantages: High thermal stability (>60°C), premium toughness, natural soil/marine degradation, safe & non-toxic (zero microplastics), low carbon footprint, and non-toxic organic aroma.',
      'No Pre-Drying Bottleneck: Stable polymer structure allows printing straight out of the box without the 4-hour pre-drying required for PLA and PETG.',
      'Zero Heated Bed Required: Low cooling shrinkage prevents warping, ensuring exceptional printability on standard FDM setups.',
      'B2B Wholesale Tiers: Spooled in 1 kg rollstock format, optimized for eco-packaging prototyping and bio-plastics research.'
    ],
    images: [
