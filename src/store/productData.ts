...
const CONVENTIONAL_STOCK_PRODUCTS: EcoStockProduct[] = [
  ...
  },
  {
    ...
    minQuantity: 100,
    quantityStep: 100,
    sizeInfo: 'Multiple sizes available (125g - 1kg coffee beans)',
    sizeVariants: [
      ...
      { id: 'white-250g', label: 'White Paper - 250g (130×200+70mm)', dimensions: '130 × 200 + 70 mm', hasHole: false, quantity: 100, totalPrice: 28.56, unitPrice: 0.286, heroImageIndex: 1 },
      { id: 'white-500g', label: 'White Paper - 500g (135×265+75mm)', dimensions: '135 × 265 + 75 mm', hasHole: false, quantity: 100, totalPrice: 36.96, unitPrice: 0.370, heroImageIndex: 3 },
      { id: 'white-1000g', label: 'White Paper - 1kg (145×330+100mm)', dimensions: '145 × 330 + 100 mm', hasHole: false, quantity: 100, totalPrice: 49.56, unitPrice: 0.496, heroImageIndex: 3 },
    ],
    customPrintNote: 'Custom prints available from 100+ pieces. Please consult our team.',
  },
  {
