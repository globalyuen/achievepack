...
const SAMPLE_PRODUCTS: SampleProduct[] = [
  {
    ...
    category: 'sample',
    description: 'Sample pack with standard sizes in conventional plastic material. Perfect for testing different sizes for your products.',
    shortDesc: '$40 samples + $40 shipping',
    features: ['Multiple Standard Sizes', 'Conventional Plastic', 'Quality Samples', 'Fast Shipping'],
