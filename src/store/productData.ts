...
const CONVENTIONAL_PRODUCTS: ConventionalProduct[] = [
  ...
  },
  {
    ...
    images: ['https://pouch.eco/wp-content/uploads/2025/12/3side_zipper_clear_-1.webp'],
    badge: '🔒 Resealable',
    rating: 4.8,
    reviews: 187,
    inStock: true,
...
// Eco Digital Products (21 = 7 shapes × 3 materials)
const ECO_DIGITAL_PRODUCTS: EcoDigitalProduct[] = [
  // 3 Side Seal Pouch × 3 materials
  {
    id: 'eco-3side-pcr',
    name: 'Eco Digital – 3 Side Seal Pouch / PCR or Bio Plastic',
    category: 'eco-digital',
    description: 'Eco-friendly 3-side seal pouch with 30% PCR or 50% Bio content. Sustainable packaging solution.',
    shortDesc: 'From US$110 for 1,000 pcs',
    features: ['PCR/Bio Material', '30% Lower Carbon', 'Digital Print', 'Eco-Friendly'],
    images: ['https://pouch.eco/wp-content/uploads/2025/12/3side_no_zipper_matt_silver-1.webp'],
    badge: '🌿 Eco',
    rating: 4.7,
    reviews: 89,
  ...
  {
    id: 'eco-3side-mono',
    name: 'Eco Digital – 3 Side Seal Pouch / Mono Recyclable Plastic',
    category: 'eco-digital',
    description: '100% recyclable mono-material 3-side seal. Single-layer construction for easy recycling.',
    shortDesc: 'From US$100 for 1,000 pcs',
    features: ['Mono Recyclable', '95% Recyclable', 'Digital Print', 'Sustainable'],
    images: ['https://pouch.eco/wp-content/uploads/2025/12/3side_no_zipper_matt_silver-1.webp'],
    badge: '♻️ Recyclable',
    rating: 4.8,
    reviews: 67,
    ...
    minOrder: 1000,
    shape: '3 Side Seal Pouch',
    material: 'Mono Recyclable Plastic',
    basePrice: 100,
    ecoConfig: {
      defaultSize: 'M',
      defaultQuantity: '1,000 (Digital print)',
  ...
  {
    id: 'eco-3side-bio',
    name: 'Eco Digital – 3 Side Seal Pouch / Biodegradable and Compostable',
    category: 'eco-digital',
    description: '100% compostable 3-side seal. Breaks down naturally in composting environment.',
    shortDesc: 'From US$150 for 1,000 pcs',
    features: ['Biodegradable', '100% Compostable', 'Digital Print', 'Eco-Friendly'],
    images: ['https://pouch.eco/wp-content/uploads/2025/12/a_kraft_bag_with_dimensions_3083325.webp'],
    badge: '🍃 Compostable',
    rating: 4.6,
    reviews: 54,
    ...
    minOrder: 1000,
    shape: '3 Side Seal Pouch',
    material: 'Biodegradable and Compostable',
    basePrice: 150,
    ecoConfig: {
      defaultSize: 'M',
      defaultQuantity: '1,000 (Digital print)',
  ...
  // Center Seal Pouch × 3 materials
  {
    id: 'eco-centerseal-pcr',
    name: 'Eco Digital – Center Seal Pouch / PCR or Bio Plastic',
    category: 'eco-digital',
    description: 'Eco-friendly center seal with PCR/Bio content. Simple and cost-effective design.',
    shortDesc: 'From US$110 for 1,000 pcs',
    features: ['PCR/Bio Material', 'Center Seal', 'Digital Print', 'Eco-Friendly'],
    images: ['https://pouch.eco/wp-content/uploads/2025/12/3side_no_zipper_matt_silver-1.webp'],
    badge: '🌿 Eco',
    rating: 4.5,
    reviews: 43,
  ...
  {
    id: 'eco-centerseal-mono',
    name: 'Eco Digital – Center Seal Pouch / Mono Recyclable Plastic',
    category: 'eco-digital',
    description: 'Recyclable center seal pouch. Perfect for simple packaging needs.',
    shortDesc: 'From US$100 for 1,000 pcs',
    features: ['Mono Recyclable', 'Center Seal', 'Digital Print', 'Sustainable'],
    images: ['https://pouch.eco/wp-content/uploads/2025/12/3side_no_zipper_matt_silver-1.webp'],
    badge: '♻️ Recyclable',
    rating: 4.6,
    reviews: 38,
  ...
  {
    id: 'eco-centerseal-bio',
    name: 'Eco Digital – Center Seal Pouch / Biodegradable and Compostable',
    category: 'eco-digital',
    description: 'Compostable center seal. Earth-friendly packaging solution.',
    shortDesc: 'From US$150 for 1,000 pcs',
    features: ['Biodegradable', 'Center Seal', 'Digital Print', 'Eco-Friendly'],
    images: ['https://pouch.eco/wp-content/uploads/2025/12/a_kraft_bag_with_dimensions_3083325.webp'],
    badge: '🍃 Compostable',
    rating: 4.5,
    reviews: 29,
  ...
  // Stand Up Pouch × 3 materials
  {
    id: 'eco-standup-pcr',
    name: 'Eco Digital – Stand Up Pouch / PCR or Bio Plastic',
    category: 'eco-digital',
    description: 'Premium eco stand-up pouch with PCR/Bio content. Excellent shelf presence.',
    shortDesc: 'From US$130 for 1,000 pcs',
    features: ['PCR/Bio Material', 'Stand Up', 'Digital Print', 'Eco-Friendly'],
    images: ['https://pouch.eco/wp-content/uploads/2025/12/standup_no_zipper_matt_silver-2.webp'],
    badge: '🌿 Eco',
    rating: 4.9,
    reviews: 178,
  ...
  {
    id: 'eco-standup-mono',
    name: 'Eco Digital – Stand Up Pouch / Mono Recyclable Plastic',
    category: 'eco-digital',
    description: 'Recyclable stand-up pouch. Perfect shelf appeal with sustainability.',
    shortDesc: 'From US$120 for 1,000 pcs',
    features: ['Mono Recyclable', 'Stand Up', 'Digital Print', 'Sustainable'],
    images: ['https://pouch.eco/wp-content/uploads/2025/12/standup_no_zipper_matt_silver-2.webp'],
    badge: '♻️ Recyclable',
    rating: 4.8,
    reviews: 156,
  ...
  {
    id: 'eco-standup-bio',
    name: 'Eco Digital – Stand Up Pouch / Biodegradable and Compostable',
    category: 'eco-digital',
    description: 'Compostable stand-up pouch. Premium eco-friendly packaging.',
    shortDesc: 'From US$170 for 1,000 pcs',
    features: ['Biodegradable', 'Stand Up', 'Digital Print', 'Eco-Friendly'],
    images: ['https://pouch.eco/wp-content/uploads/2025/12/a_kraft_bag_with_dimensions_3083325.webp'],
    badge: '🍃 Compostable',
    rating: 4.7,
    reviews: 92,
  ...
  // Box Bottom × 3 materials
  {
    id: 'eco-boxbottom-pcr',
    name: 'Eco Digital – Box Bottom Pouch / PCR or Bio Plastic',
    category: 'eco-digital',
    description: 'Eco box bottom pouch with PCR/Bio content. Maximum stability and capacity.',
    shortDesc: 'From US$180 for 1,000 pcs',
    features: ['PCR/Bio Material', 'Box Bottom', 'High Capacity', 'Eco-Friendly'],
    images: ['https://pouch.eco/wp-content/uploads/2025/12/a_kraft_bag_with_dimensions_3083325.webp'],
    badge: '🌿 Eco',
    rating: 4.6,
    reviews: 34,
  ...
  {
    id: 'eco-boxbottom-mono',
    name: 'Eco Digital – Box Bottom Pouch / Mono Recyclable Plastic',
    category: 'eco-digital',
    description: 'Recyclable box bottom pouch. Premium packaging with sustainability.',
    shortDesc: 'From US$170 for 1,000 pcs',
    features: ['Mono Recyclable', 'Box Bottom', 'High Capacity', 'Sustainable'],
    images: ['https://pouch.eco/wp-content/uploads/2025/12/a_kraft_bag_with_dimensions_3083325.webp'],
    badge: '♻️ Recyclable',
    rating: 4.7,
    reviews: 28,
  ...
  {
    id: 'eco-boxbottom-bio',
    name: 'Eco Digital – Box Bottom Pouch / Biodegradable and Compostable',
    category: 'eco-digital',
    description: 'Compostable box bottom pouch. Ultimate eco-friendly premium packaging.',
    shortDesc: 'From US$220 for 1,000 pcs',
    features: ['Biodegradable', 'Box Bottom', 'High Capacity', 'Eco-Friendly'],
    images: ['https://pouch.eco/wp-content/uploads/2025/12/a_kraft_bag_with_dimensions_3083325.webp'],
    badge: '🍃 Compostable',
    rating: 4.5,
    reviews: 19,
  ...
  // Flat Squared Bottom × 3 materials
  {
    id: 'eco-flatbottom-pcr',
    name: 'Eco Digital – Flat Squared Bottom Pouch / PCR or Bio Plastic',
    category: 'eco-digital',
    description: 'Eco flat bottom pouch with PCR/Bio. Premium flat bottom design.',
    shortDesc: 'From US$200 for 1,000 pcs',
    features: ['PCR/Bio Material', 'Flat Bottom', 'Premium Design', 'Eco-Friendly'],
    images: ['https://pouch.eco/wp-content/uploads/2025/12/a_kraft_bag_with_dimensions_3083325.webp'],
    badge: '🌿 Eco',
    rating: 4.7,
    reviews: 45,
  ...
  {
    id: 'eco-flatbottom-mono',
    name: 'Eco Digital – Flat Squared Bottom Pouch / Mono Recyclable Plastic',
    category: 'eco-digital',
    description: 'Recyclable flat bottom. Elegant and sustainable packaging.',
    shortDesc: 'From US$190 for 1,000 pcs',
    features: ['Mono Recyclable', 'Flat Bottom', 'Premium Design', 'Sustainable'],
    images: ['https://pouch.eco/wp-content/uploads/2025/12/a_kraft_bag_with_dimensions_3083325.webp'],
    badge: '♻️ Recyclable',
    rating: 4.8,
    reviews: 51,
  ...
  {
    id: 'eco-flatbottom-bio',
    name: 'Eco Digital – Flat Squared Bottom Pouch / Biodegradable and Compostable',
    category: 'eco-digital',
    description: 'Compostable flat bottom pouch. Premium eco packaging.',
    shortDesc: 'From US$240 for 1,000 pcs',
    features: ['Biodegradable', 'Flat Bottom', 'Premium Design', 'Eco-Friendly'],
    images: ['https://pouch.eco/wp-content/uploads/2025/12/a_kraft_bag_with_dimensions_3083325.webp'],
    badge: '🍃 Compostable',
    rating: 4.6,
    reviews: 23,
  ...
  // Quad Seal × 3 materials
  {
    id: 'eco-quadseal-pcr',
    name: 'Eco Digital – Quad Seal Pouch / PCR or Bio Plastic',
    category: 'eco-digital',
    description: 'Eco quad seal pouch with PCR/Bio. Four-corner seal for maximum stability.',
    shortDesc: 'From US$170 for 1,000 pcs',
    features: ['PCR/Bio Material', 'Quad Seal', 'High Stability', 'Eco-Friendly'],
    images: ['https://pouch.eco/wp-content/uploads/2025/12/standup_no_zipper_matt_silver-2.webp'],
    badge: '🌿 Eco',
    rating: 4.6,
    reviews: 37,
  ...
  {
    id: 'eco-quadseal-mono',
    name: 'Eco Digital – Quad Seal Pouch / Mono Recyclable Plastic',
    category: 'eco-digital',
    description: 'Recyclable quad seal. Strong and sustainable packaging.',
    shortDesc: 'From US$160 for 1,000 pcs',
    features: ['Mono Recyclable', 'Quad Seal', 'High Stability', 'Sustainable'],
    images: ['https://pouch.eco/wp-content/uploads/2025/12/standup_no_zipper_matt_silver-2.webp'],
    badge: '♻️ Recyclable',
    rating: 4.7,
    reviews: 42,
  ...
  {
    id: 'eco-quadseal-bio',
    name: 'Eco Digital – Quad Seal Pouch / Biodegradable and Compostable',
    category: 'eco-digital',
    description: 'Compostable quad seal. Eco-friendly strong packaging.',
    shortDesc: 'From US$210 for 1,000 pcs',
    features: ['Biodegradable', 'Quad Seal', 'High Stability', 'Eco-Friendly'],
    images: ['https://pouch.eco/wp-content/uploads/2025/12/a_kraft_bag_with_dimensions_3083325.webp'],
    badge: '🍃 Compostable',
    rating: 4.5,
    reviews: 18,
  ...
  // Side Gusset × 3 materials
  {
    id: 'eco-sidegusset-pcr',
    name: 'Eco Digital – Side Gusset Pouch / PCR or Bio Plastic',
    category: 'eco-digital',
    description: 'Eco side gusset pouch with PCR/Bio. Classic coffee bag style.',
    shortDesc: 'From US$150 for 1,000 pcs',
    features: ['PCR/Bio Material', 'Side Gusset', 'Coffee Bag Style', 'Eco-Friendly'],
    images: ['https://pouch.eco/wp-content/uploads/2025/12/3side_no_zipper_matt_silver-1.webp'],
    badge: '🌿 Eco',
    rating: 4.8,
    reviews: 76,
  ...
  {
    id: 'eco-sidegusset-mono',
    name: 'Eco Digital – Side Gusset Pouch / Mono Recyclable Plastic',
    category: 'eco-digital',
    description: 'Recyclable side gusset. Perfect for coffee and tea.',
    shortDesc: 'From US$140 for 1,000 pcs',
    features: ['Mono Recyclable', 'Side Gusset', 'Coffee Bag Style', 'Sustainable'],
    images: ['https://pouch.eco/wp-content/uploads/2025/12/3side_no_zipper_matt_silver-1.webp'],
    badge: '♻️ Recyclable',
    rating: 4.9,
    reviews: 102,
  ...
  {
    id: 'eco-sidegusset-bio',
    name: 'Eco Digital – Side Gusset Pouch / Biodegradable and Compostable',
    category: 'eco-digital',
    description: 'Compostable side gusset. Eco-friendly coffee packaging.',
    shortDesc: 'From US$190 for 1,000 pcs',
    features: ['Biodegradable', 'Side Gusset', 'Coffee Bag Style', 'Eco-Friendly'],
    images: ['https://pouch.eco/wp-content/uploads/2025/12/a_kraft_bag_with_dimensions_3083325.webp'],
    badge: '🍃 Compostable',
    rating: 4.7,
    reviews: 58,
...
// Combined products array (30 total: 5 + 4 + 21)
