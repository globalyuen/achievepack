        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4">
            ...
            <div className="lg:col-span-1 flex flex-col items-center justify-start">
              <h4 className="text-sm font-semibold mb-2">{t('footer.certified')}</h4>
              <img src="/imgs/cert-b.webp" alt="B Corp Certified" className="h-20 w-auto" />
              {/* Stripe Climate Badge */}
              <a 
                href="https://climate.stripe.com/WPsfbU" 
                target="_blank" 
                rel="noopener noreferrer"
                className="mt-3 flex items-center gap-1.5 bg-neutral-800 hover:bg-neutral-700 px-3 py-2 rounded-lg transition-colors"
              >
            ...
            <div>
              ...
              <ul className="space-y-1.5 text-neutral-300 text-xs">
                <li><Link to="/packaging/stand-up-pouches" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="hover:text-primary-500 transition-colors">Stand Up Pouches</Link></li>
                <li><Link to="/packaging/flat-bottom-bags" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="hover:text-primary-500 transition-colors">Flat Bottom Bags</Link></li>
                <li><Link to="/packaging/spout-pouches" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="hover:text-primary-500 transition-colors">Spout Pouches</Link></li>
                <li><Link to="/packaging/vacuum-pouches" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="hover:text-primary-500 transition-colors">Vacuum Pouches</Link></li>
                <li><Link to="/packaging/flat-pouches" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="hover:text-primary-500 transition-colors">Flat Pouches</Link></li>
                <li><Link to="/packaging/side-gusset-bags" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="hover:text-primary-500 transition-colors">Side Gusset Bags</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-1.5 text-neutral-300 text-xs">
                <li><Link to="/materials/compostable" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="hover:text-primary-500 transition-colors">Compostable</Link></li>
                <li><Link to="/materials/home-compostable" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="hover:text-primary-500 transition-colors">Home Compostable</Link></li>
                <li><Link to="/materials/industrial-compostable" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="hover:text-primary-500 transition-colors">Industrial Compostable</Link></li>
                <li><Link to="/materials/recyclable-mono-pe" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="hover:text-primary-500 transition-colors">Recyclable Mono PE</Link></li>
                <li><Link to="/materials/recyclable-mono-pp" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="hover:text-primary-500 transition-colors">Recyclable Mono PP</Link></li>
                <li><Link to="/materials/bio-pe" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="hover:text-primary-500 transition-colors">Bio PE</Link></li>
                <li><Link to="/materials/pcr" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="hover:text-primary-500 transition-colors">PCR Recycled</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-1.5 text-neutral-300 text-xs">
                <li><Link to="/printing/digital-printing" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="hover:text-primary-500 transition-colors">Digital Printing</Link></li>
                <li><Link to="/printing/plate-printing" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="hover:text-primary-500 transition-colors">Plate Printing</Link></li>
                <li><Link to="/features/reclosure-options" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="hover:text-primary-500 transition-colors">Reclosure Options</Link></li>
                <li><Link to="/features/surface-finish" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="hover:text-primary-500 transition-colors">Surface Finishes</Link></li>
                <li><Link to="/features/barrier-options" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="hover:text-primary-500 transition-colors">Barrier Options</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-1.5 text-neutral-300 text-xs">
                <li><Link to="/industry/coffee-tea" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="hover:text-primary-500 transition-colors">Coffee & Tea</Link></li>
                <li><Link to="/industry/snacks-food" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="hover:text-primary-500 transition-colors">Snacks & Food</Link></li>
                <li><Link to="/industry/pet-food" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="hover:text-primary-500 transition-colors">Pet Food</Link></li>
                <li><Link to="/industry/supplements-powders" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="hover:text-primary-500 transition-colors">Supplements</Link></li>
                <li><Link to="/industry/baby-food" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="hover:text-primary-500 transition-colors">Baby Food</Link></li>
                <li><Link to="/industry/frozen-food" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="hover:text-primary-500 transition-colors">Frozen Food</Link></li>
                <li><Link to="/industry/sauces-condiments" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="hover:text-primary-500 transition-colors">Sauces & Condiments</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-1.5 text-neutral-300 text-xs">
                <li><Link to="/support/faqs" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="hover:text-primary-500 transition-colors">FAQs</Link></li>
                <li><Link to="/support/lead-time" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="hover:text-primary-500 transition-colors">Lead Time</Link></li>
                <li><Link to="/company/about" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="hover:text-primary-500 transition-colors">About Us</Link></li>
                <li><Link to="/company/certificates" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="hover:text-primary-500 transition-colors">Certificates</Link></li>
            ...
            {/* Company */}
            <div>
              <h4 className="text-sm font-semibold mb-2">{t('footer.company')}</h4>
              <ul className="space-y-1.5 text-neutral-300 text-xs">
                <li><Link to="/company/factory-tour" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="hover:text-primary-500 transition-colors">Factory Tour</Link></li>
                <li><Link to="/knowledge/workflow" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="hover:text-primary-500 transition-colors">Workflow</Link></li>
                <li className="flex items-center gap-2 mt-3">
                  <Mail className="h-4 w-4 text-primary-500" />
                  <a href="mailto:ryan@achievepack.com" className="hover:text-primary-500 transition-colors">ryan@achievepack.com</a>
                </li>
                <li className="flex items-center gap-2">
                  <Phone className="h-4 w-4 text-primary-500" />
                  <a href="tel:+85269704411" className="hover:text-primary-500 transition-colors">+852 6970 4411</a>
                </li>
              </ul>
            </div>
          </div>

          <div className="border-t border-neutral-800 mt-4 pt-4 flex flex-col md:flex-row justify-between items-center gap-2">
