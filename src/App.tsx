          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            ...
            <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
              <div className="flex items-center space-x-2 mb-4">
                <Leaf className="h-9 w-9 text-primary-500" />
                <span className="text-xl font-bold text-gray-900">{t('footer.brand')}</span>
              </div>
              ...
              <ul className="flex items-center space-x-3 mt-9">
                <li>
                  <a href="https://www.instagram.com/pouch_eco/" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center text-white transition-all duration-200 bg-gray-800 rounded-full w-7 h-7 hover:bg-primary-500 focus:bg-primary-500">
                ...
                <li>
                  <a href="https://api.whatsapp.com/send/?phone=85269704411&text&app_absent=0" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center text-white transition-all duration-200 bg-gray-800 rounded-full w-7 h-7 hover:bg-green-500 focus:bg-green-500">
                ...
                <li>
                  <a href="https://www.linkedin.com/company/achieve-pack/?viewAsMember=true" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center text-white transition-all duration-200 bg-gray-800 rounded-full w-7 h-7 hover:bg-blue-600 focus:bg-blue-600">
                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
                  </a>
                </li>
                <li>
                  <a href="https://www.youtube.com/watch?v=3LZh1vHGAS0" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center text-white transition-all duration-200 bg-gray-800 rounded-full w-7 h-7 hover:bg-red-500 focus:bg-red-500">
            ...
            {/* Products */}
            <div>
              <p className="text-sm font-semibold tracking-widest text-gray-400 uppercase">{t('footer.products.title')}</p>
              <ul className="mt-6 space-y-4">
                <li><a href="#products" className="flex text-base text-black transition-all duration-200 hover:text-primary-500 focus:text-primary-500">{t('footer.products.compostable')}</a></li>
                <li><a href="#products" className="flex text-base text-black transition-all duration-200 hover:text-primary-500 focus:text-primary-500">{t('footer.products.recyclable')}</a></li>
                <li><a href="#products" className="flex text-base text-black transition-all duration-200 hover:text-primary-500 focus:text-primary-500">{t('footer.products.biobased')}</a></li>
                <li><a href="#products" className="flex text-base text-black transition-all duration-200 hover:text-primary-500 focus:text-primary-500">{t('footer.products.custom')}</a></li>
              </ul>
            </div>

            {/* Company */}
            <div>
              <p className="text-sm font-semibold tracking-widest text-gray-400 uppercase">{t('footer.company.title')}</p>
              <ul className="mt-6 space-y-4">
                <li><a href="#about" className="flex text-base text-black transition-all duration-200 hover:text-primary-500 focus:text-primary-500">{t('footer.company.about')}</a></li>
                <li><a href="#benefits" className="flex text-base text-black transition-all duration-200 hover:text-primary-500 focus:text-primary-500">{t('footer.company.sustainability')}</a></li>
                <li><a href="#about" className="flex text-base text-black transition-all duration-200 hover:text-primary-500 focus:text-primary-500">{t('footer.company.certifications')}</a></li>
                <li><a href="#contact" className="flex text-base text-black transition-all duration-200 hover:text-primary-500 focus:text-primary-500">{t('footer.company.careers')}</a></li>
              </ul>
            </div>

            {/* Support */}
            <div>
              <p className="text-sm font-semibold tracking-widest text-gray-400 uppercase">{t('footer.contact.title')}</p>
              <ul className="mt-6 space-y-4">
                <li><a href="#contact" className="flex text-base text-black transition-all duration-200 hover:text-primary-500 focus:text-primary-500">{t('footer.contact.getInTouch')}</a></li>
                <li><a href="#contact" className="flex text-base text-black transition-all duration-200 hover:text-primary-500 focus:text-primary-500">{t('footer.contact.support')}</a></li>
                <li><Link to="/terms" className="flex text-base text-black transition-all duration-200 hover:text-primary-500 focus:text-primary-500">{t('footer.contact.documentation')}</Link></li>
                <li><Link to="/terms" className="flex text-base text-black transition-all duration-200 hover:text-primary-500 focus:text-primary-500">{t('footer.contact.legal')}</Link></li>
              </ul>
            </div>
            ...
            <div className="col-span-2 md:col-span-1 lg:col-span-2 lg:pl-8">
              ...
              <form className="mt-6">
                <div>
                  ...
                  <input 
                    ...
                    className="block w-full p-4 text-black placeholder-gray-500 transition-all duration-200 bg-white border border-gray-200 rounded-md focus:outline-none focus:border-primary-500 caret-primary-500" 
                  />
                </div>
                <button 
                  type="submit" 
                  className="inline-flex items-center justify-center px-6 py-4 mt-3 font-semibold text-white transition-all duration-200 bg-primary-500 rounded-md hover:bg-primary-600 focus:bg-primary-600"
                >
                  Subscribe
                </button>
              </form>
              ...
              <div className="mt-8 flex items-center gap-4">
                <img src="/imgs/cert-b.webp" alt="B Corp Certified" className="h-16 w-auto" />
                <span className="text-sm text-gray-500">Certified Sustainable</span>
              </div>
            </div>
          </div>
