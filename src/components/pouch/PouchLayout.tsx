          ...
          <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-7 gap-8 mb-16 border-t-4 border-black pt-12">
            ...
            <div>
              ...
              <ul className="space-y-2 font-['JetBrains_Mono'] text-sm font-bold">
                ...
                <li><Link to="/industry/premium-matte-pouches" className="hover:underline">Premium Matte Finish Pouc <span className="bg-black text-[#D4FF00] text-[9px] px-1 py-0.5 ml-1 border border-black font-black uppercase">New</span></Link></li>
                <li><Link to="/industry/wholesale-unprinted-pouches" className="hover:underline">Wholesale Unprinted & Sto <span className="bg-black text-[#D4FF00] text-[9px] px-1 py-0.5 ml-1 border border-black font-black uppercase">New</span></Link></li>
                <li><Link to="/industry/high-barrier-food-pouches" className="hover:underline">High-Barrier Food Grade P <span className="bg-black text-[#D4FF00] text-[9px] px-1 py-0.5 ml-1 border border-black font-black uppercase">New</span></Link></li>
                <li><Link to="/industry/australia-shipping-coo" className="hover:underline">How to Import Custom Pack <span className="bg-black text-[#D4FF00] text-[9px] px-1 py-0.5 ml-1 border border-black font-black uppercase">New</span></Link></li>
                <li><Link to="/industry/premium-finishes" className="hover:underline">How to design premium Spo <span className="bg-black text-[#D4FF00] text-[9px] px-1 py-0.5 ml-1 border border-black font-black uppercase">New</span></Link></li>
                <li><Link to="/industry/high-barrier-retort" className="hover:underline">Can High-Barrier Retort P <span className="bg-black text-[#D4FF00] text-[9px] px-1 py-0.5 ml-1 border border-black font-black uppercase">New</span></Link></li>
                <li><Link to="/industry/custom-spout-pouches" className="hover:underline">Why Switch to Spout Pouch <span className="bg-black text-[#D4FF00] text-[9px] px-1 py-0.5 ml-1 border border-black font-black uppercase">New</span></Link></li>
                <li><Link to="/industry/pet-food-quad-seal" className="hover:underline">What is the Best Heavy-Du <span className="bg-black text-[#D4FF00] text-[9px] px-1 py-0.5 ml-1 border border-black font-black uppercase">New</span></Link></li>
                <li><Link to="/industry/kraft-window-pouch" className="hover:underline">Kraft Paper Stand Up Pouc <span className="bg-black text-[#D4FF00] text-[9px] px-1 py-0.5 ml-1 border border-black font-black uppercase">New</span></Link></li>
                <li><Link to="/industry/matcha-supplement-sachets" className="hover:underline">How to Design Custom Sach <span className="bg-black text-[#D4FF00] text-[9px] px-1 py-0.5 ml-1 border border-black font-black uppercase">New</span></Link></li>
                <li><Link to="/industry/low-moq-fast-turnaround" className="hover:underline">How to Order Custom Packa <span className="bg-black text-[#D4FF00] text-[9px] px-1 py-0.5 ml-1 border border-black font-black uppercase">New</span></Link></li>
                <li><Link to="/industry/premium-soft-touch" className="hover:underline">Premium Soft Touch Pouche <span className="bg-black text-[#D4FF00] text-[9px] px-1 py-0.5 ml-1 border border-black font-black uppercase">New</span></Link></li>
                <li><Link to="/industry/custom-die-cut-pouches" className="hover:underline">How to Create Custom Die- <span className="bg-black text-[#D4FF00] text-[9px] px-1 py-0.5 ml-1 border border-black font-black uppercase">New</span></Link></li>
                <li><Link to="/industry/resealable-tin-tie-bags" className="hover:underline">Resealable Tin Tie Paper  <span className="bg-black text-[#D4FF00] text-[9px] px-1 py-0.5 ml-1 border border-black font-black uppercase">New</span></Link></li>
                <li><Link to="/industry/sustainable-kraft-solutions" className="hover:underline">What is the Difference Be <span className="bg-black text-[#D4FF00] text-[9px] px-1 py-0.5 ml-1 border border-black font-black uppercase">New</span></Link></li>
                <li><Link to="/industry/durable-reusable-pouches" className="hover:underline">Eco-Friendly Ziplock Pouc <span className="bg-black text-[#D4FF00] text-[9px] px-1 py-0.5 ml-1 border border-black font-black uppercase">New</span></Link></li>
                <li><Link to="/industry/pla-compostable-packaging" className="hover:underline">How does 100% PLA Compost <span className="bg-black text-[#D4FF00] text-[9px] px-1 py-0.5 ml-1 border border-black font-black uppercase">New</span></Link></li>
                ...
                <li><Link to="/industry/eco-friendly-tea-coffee" className="hover:underline">How to Select Eco-Friendl <span className="bg-black text-[#D4FF00] text-[9px] px-1 py-0.5 ml-1 border border-black font-black uppercase">New</span></Link></li>
                <li><Link to="/industry/compostable-laminated-film" className="hover:underline">How does Compostable Lami <span className="bg-black text-[#D4FF00] text-[9px] px-1 py-0.5 ml-1 border border-black font-black uppercase">New</span></Link></li>
                <li><Link to="/industry/child-resistant-cbd" className="hover:underline">Child Resistant (CR) Pouc <span className="bg-black text-[#D4FF00] text-[9px] px-1 py-0.5 ml-1 border border-black font-black uppercase">New</span></Link></li>
                <li><Link to="/industry/compostable-protein-bags" className="hover:underline">Compostable Flat Bottom P <span className="bg-black text-[#D4FF00] text-[9px] px-1 py-0.5 ml-1 border border-black font-black uppercase">New</span></Link></li>
                <li><Link to="/industry/clear-transparent-pouches" className="hover:underline">there Clear Transparent C <span className="bg-black text-[#D4FF00] text-[9px] px-1 py-0.5 ml-1 border border-black font-black uppercase">New</span></Link></li>
                <li><Link to="/industry/recyclable-vacuum-bags" className="hover:underline">Can You Recycle Vacuum Ba <span className="bg-black text-[#D4FF00] text-[9px] px-1 py-0.5 ml-1 border border-black font-black uppercase">New</span></Link></li>
                <li><Link to="/industry/eco-coffee-bags-valve" className="hover:underline">there Fully Compostable C <span className="bg-black text-[#D4FF00] text-[9px] px-1 py-0.5 ml-1 border border-black font-black uppercase">New</span></Link></li>
                <li><Link to="/industry/pcr-packaging-pouches" className="hover:underline">What is PCR (Post-Consume <span className="bg-black text-[#D4FF00] text-[9px] px-1 py-0.5 ml-1 border border-black font-black uppercase">New</span></Link></li>
                <li><Link to="/industry/euro-hole-hang-bags" className="hover:underline">Eco-Friendly Pouches with <span className="bg-black text-[#D4FF00] text-[9px] px-1 py-0.5 ml-1 border border-black font-black uppercase">New</span></Link></li>
                <li><Link to="/industry/sustainable-tea-sachets" className="hover:underline">Sustainable Sachet Packag <span className="bg-black text-[#D4FF00] text-[9px] px-1 py-0.5 ml-1 border border-black font-black uppercase">New</span></Link></li>
                <li><Link to="/industry/meat-jerky-packaging" className="hover:underline">How to Select Eco-Friendl <span className="bg-black text-[#D4FF00] text-[9px] px-1 py-0.5 ml-1 border border-black font-black uppercase">New</span></Link></li>
                <li><Link to="/industry/brown-white-kraft" className="hover:underline">What is the Difference Be <span className="bg-black text-[#D4FF00] text-[9px] px-1 py-0.5 ml-1 border border-black font-black uppercase">New</span></Link></li>
