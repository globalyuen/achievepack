    ...
    <div className="hidden lg:flex items-center w-full justify-between">
      ...
      <nav className="flex items-center">
        ...
        <div className="relative" onMouseEnter={() => handleMouseEnter('shape')} onMouseLeave={handleMouseLeave}>
          ...
          {activeMenu === 'shape' && (
            <div className="fixed left-1/2 -translate-x-1/2 top-[86px] pt-2 z-50" onMouseEnter={() => handleMouseEnter('shape')} onMouseLeave={handleMouseLeave}>
              <div className="w-[95vw] max-w-[1200px] bg-white shadow-2xl rounded-xl border border-neutral-200 overflow-hidden">
                <div className="grid grid-cols-12">
        ...
        <div className="relative" onMouseEnter={() => handleMouseEnter('custom')} onMouseLeave={handleMouseLeave}>
          ...
          {activeMenu === 'custom' && (
            <div className="fixed left-1/2 -translate-x-1/2 top-[86px] pt-2 z-50" onMouseEnter={() => handleMouseEnter('custom')} onMouseLeave={handleMouseLeave}>
        ...
        <div className="relative" onMouseEnter={() => handleMouseEnter('stock')} onMouseLeave={handleMouseLeave}>
          ...
          {activeMenu === 'stock' && (
            <div className="fixed left-1/2 -translate-x-1/2 top-[86px] pt-2 z-50" onMouseEnter={() => handleMouseEnter('stock')} onMouseLeave={handleMouseLeave}>
              <div className="w-[95vw] max-w-[1100px] bg-white shadow-2xl rounded-xl border border-neutral-200 overflow-hidden">
                <div className="grid grid-cols-12">
                  {/* Left: Order Types */}
                  <div className="col-span-3 bg-neutral-50 p-4 border-r border-neutral-100">
  ...
  return (
    <nav className="flex items-center">
        ...
        <div className="relative" onMouseEnter={() => handleMouseEnter('learn')} onMouseLeave={handleMouseLeave}>
          ...
          {activeMenu === 'learn' && (
            <div className="fixed left-1/2 -translate-x-1/2 top-[86px] pt-2 z-50" onMouseEnter={() => handleMouseEnter('learn')} onMouseLeave={handleMouseLeave}>
              <div className="w-[95vw] max-w-[1100px] bg-white shadow-2xl rounded-xl border border-neutral-200 overflow-hidden">
                <div className="grid grid-cols-12">
                  {/* Left: All Categories */}
        ...
        <div className="relative" onMouseEnter={() => handleMouseEnter('blog')} onMouseLeave={handleMouseLeave}>
          ...
          {activeMenu === 'blog' && (
            <div className="fixed left-1/2 -translate-x-1/2 top-[86px] pt-2 z-50" onMouseEnter={() => handleMouseEnter('blog')} onMouseLeave={handleMouseLeave}>
        ...
        <div className="relative ml-2" onMouseEnter={() => handleMouseEnter('free')} onMouseLeave={handleMouseLeave}>
          ...
          {activeMenu === 'free' && (
            <div className="fixed right-4 top-[86px] pt-2 z-50" onMouseEnter={() => handleMouseEnter('free')} onMouseLeave={handleMouseLeave}>
