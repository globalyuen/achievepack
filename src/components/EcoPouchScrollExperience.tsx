...
const MATERIALS = [
  {
    ...
    logo: '/eco-logo/transparent-bkg/compost.webp',
    bgColor: '#f5f0e8',
    accentColor: '#8B7355',
  },
  {
    ...
    logo: '/eco-logo/transparent-bkg/biope.webp',
    bgColor: '#f0fdf4',
    accentColor: '#10b981',
  },
  {
    ...
    logo: '/eco-logo/transparent-bkg/pcr.webp',
    bgColor: '#f0f9ff',
    accentColor: '#0ea5e9',
  },
  {
    ...
    logo: '/eco-logo/transparent-bkg/recycle.webp',
    bgColor: '#f0fdf9',
    accentColor: '#14b8a6',
  },
]
