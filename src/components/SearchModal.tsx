  ...
  const catalog: SearchItem[] = useMemo(() => {
    if (theme === 'b2b') {
      return [
        ...
        { title: 'Child Resistant Bags / Pouches', link: '/function/child-resistant-bags', category: 'Products', description: 'Child-resistant pouches and packaging with safety zippers' },
        { title: 'Retort Pouches', link: '/function/digital-printed-retort-bags', category: 'Products', description: 'High-temperature retortable packaging for ready meals' },
        { title: 'Carbon Neutral Bags', link: '/function/carbon-neutral-bags', category: 'Products', description: 'Certified carbon neutral flexible packaging options' },
        { title: 'Microwave Steam Bags', link: '/function/microwave-steam-bags', category: 'Products', description: 'Self-venting microwave steam cooking bags' },
        { title: 'Smart Degassing Sticker', link: '/function/smart-degassing-sticker', category: 'Products', description: 'Degassing valves alternative for coffee packaging' },
        { title: 'Pre-Zippered Rollstock', link: '/function/pre-zippered-rollstock', category: 'Products', description: 'Form-fill-seal rollstock film with pre-applied zippers' },
        { title: 'Heat-Resistant Pouches', link: '/function/heat-resistant-compostable-pouches', category: 'Products', description: 'Compostable pouches for candles and hot-fill products' },
        { title: 'Large Format Kraft Bags', link: '/function/large-format-kraft-heavy-bags', category: 'Products', description: 'Heavy-duty large format kraft paper bags for bulk goods' },
        { title: 'Spout Pouches for Juice', link: '/function/spout-pouches-juice', category: 'Products', description: 'Liquid spout pouches optimized for juices and beverages' },
        // B2B Materials
        ...
        { title: 'PVA Water Soluble Bags', link: '/function/pva-water-soluble-bags', category: 'Materials', description: 'Biodegradable, completely water-soluble packaging' },
        { title: 'Rice Paper Bags', link: '/function/rice-paper-bags', category: 'Materials', description: 'Textured organic rice paper flexible pouches' },
        // B2B Tools & Services
