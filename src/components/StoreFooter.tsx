        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs text-neutral-400">
              ...
              <li><Link to="/industry/premium-matte-pouches" className="hover:text-primary-400 font-medium text-primary-400 flex items-center gap-1">Premium Matte Finish Pouc <span className="bg-primary-500/20 text-[10px] px-1.5 py-0.5 rounded leading-none uppercase">New</span></Link></li>
              <li><Link to="/industry/wholesale-unprinted-pouches" className="hover:text-primary-400 font-medium text-primary-400 flex items-center gap-1">Wholesale Unprinted & Sto <span className="bg-primary-500/20 text-[10px] px-1.5 py-0.5 rounded leading-none uppercase">New</span></Link></li>
              <li><Link to="/industry/high-barrier-food-pouches" className="hover:text-primary-400 font-medium text-primary-400 flex items-center gap-1">High-Barrier Food Grade P <span className="bg-primary-500/20 text-[10px] px-1.5 py-0.5 rounded leading-none uppercase">New</span></Link></li>
              <li><Link to="/industry/australia-shipping-coo" className="hover:text-primary-400 font-medium text-primary-400 flex items-center gap-1">How to Import Custom Pack <span className="bg-primary-500/20 text-[10px] px-1.5 py-0.5 rounded leading-none uppercase">New</span></Link></li>
              <li><Link to="/industry/premium-finishes" className="hover:text-primary-400 font-medium text-primary-400 flex items-center gap-1">How to design premium Spo <span className="bg-primary-500/20 text-[10px] px-1.5 py-0.5 rounded leading-none uppercase">New</span></Link></li>
              <li><Link to="/industry/high-barrier-retort" className="hover:text-primary-400 font-medium text-primary-400 flex items-center gap-1">Can High-Barrier Retort P <span className="bg-primary-500/20 text-[10px] px-1.5 py-0.5 rounded leading-none uppercase">New</span></Link></li>
              <li><Link to="/industry/custom-spout-pouches" className="hover:text-primary-400 font-medium text-primary-400 flex items-center gap-1">Why Switch to Spout Pouch <span className="bg-primary-500/20 text-[10px] px-1.5 py-0.5 rounded leading-none uppercase">New</span></Link></li>
              <li><Link to="/industry/pet-food-quad-seal" className="hover:text-primary-400 font-medium text-primary-400 flex items-center gap-1">What is the Best Heavy-Du <span className="bg-primary-500/20 text-[10px] px-1.5 py-0.5 rounded leading-none uppercase">New</span></Link></li>
              <li><Link to="/industry/kraft-window-pouch" className="hover:text-primary-400 font-medium text-primary-400 flex items-center gap-1">Kraft Paper Stand Up Pouc <span className="bg-primary-500/20 text-[10px] px-1.5 py-0.5 rounded leading-none uppercase">New</span></Link></li>
              <li><Link to="/industry/matcha-supplement-sachets" className="hover:text-primary-400 font-medium text-primary-400 flex items-center gap-1">How to Design Custom Sach <span className="bg-primary-500/20 text-[10px] px-1.5 py-0.5 rounded leading-none uppercase">New</span></Link></li>
              <li><Link to="/industry/low-moq-fast-turnaround" className="hover:text-primary-400 font-medium text-primary-400 flex items-center gap-1">How to Order Custom Packa <span className="bg-primary-500/20 text-[10px] px-1.5 py-0.5 rounded leading-none uppercase">New</span></Link></li>
              <li><Link to="/industry/premium-soft-touch" className="hover:text-primary-400 font-medium text-primary-400 flex items-center gap-1">Premium Soft Touch Pouche <span className="bg-primary-500/20 text-[10px] px-1.5 py-0.5 rounded leading-none uppercase">New</span></Link></li>
              <li><Link to="/industry/custom-die-cut-pouches" className="hover:text-primary-400 font-medium text-primary-400 flex items-center gap-1">How to Create Custom Die- <span className="bg-primary-500/20 text-[10px] px-1.5 py-0.5 rounded leading-none uppercase">New</span></Link></li>
              <li><Link to="/industry/resealable-tin-tie-bags" className="hover:text-primary-400 font-medium text-primary-400 flex items-center gap-1">Resealable Tin Tie Paper  <span className="bg-primary-500/20 text-[10px] px-1.5 py-0.5 rounded leading-none uppercase">New</span></Link></li>
              <li><Link to="/industry/sustainable-kraft-solutions" className="hover:text-primary-400 font-medium text-primary-400 flex items-center gap-1">What is the Difference Be <span className="bg-primary-500/20 text-[10px] px-1.5 py-0.5 rounded leading-none uppercase">New</span></Link></li>
              <li><Link to="/industry/durable-reusable-pouches" className="hover:text-primary-400 font-medium text-primary-400 flex items-center gap-1">Eco-Friendly Ziplock Pouc <span className="bg-primary-500/20 text-[10px] px-1.5 py-0.5 rounded leading-none uppercase">New</span></Link></li>
              <li><Link to="/industry/pla-compostable-packaging" className="hover:text-primary-400 font-medium text-primary-400 flex items-center gap-1">How does 100% PLA Compost <span className="bg-primary-500/20 text-[10px] px-1.5 py-0.5 rounded leading-none uppercase">New</span></Link></li>
              ...
              <li><Link to="/industry/eco-friendly-tea-coffee" className="hover:text-primary-400 font-medium text-primary-400 flex items-center gap-1">How to Select Eco-Friendl <span className="bg-primary-500/20 text-[10px] px-1.5 py-0.5 rounded leading-none uppercase">New</span></Link></li>
              <li><Link to="/industry/compostable-laminated-film" className="hover:text-primary-400 font-medium text-primary-400 flex items-center gap-1">How does Compostable Lami <span className="bg-primary-500/20 text-[10px] px-1.5 py-0.5 rounded leading-none uppercase">New</span></Link></li>
              <li><Link to="/industry/child-resistant-cbd" className="hover:text-primary-400 font-medium text-primary-400 flex items-center gap-1">Child Resistant (CR) Pouc <span className="bg-primary-500/20 text-[10px] px-1.5 py-0.5 rounded leading-none uppercase">New</span></Link></li>
              <li><Link to="/industry/compostable-protein-bags" className="hover:text-primary-400 font-medium text-primary-400 flex items-center gap-1">Compostable Flat Bottom P <span className="bg-primary-500/20 text-[10px] px-1.5 py-0.5 rounded leading-none uppercase">New</span></Link></li>
              <li><Link to="/industry/clear-transparent-pouches" className="hover:text-primary-400 font-medium text-primary-400 flex items-center gap-1">there Clear Transparent C <span className="bg-primary-500/20 text-[10px] px-1.5 py-0.5 rounded leading-none uppercase">New</span></Link></li>
              <li><Link to="/industry/recyclable-vacuum-bags" className="hover:text-primary-400 font-medium text-primary-400 flex items-center gap-1">Can You Recycle Vacuum Ba <span className="bg-primary-500/20 text-[10px] px-1.5 py-0.5 rounded leading-none uppercase">New</span></Link></li>
              <li><Link to="/industry/eco-coffee-bags-valve" className="hover:text-primary-400 font-medium text-primary-400 flex items-center gap-1">there Fully Compostable C <span className="bg-primary-500/20 text-[10px] px-1.5 py-0.5 rounded leading-none uppercase">New</span></Link></li>
              <li><Link to="/industry/pcr-packaging-pouches" className="hover:text-primary-400 font-medium text-primary-400 flex items-center gap-1">What is PCR (Post-Consume <span className="bg-primary-500/20 text-[10px] px-1.5 py-0.5 rounded leading-none uppercase">New</span></Link></li>
              <li><Link to="/industry/euro-hole-hang-bags" className="hover:text-primary-400 font-medium text-primary-400 flex items-center gap-1">Eco-Friendly Pouches with <span className="bg-primary-500/20 text-[10px] px-1.5 py-0.5 rounded leading-none uppercase">New</span></Link></li>
