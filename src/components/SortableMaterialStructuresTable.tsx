...
export const MONO_PE_PP_STRUCTURES: MaterialStructure[] = [
  ...
  { id: 'mono-pe-triplex-metalised', name: 'Mono PE Triplex Metalised', shortName: 'PE Metalised', img: '/imgs/spec/mono-pe-triplex-metalised.webp', url: '/spec/mono-pe-triplex-metalised', otr: 1, otrDisplay: '<1', wvtr: 1, wvtrDisplay: '<1', thickness: '120μm', barrierLevel: 'high', hasWindow: false, hasKraft: false, hasMetalised: true, hasAluminum: false, bestFor: ['high barrier', 'coffee'], feature: 'High Barrier', category: 'mono-pe' },
  { id: 'mono-pp-triplex-metalised', name: 'Mono PP Triplex Metalised', shortName: 'PP Metalised', img: '/imgs/spec/mono-pp-triplex-metalised.webp', url: '/spec/mono-pp-triplex-metalised', otr: 1, otrDisplay: '<1', wvtr: 0.5, wvtrDisplay: '<0.5', thickness: '120μm', barrierLevel: 'high', hasWindow: false, hasKraft: false, hasMetalised: true, hasAluminum: false, bestFor: ['high barrier', 'moisture'], feature: 'High + Moisture', category: 'mono-pp' },
]
...
export const COMPOSTABLE_STRUCTURES: MaterialStructure[] = [
  ...
  { id: 'bio-cello-duplex-nowindow', name: 'Bio Cello Duplex No Window', shortName: 'Cello No Window', img: '/imgs/spec/bio-cello-duplex-nowindow.webp', url: '/spec/bio-cello-duplex-nowindow', otr: 200, otrDisplay: '<200', wvtr: 50, wvtrDisplay: '<50', thickness: '60μm', barrierLevel: 'low', hasWindow: false, hasKraft: false, hasMetalised: false, hasAluminum: false, bestFor: ['home compostable', 'light barrier'], feature: 'Light Protection', category: 'compostable' },
  { id: 'bio-pla-duplex-clear', name: 'Bio PLA Duplex Clear', shortName: 'PLA Clear', img: '/imgs/spec/bio-pla-duplex-clear.webp', url: '/spec/bio-pla-duplex-clear', otr: 100, otrDisplay: '<100', wvtr: 30, wvtrDisplay: '<30', thickness: '80μm', barrierLevel: 'low', hasWindow: true, hasKraft: false, hasMetalised: false, hasAluminum: false, bestFor: ['industrial compost', 'snacks'], feature: 'Industrial Compost', category: 'compostable' },
  { id: 'bio-pla-kraft-triplex-clear', name: 'Bio PLA Kraft Triplex Clear', shortName: 'PLA Kraft', img: '/imgs/spec/bio-pla-kraft-triplex-clear.webp', url: '/spec/bio-pla-kraft-triplex-clear', otr: 100, otrDisplay: '<100', wvtr: 25, wvtrDisplay: '<25', thickness: '120μm', barrierLevel: 'low', hasWindow: true, hasKraft: true, hasMetalised: false, hasAluminum: false, bestFor: ['premium', 'natural look'], feature: 'Natural + Compost', category: 'compostable' },
  { id: 'bio-pla-triplex-metalised', name: 'Bio PLA Triplex Metalised', shortName: 'PLA Metalised', img: '/imgs/spec/bio-pla-triplex-metalised.webp', url: '/spec/bio-pla-triplex-metalised', otr: 5, otrDisplay: '<5', wvtr: 5, wvtrDisplay: '<5', thickness: '100μm', barrierLevel: 'high', hasWindow: false, hasKraft: false, hasMetalised: true, hasAluminum: false, bestFor: ['compostable + barrier'], feature: 'High Barrier Bio', category: 'compostable' },
]
