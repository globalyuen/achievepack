...
export const PCR_STRUCTURES: MaterialStructure[] = [
  ...
  { id: 'pcr-pet-quadlex-aluminum-heavy', name: 'PCR PET Quadlex Aluminum Heavy Duty', shortName: 'PET Quadlex Heavy', img: '/imgs/spec/pet-quadlex-aluminum-heavy.webp', url: '/spec/pcr-pet-duplex-clear', otr: 0.3, otrDisplay: '<0.3', wvtr: 0.3, wvtrDisplay: '<0.3', thickness: '200μm', barrierLevel: 'ultra', hasWindow: false, hasKraft: false, hasMetalised: false, hasAluminum: true, bestFor: ['heavy duty', 'max protection'], feature: 'Heavy Duty', category: 'pcr' },
...
export const BIO_PE_STRUCTURES: MaterialStructure[] = [
  ...
  { id: 'biope-pet-quadlex-aluminum-heavy', name: 'BioPE PET Quadlex Aluminum Heavy Duty', shortName: 'BioPE PET Quadlex', img: '/imgs/spec/pet-quadlex-aluminum-heavy.webp', url: '/spec/biope-pet-duplex-clear', otr: 0.3, otrDisplay: '<0.3', wvtr: 0.3, wvtrDisplay: '<0.3', thickness: '200μm', barrierLevel: 'ultra', hasWindow: false, hasKraft: false, hasMetalised: false, hasAluminum: true, bestFor: ['heavy duty', 'max protection'], feature: 'Heavy Duty Bio', category: 'bio-pe' },
]
