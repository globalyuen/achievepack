...
const Abarrieroptionspresentationc6124347 = lazyWithRetry(() => import('./pages/topics/ABarrierOptionsPresentationC6124347'));
const Acalculatordimensionsguide9407366 = lazyWithRetry(() => import('./pages/topics/ACalculatorDimensionsGuide9407366'));
const Acalculatorenvironmentalchart0728270 = lazyWithRetry(() => import('./pages/topics/ACalculatorEnvironmentalChart0728270'));
const Acalculatorglassjar6073879 = lazyWithRetry(() => import('./pages/topics/ACalculatorGlassJar6073879'));
const Acalculatormetalcan8467151 = lazyWithRetry(() => import('./pages/topics/ACalculatorMetalCan8467151'));
const Acalculatorprojectiongraph8271356 = lazyWithRetry(() => import('./pages/topics/ACalculatorProjectionGraph8271356'));
const Acalculatorquestionmark1525340 = lazyWithRetry(() => import('./pages/topics/ACalculatorQuestionMark1525340'));
const Acalculatorsavingschart5545421 = lazyWithRetry(() => import('./pages/topics/ACalculatorSavingsChart5545421'));
const Acalculatorshippingillustration1305407 = lazyWithRetry(() => import('./pages/topics/ACalculatorShippingIllustration1305407'));
const Acalculatorsuccessicon9230577 = lazyWithRetry(() => import('./pages/topics/ACalculatorSuccessIcon9230577'));
const Acostbenefitinfographic9738186 = lazyWithRetry(() => import('./pages/topics/ACostBenefitInfographic9738186'));
const Alabelingguidev28119676 = lazyWithRetry(() => import('./pages/topics/ALabelingGuideV28119676'));
const Apcrmaterialsciencerecyclingdiagram3116614 = lazyWithRetry(() => import('./pages/topics/APcrMaterialScienceRecyclingDiagram3116614'));
const Apcrtestingvalidationdiagram8779130 = lazyWithRetry(() => import('./pages/topics/APcrTestingValidationDiagram8779130'));
const Aproductresidueprofileanalysis24334051 = lazyWithRetry(() => import('./pages/topics/AProductResidueProfileAnalysis24334051'));
const Asizeguidecardv29433535 = lazyWithRetry(() => import('./pages/topics/ASizeGuideCardV29433535'));
const Asmejourneyportfoliodiagram6443956 = lazyWithRetry(() => import('./pages/topics/ASmeJourneyPortfolioDiagram6443956'));
const Asnackbrandvariation22026894 = lazyWithRetry(() => import('./pages/topics/ASnackBrandVariation22026894'));
const Asurfacefinishclosedetailb2163248 = lazyWithRetry(() => import('./pages/topics/ASurfaceFinishCloseDetailB2163248'));
const Appletouchicon = lazyWithRetry(() => import('./pages/topics/AppleTouchIcon'));
const Babyfoodheropackagingv2 = lazyWithRetry(() => import('./pages/topics/BabyFoodHeroPackagingV2'));
const Babyfoodheropackagingv3 = lazyWithRetry(() => import('./pages/topics/BabyFoodHeroPackagingV3'));
const Biopeeprresidueanalysis = lazyWithRetry(() => import('./pages/topics/BioPeEprResidueAnalysis'));
const Biopeproductresidueanalysis = lazyWithRetry(() => import('./pages/topics/BioPeProductResidueAnalysis'));
const Biodegradableflatbottombagswholesaleinfographic = lazyWithRetry(() => import('./pages/topics/BiodegradableFlatBottomBagsWholesaleInfographic'));
const Biope = lazyWithRetry(() => import('./pages/topics/Biope'));
const Bpi = lazyWithRetry(() => import('./pages/topics/Bpi'));
const Bpicertifiedguideinfographic4 = lazyWithRetry(() => import('./pages/topics/BpiCertifiedGuideInfographic4'));
const Bpicertifiedguideinfographic5 = lazyWithRetry(() => import('./pages/topics/BpiCertifiedGuideInfographic5'));
const Certificationfaq = lazyWithRetry(() => import('./pages/topics/CertificationFaq'));
const Childresistantexitbagpage = lazyWithRetry(() => import('./pages/topics/ChildResistantExitBagPage'));
const Climate = lazyWithRetry(() => import('./pages/topics/Climate'));
const Comparisonflexiblevsrigid = lazyWithRetry(() => import('./pages/topics/ComparisonFlexibleVsRigid'));
const Compostablebarrierfilmforsnacksinfographic4 = lazyWithRetry(() => import('./pages/topics/CompostableBarrierFilmForSnacksInfographic4'));
const Compostablebarrierfilmforsnacksinfographic5 = lazyWithRetry(() => import('./pages/topics/CompostableBarrierFilmForSnacksInfographic5'));
const Compostablehighbarrierfilmsuppliersinfographic4 = lazyWithRetry(() => import('./pages/topics/CompostableHighBarrierFilmSuppliersInfographic4'));
const Compostablehighbarrierfilmsuppliersinfographic5 = lazyWithRetry(() => import('./pages/topics/CompostableHighBarrierFilmSuppliersInfographic5'));
const Compostablehumiditycontrolguideinfographic4 = lazyWithRetry(() => import('./pages/topics/CompostableHumidityControlGuideInfographic4'));
const Compostablehumiditycontrolguideinfographic5 = lazyWithRetry(() => import('./pages/topics/CompostableHumidityControlGuideInfographic5'));
const Compostablepouchsizechartforliquidsinfographic6 = lazyWithRetry(() => import('./pages/topics/CompostablePouchSizeChartForLiquidsInfographic6'));
const Compostablepowdersachet = lazyWithRetry(() => import('./pages/topics/CompostablePowderSachet'));
const Compostableretortpouchesforbabyfoodinfographic4 = lazyWithRetry(() => import('./pages/topics/CompostableRetortPouchesForBabyFoodInfographic4'));
const Compostableretortpouchesforbabyfoodinfographic5 = lazyWithRetry(() => import('./pages/topics/CompostableRetortPouchesForBabyFoodInfographic5'));
const Compostableteapouchwithzipperinfographic6 = lazyWithRetry(() => import('./pages/topics/CompostableTeaPouchWithZipperInfographic6'));
const Compostablevacuumsealbagpage = lazyWithRetry(() => import('./pages/topics/CompostableVacuumSealBagPage'));
const Contactctabanner = lazyWithRetry(() => import('./pages/topics/ContactCtaBanner'));
const Curbsiderecyclablecoffeebaginfographic2 = lazyWithRetry(() => import('./pages/topics/CurbsideRecyclableCoffeeBagInfographic2'));
const Curbsiderecyclablecoffeebaginfographic3 = lazyWithRetry(() => import('./pages/topics/CurbsideRecyclableCoffeeBagInfographic3'));
const Custompackagingdesign7D2800Dc = lazyWithRetry(() => import('./pages/topics/CustomPackagingDesign7d2800dc'));
const Custompouchdesign4Aac2432 = lazyWithRetry(() => import('./pages/topics/CustomPouchDesign4aac2432'));
const Customprintedbarriersachetsinfographic6 = lazyWithRetry(() => import('./pages/topics/CustomPrintedBarrierSachetsInfographic6'));
const Customprintedmaterialsguideinfographic2 = lazyWithRetry(() => import('./pages/topics/CustomPrintedMaterialsGuideInfographic2'));
const Customprintedmaterialsguideinfographic3 = lazyWithRetry(() => import('./pages/topics/CustomPrintedMaterialsGuideInfographic3'));
const Customprintedsachetpackagingwholesaleinfographic2 = lazyWithRetry(() => import('./pages/topics/CustomPrintedSachetPackagingWholesaleInfographic2'));
const Customprintedsachetpackagingwholesaleinfographic3 = lazyWithRetry(() => import('./pages/topics/CustomPrintedSachetPackagingWholesaleInfographic3'));
const Customshapedcompostablestanduppouchesinfographic = lazyWithRetry(() => import('./pages/topics/CustomShapedCompostableStandUpPouchesInfographic'));
const Customstanduppouchpetfoodpage = lazyWithRetry(() => import('./pages/topics/CustomStandUpPouchPetFoodPage'));
const Digitalprintedbarrierpouchessmallbatchinfographic2 = lazyWithRetry(() => import('./pages/topics/DigitalPrintedBarrierPouchesSmallBatchInfographic2'));
const Digitalprintedbarrierpouchessmallbatchinfographic3 = lazyWithRetry(() => import('./pages/topics/DigitalPrintedBarrierPouchesSmallBatchInfographic3'));
const Digitalprintingecopackagingguideinfographic6 = lazyWithRetry(() => import('./pages/topics/DigitalPrintingEcoPackagingGuideInfographic6'));
const Ecodigitalprintingadvantage = lazyWithRetry(() => import('./pages/topics/EcoDigitalPrintingAdvantage'));
const Ecofriendlydigitalprintbagsinfographic3 = lazyWithRetry(() => import('./pages/topics/EcoFriendlyDigitalPrintBagsInfographic3'));
const Ecofriendlypouchsizeschartinfographic2 = lazyWithRetry(() => import('./pages/topics/EcoFriendlyPouchSizesChartInfographic2'));
const Ecofriendlypouchsizeschartinfographic3 = lazyWithRetry(() => import('./pages/topics/EcoFriendlyPouchSizesChartInfographic3'));
const Ecofriendlystanduppouchdimensionsinfographic3 = lazyWithRetry(() => import('./pages/topics/EcoFriendlyStandUpPouchDimensionsInfographic3'));
const Ecommercebrandpackagingvariation2 = lazyWithRetry(() => import('./pages/topics/EcommerceBrandPackagingVariation2'));
const Flatbottomproteinbag = lazyWithRetry(() => import('./pages/topics/FlatBottomProteinBag'));
const Flexiblepackagingsachetsizesforpowdersinfographic6 = lazyWithRetry(() => import('./pages/topics/FlexiblePackagingSachetSizesForPowdersInfographic6'));
const Foodsupplier = lazyWithRetry(() => import('./pages/topics/FoodSupplier'));
const Foodsupplierpackaging = lazyWithRetry(() => import('./pages/topics/FoodSupplierPackaging'));
const Greaseproofpettreatpackaginginfographic6 = lazyWithRetry(() => import('./pages/topics/GreaseProofPetTreatPackagingInfographic6'));
const Hero = lazyWithRetry(() => import('./pages/topics/Hero'));
const Holographicretortpouchpage = lazyWithRetry(() => import('./pages/topics/HolographicRetortPouchPage'));
const Homecompostableguideinfographic4 = lazyWithRetry(() => import('./pages/topics/HomeCompostableGuideInfographic4'));
const Homecompostableguideinfographic5 = lazyWithRetry(() => import('./pages/topics/HomeCompostableGuideInfographic5'));
const Img6311 = lazyWithRetry(() => import('./pages/topics/Img6311'));
const Img6312 = lazyWithRetry(() => import('./pages/topics/Img6312'));
const Img8013 = lazyWithRetry(() => import('./pages/topics/Img8013'));
const Img8016 = lazyWithRetry(() => import('./pages/topics/Img8016'));
const Img8020 = lazyWithRetry(() => import('./pages/topics/Img8020'));
const Img8028 = lazyWithRetry(() => import('./pages/topics/Img8028'));
const Img8032 = lazyWithRetry(() => import('./pages/topics/Img8032'));
const Img8034 = lazyWithRetry(() => import('./pages/topics/Img8034'));
const Img8042 = lazyWithRetry(() => import('./pages/topics/Img8042'));
const Img8043 = lazyWithRetry(() => import('./pages/topics/Img8043'));
const Img8048 = lazyWithRetry(() => import('./pages/topics/Img8048'));
const Img8053 = lazyWithRetry(() => import('./pages/topics/Img8053'));
const Infographicgrsrecyclable = lazyWithRetry(() => import('./pages/topics/InfographicGrsRecyclable'));
const Infographicplantbased = lazyWithRetry(() => import('./pages/topics/InfographicPlantBased'));
const Infographicpremiumfinishes = lazyWithRetry(() => import('./pages/topics/InfographicPremiumFinishes'));
const Infographicshippingstorage = lazyWithRetry(() => import('./pages/topics/InfographicShippingStorage'));
const Kraftpaperflatbottombagpage = lazyWithRetry(() => import('./pages/topics/KraftPaperFlatBottomBagPage'));
const Kraftpaperzipperdoypackinfographic4 = lazyWithRetry(() => import('./pages/topics/KraftPaperZipperDoypackInfographic4'));
const Kraftpaperzipperdoypackinfographic5 = lazyWithRetry(() => import('./pages/topics/KraftPaperZipperDoypackInfographic5'));
const Kraftstanduppoucheswithwindowinfographic4 = lazyWithRetry(() => import('./pages/topics/KraftStandUpPouchesWithWindowInfographic4'));
const Kraftstanduppoucheswithwindowinfographic5 = lazyWithRetry(() => import('./pages/topics/KraftStandUpPouchesWithWindowInfographic5'));
const Lowminimumdigitalpouchprintinginfographic2 = lazyWithRetry(() => import('./pages/topics/LowMinimumDigitalPouchPrintingInfographic2'));
const Lowminimumdigitalpouchprintinginfographic6 = lazyWithRetry(() => import('./pages/topics/LowMinimumDigitalPouchPrintingInfographic6'));
const Mattefoilcoffeebagpage = lazyWithRetry(() => import('./pages/topics/MatteFoilCoffeeBagPage'));
const Monomaterial = lazyWithRetry(() => import('./pages/topics/MonoMaterial'));
const Monopevsmonoppinfographic4 = lazyWithRetry(() => import('./pages/topics/MonoPeVsMonoPpInfographic4'));
const Monopevsmonoppinfographic5 = lazyWithRetry(() => import('./pages/topics/MonoPeVsMonoPpInfographic5'));
const Ogimage = lazyWithRetry(() => import('./pages/topics/OgImage'));
const Patterndots = lazyWithRetry(() => import('./pages/topics/PatternDots'));
const Pcrcostbenefitinfographic = lazyWithRetry(() => import('./pages/topics/PcrCostBenefitInfographic'));
const Pcrguide = lazyWithRetry(() => import('./pages/topics/PcrGuide'));
const Pcrmaterialsciencediagram = lazyWithRetry(() => import('./pages/topics/PcrMaterialScienceDiagram'));
const Pcrpackagingguide = lazyWithRetry(() => import('./pages/topics/PcrPackagingGuide'));
const Pcrpackagingherooverview = lazyWithRetry(() => import('./pages/topics/PcrPackagingHeroOverview'));
const Pcrtestingvalidationdiagram = lazyWithRetry(() => import('./pages/topics/PcrTestingValidationDiagram'));
const Process5Steps = lazyWithRetry(() => import('./pages/topics/Process5Steps'));
const Productcompostingtimeline = lazyWithRetry(() => import('./pages/topics/ProductCompostingTimeline'));
const Recyclablebarriersachetsforcoffeeinfographic = lazyWithRetry(() => import('./pages/topics/RecyclableBarrierSachetsForCoffeeInfographic'));
const Recyclableguide = lazyWithRetry(() => import('./pages/topics/RecyclableGuide'));
const Recyclablerollstockfilmpage = lazyWithRetry(() => import('./pages/topics/RecyclableRollstockFilmPage'));
const Reducewaste = lazyWithRetry(() => import('./pages/topics/ReduceWaste'));
const Resealablemylarbagsnackspage = lazyWithRetry(() => import('./pages/topics/ResealableMylarBagSnacksPage'));
const Smallbatchprintedflexiblepackaginginfographic3 = lazyWithRetry(() => import('./pages/topics/SmallBatchPrintedFlexiblePackagingInfographic3'));
const Smepackagingjourney = lazyWithRetry(() => import('./pages/topics/SmePackagingJourney'));
const Snackbrandpackagingvariation2 = lazyWithRetry(() => import('./pages/topics/SnackBrandPackagingVariation2'));
const Solutionfoodbeverage = lazyWithRetry(() => import('./pages/topics/SolutionFoodBeverage'));
const Stampfoilrecyclabilityinfographic2 = lazyWithRetry(() => import('./pages/topics/StampFoilRecyclabilityInfographic2'));
const Stampfoilrecyclabilityinfographic3 = lazyWithRetry(() => import('./pages/topics/StampFoilRecyclabilityInfographic3'));
const Standuppouch2Ozsizechartinfographic4 = lazyWithRetry(() => import('./pages/topics/StandUpPouch2OzSizeChartInfographic4'));
const Standuppouch2Ozsizechartinfographic5 = lazyWithRetry(() => import('./pages/topics/StandUpPouch2OzSizeChartInfographic5'));
const Standuppouchforpowders = lazyWithRetry(() => import('./pages/topics/StandUpPouchForPowders'));
const Standuppouchsizingguideinfographic = lazyWithRetry(() => import('./pages/topics/StandUpPouchSizingGuideInfographic'));
const Start = lazyWithRetry(() => import('./pages/topics/Start'));
const Sustainableflatbottompouchsizesinfographic3 = lazyWithRetry(() => import('./pages/topics/SustainableFlatBottomPouchSizesInfographic3'));
const Testslugschemainfographic = lazyWithRetry(() => import('./pages/topics/TestSlugSchemaInfographic'));
const Testslugschemainfographic4 = lazyWithRetry(() => import('./pages/topics/TestSlugSchemaInfographic4'));
const Topic4Aac2432Ccfb47A2Bff283B4B4304F63 = lazyWithRetry(() => import('./pages/topics/Topic4aac2432Ccfb47a2Bff283b4b4304f63'));
const Topic550370B477134F3289Cb48E0A6Ba2Fe3 = lazyWithRetry(() => import('./pages/topics/Topic550370b477134f3289cb48e0a6ba2fe3'));
const Topic724830347D2F4D59Aae0B6Fbfa3A7897 = lazyWithRetry(() => import('./pages/topics/Topic724830347d2f4d59Aae0B6fbfa3a7897'));
const Topic7D2800Dc97Da4386B3Eabca29C3A9E05 = lazyWithRetry(() => import('./pages/topics/Topic7d2800dc97da4386B3eaBca29c3a9e05'));
    ...
    <Routes>
      ...
      <Route path="/topics/pcr-packaging-cost-benefit-infographic" element={<PcrCostBenefitInfographic />} />
          ...
          <Route path="/topics/custom-printed-barrier-sachets" element={<CustomPrintedBarrierSachetsPage />} />
                    <Route path="/topics/a-baby-food-hero-v21781490" element={<Ababyfoodherov21781490 />} />
              <Route path="/topics/a-baby-food-hero-v34065437" element={<Ababyfoodherov34065437 />} />
              <Route path="/topics/a-barrier-options-presentation-c6124347" element={<Abarrieroptionspresentationc6124347 />} />
              <Route path="/topics/a-calculator-dimensions-guide9407366" element={<Acalculatordimensionsguide9407366 />} />
              <Route path="/topics/a-calculator-environmental-chart0728270" element={<Acalculatorenvironmentalchart0728270 />} />
              <Route path="/topics/a-calculator-glass-jar6073879" element={<Acalculatorglassjar6073879 />} />
              <Route path="/topics/a-calculator-metal-can8467151" element={<Acalculatormetalcan8467151 />} />
              <Route path="/topics/a-calculator-projection-graph8271356" element={<Acalculatorprojectiongraph8271356 />} />
              <Route path="/topics/a-calculator-question-mark1525340" element={<Acalculatorquestionmark1525340 />} />
              <Route path="/topics/a-calculator-savings-chart5545421" element={<Acalculatorsavingschart5545421 />} />
              <Route path="/topics/a-calculator-shipping-illustration1305407" element={<Acalculatorshippingillustration1305407 />} />
              <Route path="/topics/a-calculator-success-icon9230577" element={<Acalculatorsuccessicon9230577 />} />
              <Route path="/topics/a-cost-benefit-infographic9738186" element={<Acostbenefitinfographic9738186 />} />
              <Route path="/topics/a-labeling-guide-v28119676" element={<Alabelingguidev28119676 />} />
              <Route path="/topics/a-pcr-material-science-recycling-diagram3116614" element={<Apcrmaterialsciencerecyclingdiagram3116614 />} />
              <Route path="/topics/a-pcr-testing-validation-diagram8779130" element={<Apcrtestingvalidationdiagram8779130 />} />
              <Route path="/topics/a-product-residue-profile-analysis24334051" element={<Aproductresidueprofileanalysis24334051 />} />
              <Route path="/topics/a-size-guide-card-v29433535" element={<Asizeguidecardv29433535 />} />
              <Route path="/topics/a-sme-journey-portfolio-diagram6443956" element={<Asmejourneyportfoliodiagram6443956 />} />
              <Route path="/topics/a-snack-brand-variation22026894" element={<Asnackbrandvariation22026894 />} />
              <Route path="/topics/a-surface-finish-close-detail-b2163248" element={<Asurfacefinishclosedetailb2163248 />} />
              <Route path="/topics/apple-touch-icon" element={<Appletouchicon />} />
              <Route path="/topics/baby-food-hero-packaging-v2" element={<Babyfoodheropackagingv2 />} />
              <Route path="/topics/baby-food-hero-packaging-v3" element={<Babyfoodheropackagingv3 />} />
              <Route path="/topics/bio-pe-epr-residue-analysis" element={<Biopeeprresidueanalysis />} />
              <Route path="/topics/bio-pe-product-residue-analysis" element={<Biopeproductresidueanalysis />} />
              <Route path="/topics/biodegradable-flat-bottom-bags-wholesale-infographic" element={<Biodegradableflatbottombagswholesaleinfographic />} />
              <Route path="/topics/biope" element={<Biope />} />
              <Route path="/topics/bpi" element={<Bpi />} />
              <Route path="/topics/bpi-certified-guide-infographic4" element={<Bpicertifiedguideinfographic4 />} />
              <Route path="/topics/bpi-certified-guide-infographic5" element={<Bpicertifiedguideinfographic5 />} />
              <Route path="/topics/certification-faq" element={<Certificationfaq />} />
              <Route path="/topics/child-resistant-exit-bag-page" element={<Childresistantexitbagpage />} />
              <Route path="/topics/climate" element={<Climate />} />
              <Route path="/topics/comparison-flexible-vs-rigid" element={<Comparisonflexiblevsrigid />} />
              <Route path="/topics/compostable-barrier-film-for-snacks-infographic4" element={<Compostablebarrierfilmforsnacksinfographic4 />} />
              <Route path="/topics/compostable-barrier-film-for-snacks-infographic5" element={<Compostablebarrierfilmforsnacksinfographic5 />} />
              <Route path="/topics/compostable-high-barrier-film-suppliers-infographic4" element={<Compostablehighbarrierfilmsuppliersinfographic4 />} />
              <Route path="/topics/compostable-high-barrier-film-suppliers-infographic5" element={<Compostablehighbarrierfilmsuppliersinfographic5 />} />
              <Route path="/topics/compostable-humidity-control-guide-infographic4" element={<Compostablehumiditycontrolguideinfographic4 />} />
              <Route path="/topics/compostable-humidity-control-guide-infographic5" element={<Compostablehumiditycontrolguideinfographic5 />} />
              <Route path="/topics/compostable-pouch-size-chart-for-liquids-infographic6" element={<Compostablepouchsizechartforliquidsinfographic6 />} />
              <Route path="/topics/compostable-powder-sachet" element={<Compostablepowdersachet />} />
              <Route path="/topics/compostable-retort-pouches-for-baby-food-infographic4" element={<Compostableretortpouchesforbabyfoodinfographic4 />} />
              <Route path="/topics/compostable-retort-pouches-for-baby-food-infographic5" element={<Compostableretortpouchesforbabyfoodinfographic5 />} />
              <Route path="/topics/compostable-tea-pouch-with-zipper-infographic6" element={<Compostableteapouchwithzipperinfographic6 />} />
              <Route path="/topics/compostable-vacuum-seal-bag-page" element={<Compostablevacuumsealbagpage />} />
              <Route path="/topics/contact-cta-banner" element={<Contactctabanner />} />
              <Route path="/topics/curbside-recyclable-coffee-bag-infographic2" element={<Curbsiderecyclablecoffeebaginfographic2 />} />
              <Route path="/topics/curbside-recyclable-coffee-bag-infographic3" element={<Curbsiderecyclablecoffeebaginfographic3 />} />
              <Route path="/topics/custom-packaging-design7d2800dc" element={<Custompackagingdesign7D2800Dc />} />
              <Route path="/topics/custom-pouch-design4aac2432" element={<Custompouchdesign4Aac2432 />} />
              <Route path="/topics/custom-printed-barrier-sachets-infographic6" element={<Customprintedbarriersachetsinfographic6 />} />
              <Route path="/topics/custom-printed-materials-guide-infographic2" element={<Customprintedmaterialsguideinfographic2 />} />
              <Route path="/topics/custom-printed-materials-guide-infographic3" element={<Customprintedmaterialsguideinfographic3 />} />
              <Route path="/topics/custom-printed-sachet-packaging-wholesale-infographic2" element={<Customprintedsachetpackagingwholesaleinfographic2 />} />
              <Route path="/topics/custom-printed-sachet-packaging-wholesale-infographic3" element={<Customprintedsachetpackagingwholesaleinfographic3 />} />
              <Route path="/topics/custom-shaped-compostable-stand-up-pouches-infographic" element={<Customshapedcompostablestanduppouchesinfographic />} />
              <Route path="/topics/custom-stand-up-pouch-pet-food-page" element={<Customstanduppouchpetfoodpage />} />
              <Route path="/topics/digital-printed-barrier-pouches-small-batch-infographic2" element={<Digitalprintedbarrierpouchessmallbatchinfographic2 />} />
              <Route path="/topics/digital-printed-barrier-pouches-small-batch-infographic3" element={<Digitalprintedbarrierpouchessmallbatchinfographic3 />} />
              <Route path="/topics/digital-printing-eco-packaging-guide-infographic6" element={<Digitalprintingecopackagingguideinfographic6 />} />
              <Route path="/topics/eco-digital-printing-advantage" element={<Ecodigitalprintingadvantage />} />
              <Route path="/topics/eco-friendly-digital-print-bags-infographic3" element={<Ecofriendlydigitalprintbagsinfographic3 />} />
              <Route path="/topics/eco-friendly-pouch-sizes-chart-infographic2" element={<Ecofriendlypouchsizeschartinfographic2 />} />
              <Route path="/topics/eco-friendly-pouch-sizes-chart-infographic3" element={<Ecofriendlypouchsizeschartinfographic3 />} />
              <Route path="/topics/eco-friendly-stand-up-pouch-dimensions-infographic3" element={<Ecofriendlystanduppouchdimensionsinfographic3 />} />
              <Route path="/topics/ecommerce-brand-packaging-variation2" element={<Ecommercebrandpackagingvariation2 />} />
              <Route path="/topics/flat-bottom-protein-bag" element={<Flatbottomproteinbag />} />
              <Route path="/topics/flexible-packaging-sachet-sizes-for-powders-infographic6" element={<Flexiblepackagingsachetsizesforpowdersinfographic6 />} />
              <Route path="/topics/food-supplier" element={<Foodsupplier />} />
              <Route path="/topics/food-supplier-packaging" element={<Foodsupplierpackaging />} />
              <Route path="/topics/grease-proof-pet-treat-packaging-infographic6" element={<Greaseproofpettreatpackaginginfographic6 />} />
              <Route path="/topics/hero" element={<Hero />} />
              <Route path="/topics/holographic-retort-pouch-page" element={<Holographicretortpouchpage />} />
              <Route path="/topics/home-compostable-guide-infographic4" element={<Homecompostableguideinfographic4 />} />
              <Route path="/topics/home-compostable-guide-infographic5" element={<Homecompostableguideinfographic5 />} />
              <Route path="/topics/img6311" element={<Img6311 />} />
              <Route path="/topics/img6312" element={<Img6312 />} />
              <Route path="/topics/img8013" element={<Img8013 />} />
              <Route path="/topics/img8016" element={<Img8016 />} />
              <Route path="/topics/img8020" element={<Img8020 />} />
              <Route path="/topics/img8028" element={<Img8028 />} />
              <Route path="/topics/img8032" element={<Img8032 />} />
              <Route path="/topics/img8034" element={<Img8034 />} />
              <Route path="/topics/img8042" element={<Img8042 />} />
              <Route path="/topics/img8043" element={<Img8043 />} />
              <Route path="/topics/img8048" element={<Img8048 />} />
              <Route path="/topics/img8053" element={<Img8053 />} />
              <Route path="/topics/infographic-grs-recyclable" element={<Infographicgrsrecyclable />} />
              <Route path="/topics/infographic-plant-based" element={<Infographicplantbased />} />
              <Route path="/topics/infographic-premium-finishes" element={<Infographicpremiumfinishes />} />
              <Route path="/topics/infographic-shipping-storage" element={<Infographicshippingstorage />} />
              <Route path="/topics/kraft-paper-flat-bottom-bag-page" element={<Kraftpaperflatbottombagpage />} />
              <Route path="/topics/kraft-paper-zipper-doypack-infographic4" element={<Kraftpaperzipperdoypackinfographic4 />} />
              <Route path="/topics/kraft-paper-zipper-doypack-infographic5" element={<Kraftpaperzipperdoypackinfographic5 />} />
              <Route path="/topics/kraft-stand-up-pouches-with-window-infographic4" element={<Kraftstanduppoucheswithwindowinfographic4 />} />
              <Route path="/topics/kraft-stand-up-pouches-with-window-infographic5" element={<Kraftstanduppoucheswithwindowinfographic5 />} />
              <Route path="/topics/low-minimum-digital-pouch-printing-infographic2" element={<Lowminimumdigitalpouchprintinginfographic2 />} />
              <Route path="/topics/low-minimum-digital-pouch-printing-infographic6" element={<Lowminimumdigitalpouchprintinginfographic6 />} />
              <Route path="/topics/matte-foil-coffee-bag-page" element={<Mattefoilcoffeebagpage />} />
              <Route path="/topics/mono-material" element={<Monomaterial />} />
              <Route path="/topics/mono-pe-vs-mono-pp-infographic4" element={<Monopevsmonoppinfographic4 />} />
              <Route path="/topics/mono-pe-vs-mono-pp-infographic5" element={<Monopevsmonoppinfographic5 />} />
              <Route path="/topics/og-image" element={<Ogimage />} />
              <Route path="/topics/pattern-dots" element={<Patterndots />} />
              <Route path="/topics/pcr-cost-benefit-infographic" element={<Pcrcostbenefitinfographic />} />
              <Route path="/topics/pcr-guide" element={<Pcrguide />} />
              <Route path="/topics/pcr-material-science-diagram" element={<Pcrmaterialsciencediagram />} />
              <Route path="/topics/pcr-packaging-guide" element={<Pcrpackagingguide />} />
              <Route path="/topics/pcr-packaging-hero-overview" element={<Pcrpackagingherooverview />} />
              <Route path="/topics/pcr-testing-validation-diagram" element={<Pcrtestingvalidationdiagram />} />
              <Route path="/topics/process5-steps" element={<Process5Steps />} />
              <Route path="/topics/product-composting-timeline" element={<Productcompostingtimeline />} />
              <Route path="/topics/recyclable-barrier-sachets-for-coffee-infographic" element={<Recyclablebarriersachetsforcoffeeinfographic />} />
              <Route path="/topics/recyclable-guide" element={<Recyclableguide />} />
              <Route path="/topics/recyclable-rollstock-film-page" element={<Recyclablerollstockfilmpage />} />
              <Route path="/topics/reduce-waste" element={<Reducewaste />} />
              <Route path="/topics/resealable-mylar-bag-snacks-page" element={<Resealablemylarbagsnackspage />} />
              <Route path="/topics/small-batch-printed-flexible-packaging-infographic3" element={<Smallbatchprintedflexiblepackaginginfographic3 />} />
              <Route path="/topics/sme-packaging-journey" element={<Smepackagingjourney />} />
              <Route path="/topics/snack-brand-packaging-variation2" element={<Snackbrandpackagingvariation2 />} />
              <Route path="/topics/solution-food-beverage" element={<Solutionfoodbeverage />} />
              <Route path="/topics/stamp-foil-recyclability-infographic2" element={<Stampfoilrecyclabilityinfographic2 />} />
              <Route path="/topics/stamp-foil-recyclability-infographic3" element={<Stampfoilrecyclabilityinfographic3 />} />
              <Route path="/topics/stand-up-pouch2-oz-size-chart-infographic4" element={<Standuppouch2Ozsizechartinfographic4 />} />
              <Route path="/topics/stand-up-pouch2-oz-size-chart-infographic5" element={<Standuppouch2Ozsizechartinfographic5 />} />
              <Route path="/topics/stand-up-pouch-for-powders" element={<Standuppouchforpowders />} />
              <Route path="/topics/stand-up-pouch-sizing-guide-infographic" element={<Standuppouchsizingguideinfographic />} />
              <Route path="/topics/start" element={<Start />} />
              <Route path="/topics/sustainable-flat-bottom-pouch-sizes-infographic3" element={<Sustainableflatbottompouchsizesinfographic3 />} />
              <Route path="/topics/test-slug-schema-infographic" element={<Testslugschemainfographic />} />
              <Route path="/topics/test-slug-schema-infographic4" element={<Testslugschemainfographic4 />} />
              <Route path="/topics/topic4aac2432-ccfb47a2-bff283b4b4304f63" element={<Topic4Aac2432Ccfb47A2Bff283B4B4304F63 />} />
              <Route path="/topics/topic550370b477134f3289cb48e0a6ba2fe3" element={<Topic550370B477134F3289Cb48E0A6Ba2Fe3 />} />
              <Route path="/topics/topic724830347d2f4d59-aae0-b6fbfa3a7897" element={<Topic724830347D2F4D59Aae0B6Fbfa3A7897 />} />
              <Route path="/topics/topic7d2800dc97da4386-b3ea-bca29c3a9e05" element={<Topic7D2800Dc97Da4386B3Eabca29C3A9E05 />} />
              <Route path="/topics/topic99eeb01c-fafb40e69ac739051266ab5a" element={<Topic99Eeb01Cfafb40E69Ac739051266Ab5A />} />
              <Route path="/topics/transparent-spout-pouch-page" element={<Transparentspoutpouchpage />} />
              <Route path="/topics/woven-polypropylene-sack-page" element={<Wovenpolypropylenesackpage />} />
    </Routes>
  );
};
...
const routeImportMap: Record<string, () => Promise<any>> = {
  ...
  '/materials/compostable-bar-packaging': () => import('./pages/materials/CompostableBarPackagingPage'),
...
const CompostableBarPackagingPage = lazyWithRetry(() => import('./pages/materials/CompostableBarPackagingPage'))
...
const LabelMaterialsGuidePage = lazyWithRetry(() => import('./pages/topics/LabelMaterialsGuidePage'))
...
const ArtworkGalleryPage = lazyWithRetry(() => import('./pages/ArtworkGalleryPage'))
            ...
            <BrowserRouter basename={routerBasename}>
              <StoreProvider>
                <CalendlyProvider>
                  ...
                  <Route path="/materials/compostable-bar-packaging" element={<CompostableBarPackagingPage />} />
                  ...
                  <Route path="/artwork-gallery/:batchId" element={<ArtworkGalleryPage />} />
                  ...
                  <Route path="/balsa-soft-wood-packaging" element={<BalsaSoftWoodPackaging />} />
                   <Route path="/topics/label-materials-guide" element={<LabelMaterialsGuidePage />} />

                   {/* Missing /topics/ routes - Learn page links fixed */}
                   ...
                   <Route path="/topics/food-packaging-supplier" element={<FoodPackagingSupplierPage />} />
                   <Route path="/topics/eco-friendly-packaging-supplier" element={<FoodPackagingSupplierServicePage />} />
                   <Route path="/topics/custom-packaging" element={<CustomVsStandardPackagingPage />} />
                   <Route path="/topics/reduce-packaging-waste" element={<ReducePackagingWasteGuidePage />} />
                   ...
                   <Route path="/topics/compostable-certification-faq" element={<CompostableCertificationFAQPage />} />
                   <Route path="/topics/compostable-packaging-blog" element={<CompostablePackagingBlogPage />} />
                   <Route path="/topics/compostable-spouted-pouches" element={<CompostablePackagingBlogPage />} />
                   <Route path="/topics/sensory-unboxing-experience" element={<SensoryUnboxingExperience />} />
                   <Route path="/topics/epr-tax-minimization-strategies" element={<EprTaxMinimizationStrategies />} />
                   <Route path="/topics/ultrasonic-vs-heat-sealing" element={<UltrasonicVsHeatSealing />} />
                   <Route path="/topics/ocean-bound-plastic-packaging" element={<OceanBoundPlasticPackaging />} />
                   <Route path="/topics/active-modified-atmosphere-packaging" element={<ActiveModifiedAtmospherePackaging />} />
                   <Route path="/topics/tamper-evident-sealing-standards" element={<TamperEvidentSealingStandards />} />
                   <Route path="/topics/liquid-barrier-packaging-spouts" element={<LiquidBarrierPackagingSpouts />} />
                   <Route path="/topics/carbon-footprint-tracking-packaging" element={<CarbonFootprintTrackingPackaging />} />
                   <Route path="/topics/compostable-humidity-control" element={<CompostableHumidityControl />} />
                   <Route path="/topics/jelly-beverage-stand-up-pouch" element={<JellyBeverageStandUpPouch />} />
                   <Route path="/topics/oatmeal-cereal-stand-up-pouch" element={<OatmealCerealStandUpPouch />} />
                   <Route path="/topics/snack-stand-up-pouch-large" element={<SnackStandUpPouchLarge />} />
                   <Route path="/topics/kraft-paper-shopping-bag" element={<KraftPaperShoppingBag />} />
                   <Route path="/topics/tea-stand-up-zipper-pouch" element={<TeaStandUpZipperPouch />} />
                   <Route path="/topics/pet-treat-stand-up-zipper-pouch" element={<PetTreatStandUpZipperPouch />} />
                   <Route path="/topics/medical-tape-three-side-seal" element={<MedicalTapeThreeSideSeal />} />
                   <Route path="/topics/household-jam-three-side-seal" element={<HouseholdJamThreeSideSeal />} />
                   <Route path="/topics/cereal-sachet-three-side-seal" element={<CerealSachetThreeSideSeal />} />
                   <Route path="/topics/snack-sachet-three-side-seal" element={<SnackSachetThreeSideSeal />} />
                   <Route path="/topics/tea-sachet-three-side-seal" element={<TeaSachetThreeSideSeal />} />
                   <Route path="/topics/coffee-sachet-three-side-seal" element={<CoffeeSachetThreeSideSeal />} />
                   <Route path="/topics/coffee-beans-flat-bottom-pouch" element={<CoffeeBeansFlatBottomPouch />} />
                   <Route path="/topics/nuts-flat-bottom-pouch" element={<NutsFlatBottomPouch />} />
                   <Route path="/topics/pillow-pack-snack-bag" element={<PillowPackSnackBag />} />
                   <Route path="/topics/household-back-seal-bag" element={<HouseholdBackSealBag />} />
                   <Route path="/topics/grains-back-seal-pouch" element={<GrainsBackSealPouch />} />
                   <Route path="/topics/cheese-pocket-zipper" element={<CheesePocketZipper />} />
                   <Route path="/topics/cocktail-spout" element={<CocktailSpout />} />
                   <Route path="/topics/collagen-high-barrier" element={<CollagenHighBarrier />} />
                   {/* Spec page missing route */}
                   <Route path="/spec/bio-cello-duplex-clear" element={<BioCelloTriplexHighestPage />} />
        ...
        <ErrorBoundary>
          <GeoBlocker>
            <BrowserRouter basename={routerBasename}>
              ...
              {/* Missing /topics/ and /spec/ routes for achievepack.com */}
              <Route path="/topics/eco-friendly-food-packaging" element={<EcoFriendlyFoodPackagingPage />} />
              <Route path="/topics/dtc-sustainable-packaging" element={<DTCSustainablePackagingPage />} />
              <Route path="/topics/green-coffee-materials" element={<GreenCoffeeMaterialsPage />} />
              <Route path="/topics/digital-printing-eco-packaging" element={<DigitalPrintingEcoPackagingPage />} />
              ...
              {/* Root & Knowledge Aliases for AchievePack */}
              <Route path="/dupont-paper-tote-bags-benefits" element={<DupontPaperToteBagsBenefits />} />
              <Route path="/tyvek-vs-canvas-tote-bags" element={<TyvekVsCanvasToteBags />} />
              <Route path="/eco-friendly-dupont-paper-bags" element={<EcoFriendlyDupontPaperBags />} />
              <Route path="/molded-pulp-packaging-benefits" element={<MoldedPulpPackagingBenefits />} />
              ...
              {/* Case Studies, Composting & Specs for AchievePack */}
              ...
              <Route path="/spec/biope-pp-kraft-quadlex-aluminum" element={<BioPePpKraftQuadlexAluminumPage />} />
              <Route path="/spec/biope-pp-triplex-aluminum" element={<BioPePpTriplexAluminumPage />} />
              <Route path="/case-studies/adaptogens" element={<CompostablePackagingBlogPage />} />
              <Route path="/case-studies/bakery" element={<CompostablePackagingBlogPage />} />
              <Route path="/case-studies/bath-products" element={<CompostablePackagingBlogPage />} />
              <Route path="/case-studies/candle-brand" element={<CompostablePackagingBlogPage />} />
              <Route path="/case-studies/organic-nuts" element={<CompostablePackagingBlogPage />} />
              <Route path="/case-studies/outdoor-snacks" element={<CompostablePackagingBlogPage />} />
              <Route path="/composting/biodegradable-vs-compostable" element={<CompostableVsRecyclablePage />} />
              <Route path="/composting/commercial-composting" element={<CompostablePage />} />
