...
const sourceFile = project.addSourceFileAtPath('src/pages/admin/QuoteAnalyticsPage.tsx');
...
const component = sourceFile.getVariableDeclaration('QuoteAnalyticsPage');
if (component) {
...
fs.writeFileSync('extracted_quote_analytics.json', JSON.stringify(dict, null, 2));
