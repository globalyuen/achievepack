...
const sourceFile = project.addSourceFileAtPath('src/pages/blog/PackagingCostGuidePage.tsx');
...
const component = sourceFile.getVariableDeclaration('PackagingCostGuidePage');
if (component) {
...
fs.writeFileSync('extracted_packaging_cost_guide.json', JSON.stringify(dict, null, 2));
