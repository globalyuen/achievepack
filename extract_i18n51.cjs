...
const sourceFile = project.addSourceFileAtPath('src/pages/topics/CompostableHumidityControlPage.tsx');
...
const component = sourceFile.getVariableDeclaration('CompostableHumidityControlPage') || sourceFile.getFunction('CompostableHumidityControlPage');
if (component) {
...
fs.writeFileSync('extracted_compostable_humidity.json', JSON.stringify(dict, null, 2));
