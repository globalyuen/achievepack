...
const sourceFile = project.addSourceFileAtPath('src/pages/legal/TermsOfUsePage.tsx');
...
const component = sourceFile.getVariableDeclaration('TermsOfUsePage') || sourceFile.getFunction('TermsOfUsePage');
if (component) {
...
fs.writeFileSync('extracted_terms.json', JSON.stringify(dict, null, 2));
