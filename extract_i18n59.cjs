...
const sourceFile = project.addSourceFileAtPath('src/pages/topics/CustomBrandPackagingServicePage.tsx');
...
const component = sourceFile.getVariableDeclaration('CustomBrandPackagingServicePage') || sourceFile.getFunction('CustomBrandPackagingServicePage');
if (component) {
...
fs.writeFileSync('extracted_custom_brand_serv.json', JSON.stringify(dict, null, 2));
