...
const pages = [
  { file: 'EcoStandUpPouchGuidePage.tsx', pageKey: 'ecoStandupGuide' },
  { file: 'EcoStandUpCoffeePouchPage.tsx', pageKey: 'ecoStandupCoffee' },
  { file: 'PremiumEcoPackagingComparisonPage.tsx', pageKey: 'premiumEcoPackagingComparison' },
];
