...
const sourceFile = project.addSourceFileAtPath('src/pages/legal/ShippingPolicyPage.tsx');
...
const component = sourceFile.getVariableDeclaration('ShippingPolicyPage') || sourceFile.getFunction('ShippingPolicyPage');
if (component) {
...
fs.writeFileSync('extracted_shipping.json', JSON.stringify(dict, null, 2));
