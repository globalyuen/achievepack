...
const sourceFile = project.addSourceFileAtPath('src/pages/RyanHologramPage.tsx');
...
const component = sourceFile.getVariableDeclaration('RyanHologramPage') || sourceFile.getFunction('RyanHologramPage') || sourceFile.getVariableDeclaration('RyanHolographicPage') || sourceFile.getFunction('RyanHolographicPage');
if (component) {
...
fs.writeFileSync('extracted_ryan_hologram.json', JSON.stringify(dict, null, 2));
