...
const sourceFile = project.addSourceFileAtPath('src/pages/topics/EcoFriendlySupplierServicePage.tsx');
...
const component = sourceFile.getVariableDeclaration('EcoFriendlySupplierServicePage') || sourceFile.getFunction('EcoFriendlySupplierServicePage');
if (component) {
...
fs.writeFileSync('extracted_eco_supplier.json', JSON.stringify(dict, null, 2));
