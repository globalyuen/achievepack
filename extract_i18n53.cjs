...
const sourceFile = project.addSourceFileAtPath('src/pages/topics/EcoPackagingRegulationsPage.tsx');
...
const component = sourceFile.getVariableDeclaration('EcoPackagingRegulationsPage') || sourceFile.getFunction('EcoPackagingRegulationsPage');
if (component) {
...
fs.writeFileSync('extracted_eco_regulations.json', JSON.stringify(dict, null, 2));
