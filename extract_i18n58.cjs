...
const sourceFile = project.addSourceFileAtPath('src/pages/topics/MinimalistD2CPackagingPage.tsx');
...
const component = sourceFile.getVariableDeclaration('MinimalistD2CPackagingPage') || sourceFile.getFunction('MinimalistD2CPackagingPage');
if (component) {
...
fs.writeFileSync('extracted_d2c.json', JSON.stringify(dict, null, 2));
