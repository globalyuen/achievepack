...
const sourceFile = project.addSourceFileAtPath('src/pages/free-service/FreeServicesHubPage.tsx');
...
const component = sourceFile.getVariableDeclaration('FreeServicesHubPage') || sourceFile.getFunction('FreeServicesHubPage');
if (component) {
...
fs.writeFileSync('extracted_free_hub.json', JSON.stringify(dict, null, 2));
