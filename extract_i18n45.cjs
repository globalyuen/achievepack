...
const sourceFile = project.addSourceFileAtPath('src/pages/topics/EUPPWRCompliancePage.tsx');
...
const component = sourceFile.getVariableDeclaration('EUPPWRCompliancePage') || sourceFile.getFunction('EUPPWRCompliancePage');
if (component) {
...
fs.writeFileSync('extracted_euppwr.json', JSON.stringify(dict, null, 2));
