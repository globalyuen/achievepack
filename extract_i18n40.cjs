...
const sourceFile = project.addSourceFileAtPath('src/pages/free-service/AchieveChipsDemoPage.tsx');
...
const component = sourceFile.getVariableDeclaration('AchieveChipsDemoPage') || sourceFile.getFunction('AchieveChipsDemoPage');
if (component) {
...
fs.writeFileSync('extracted_achieve_chips.json', JSON.stringify(dict, null, 2));
