...
const sourceFile = project.addSourceFileAtPath('src/pages/OrderManagementPage.tsx');
...
const component = sourceFile.getVariableDeclaration('OrderManagementPage') || sourceFile.getFunction('OrderManagementPage');
if (component) {
...
fs.writeFileSync('extracted_order_management.json', JSON.stringify(dict, null, 2));
