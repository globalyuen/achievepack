...
const sourceFile = project.addSourceFileAtPath('src/pages/topics/EcoFriendlyFoodPackagingPage.tsx');
...
const component = sourceFile.getVariableDeclaration('EcoFriendlyFoodPackagingPage') || sourceFile.getFunction('EcoFriendlyFoodPackagingPage');
if (component) {
...
fs.writeFileSync('extracted_eco_food.json', JSON.stringify(dict, null, 2));
